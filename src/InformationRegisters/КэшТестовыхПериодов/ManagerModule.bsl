...
//   *ТестовыеПериоды - Массив из Структура - содержит описатели тестовых периодов:
...
Процедура ОбновитьДанныеТестовыхПериодов(ДанныеСервисовСопровождения) Экспорт
	...
	ИдентификаторыСервисов = ДанныеСервисовСопровождения.ВыгрузитьКолонку("ИдентификаторСервисаСопровождения");
	ИдентификаторыСервисов = ОбщегоНазначенияКлиентСервер.СвернутьМассив(ИдентификаторыСервисов);
	
	Для Каждого ИдентификаторСервиса Из ИдентификаторыСервисов Цикл
