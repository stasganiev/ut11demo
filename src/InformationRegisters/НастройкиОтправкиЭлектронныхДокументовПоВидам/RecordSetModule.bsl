...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	Запрос.Текст = 
		...
		|	НастройкиОтправкиЭлектронныхДокументовПоВидам.СпособОбменаЭД = ЗНАЧЕНИЕ(Перечисление.СпособыОбменаЭД.Внутренний) КАК ЭтоИнтеркампани
		...
		|
		|ВЫБРАТЬ
		|	КлючевыеРеквизиты.Отправитель,
		|	КлючевыеРеквизиты.Получатель,
		|	КлючевыеРеквизиты.Договор,
		|	ИСТИНА,
		...
		|ГДЕ
		|	КлючевыеРеквизиты.Договор В (&ПустойДоговор)
		|	И НастройкиОтправкиЭлектронныхДокументов.Отправитель ЕСТЬ NULL
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
		...
		|		ПО КлючевыеРеквизиты.Отправитель = НастройкиОтправкиЭлектронныхДокументов.Отправитель
		|			И КлючевыеРеквизиты.Получатель = НастройкиОтправкиЭлектронныхДокументов.Получатель
		|			И КлючевыеРеквизиты.Договор В (&ПустойДоговор)
		|ГДЕ
		|	НастройкиОтправкиЭлектронныхДокументов.Договор В (&ПустойДоговор)
		|	И КлючевыеРеквизиты.Отправитель ЕСТЬ NULL";
	...
	Если Не РезультатЗапроса.Пустой() Тогда
		...
		Исключение
			...
			ЭлектронноеВзаимодействие.ОбработатьОшибку(НСтр("ru = 'Обновление настроек отправки'"), ОбработкаОшибок.ПодробноеПредставлениеОшибки(Информация),
