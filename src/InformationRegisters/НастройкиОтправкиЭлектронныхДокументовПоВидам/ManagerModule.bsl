...
Процедура УдалитьНастройкиОтправкиЭДО(Параметры, АдресРезультата) Экспорт
	...
	Исключение
		...
		ЭлектронноеВзаимодействие.ОбработатьОшибку(НСтр("ru = 'Удаление настроек отправки ЭДО'"), ОбработкаОшибок.ПодробноеПредставлениеОшибки(Информация), ТекстОшибки);
		Результат = Ложь;
...
Процедура УдалитьНастройкиИнтеркампани(Параметры, АдресРезультата) Экспорт
	...
	Исключение
		...
		ЭлектронноеВзаимодействие.ОбработатьОшибку(НСтр("ru = 'Удаление настроек интеркампани'"), ОбработкаОшибок.ПодробноеПредставлениеОшибки(Информация), ТекстОшибки);
		Результат = Ложь;
