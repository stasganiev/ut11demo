...
//
Функция ЗаписатьСтатус(Документ, ПараметрыОбновления) Экспорт
	...
	Исключение
		...
		ЭлектронноеВзаимодействие.ОбработатьОшибку(НСтр("ru = 'Записать статус запроса коммерческих предложений'"), ПодробноеПредставлениеОшибки(Информация), 
			НСтр("ru = 'Не удалось записать статус запроса коммерческих предложений'"), "БизнесСеть");
