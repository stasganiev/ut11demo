...
&НаКлиенте
Процедура ВидЭлектроннойПодписиДляВыбораНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	
	ВидыПодписей = Новый СписокЗначений();
	ПодписьПЭП_УНЭП = НастройкиВнутреннегоЭДОКлиентСервер.ВидЭлектроннойПодписиПЭП_УНЭП();
	ВидыПодписей.Добавить(ПодписьПЭП_УНЭП, ПодписьПЭП_УНЭП);
...
Процедура ОформитьСоглашенияССотрудниками(Команда)
	...
	Если ТекущиеДанные <> неопределено Тогда 
		...
		НастройкиВнутреннегоЭДОСлужебныйКлиент.ОткрытьФормуФормированияУведомленияОбИспользованииПЭП_УНЭП(Организация,
...
&НаКлиенте
Процедура ОформитьПоложениеОбИспользованииПЭП_УНЭП(Команда)
	
	Если ЗначениеЗаполнено(Организация) Тогда 
		
		НастройкиВнутреннегоЭДОСлужебныйКлиент.ОткрытьФормуФормированияПоложенияОбИспользованииПЭП_УНЭП(Организация,
			ЭтаФорма);
...
Процедура УстановитьВидЭлектроннойПодписи(Форма)
	...
	Если Форма.ВидЭлектроннойПодписи = ПростаяПодпись Тогда
		Форма.ВидЭлектроннойПодписиДляВыбора = НастройкиВнутреннегоЭДОКлиентСервер.ВидЭлектроннойПодписиПЭП_УНЭП();
	Иначе
		Форма.ВидЭлектроннойПодписиДляВыбора = Форма.ВидЭлектроннойПодписи;
	КонецЕсли;
...
Процедура ПослеВыбораВариантаПодписиИзСписка(ВыбранныйЭлемент, ДополнительныеПараметры) Экспорт
	...
	ВидЭлектроннойПодписиДляВыбора = ВыбранныйЭлемент.Значение;
	Если ВидЭлектроннойПодписиДляВыбора = НастройкиВнутреннегоЭДОКлиентСервер.ВидЭлектроннойПодписиПЭП_УНЭП() Тогда
		ВидЭлектроннойПодписи = ПредопределенноеЗначение("Перечисление.ВидыЭлектронныхПодписей.Простая");		
	Иначе
