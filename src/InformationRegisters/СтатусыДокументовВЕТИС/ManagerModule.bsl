	...
	ИначеЕсли ТипЗнч(СсылкаНаОформляемыйДокумент) = Тип("ДокументСсылка.ВходящаяТранспортнаяОперацияВЕТИС") Тогда
		...
		СтруктураЗначенияПоУмолчанию.Вставить("ДальнейшееДействие1",
			МенеджерОбъекта.ДальнейшееДействиеПоУмолчанию(
				ПараметрыДляРасчетаСтатуса.ПроверятьНаРегионализацию,
...
// 
// Параметры:
//  Статус - ПеречислениеСсылка - новый статус документа ВетИС
//  ДальнейшиеДействия - Массив Из ПеречислениеСсылка.ДальнейшиеДействияПоВзаимодействиюВЕТИС -  Дальнейшие действия
// 
// Возвращаемое значение:
//  Структура -  Возвращаемое значение дальнейшие действия статус:
// * НовыйСтатус - ПеречислениеСсылка - новый статус документа ВетИС
// * ДальнейшееДействие1 - ПеречислениеСсылка.ДальнейшиеДействияПоВзаимодействиюВЕТИС - 
// * ДальнейшееДействие2 - ПеречислениеСсылка.ДальнейшиеДействияПоВзаимодействиюВЕТИС - 
// * ДальнейшееДействие3 - ПеречислениеСсылка.ДальнейшиеДействияПоВзаимодействиюВЕТИС - 
