...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьПоШаблонуНаСервере(ОтражениеВУчетеЭДО.ПрофилиНастроекОтраженияВходящихДокументов().ПервоначальноеЗаполнение,
...
Процедура Удалить(Команда)
	...
	ОтражениеВУчетеЭДОКлиент.УдалитьНастройкуОтраженияВУчете(Организация, Контрагент,
...
Процедура ЗаполнитьПоШаблонуНаСервере(Знач ИмяШаблона, СоответствиеВидовИТипов)
	...
	Профиль = ОтражениеВУчетеЭДО.ПрофилиНастроекОтраженияВходящихДокументов()[ИмяШаблона];
	ТаблицаПредопределенногоПрофиля = ОтражениеВУчетеЭДО.ШаблонНастроекОтраженияВУчете(Профиль);
...
Процедура ЗаполнитьСоответствиеВидовИТипов(СоответствиеВидовИТипов)
	...
	Для Каждого СтрокаВидаЭД Из ВходящиеДокументы Цикл
		...
		СписокВыбора = ОтражениеВУчетеЭДО.СписокОперацийВидаДокумента(ВидЭД, Истина,
...
Функция СохранитьНастройкиНаСервере(Знач ВходящиеДокументы, Знач Получатель,
	...
	Возврат ОтражениеВУчетеЭДО.СохранитьНастройкиОтраженияВУчете(ВходящиеДокументы.Выгрузить(), Получатель,
