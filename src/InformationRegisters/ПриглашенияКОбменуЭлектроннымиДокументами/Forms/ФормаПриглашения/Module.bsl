...
Процедура ЗаполнитьДанные()
	...
	ЭтоОблачныйЭДО             = ДанныеПриглашения.ЭтоОблачныйЭДО;
...
Процедура ВыполнитьДействиеСПриглашением(Действие)
	...
	Если Действие = "Принять" Тогда
		ПриглашенияЭДОСлужебныйКлиент.ПринятьПриглашения(Приглашения, ЭтотОбъект, Оповещение);
	ИначеЕсли Действие = "Отклонить" Тогда
		ПриглашенияЭДОСлужебныйКлиент.ОтклонитьПриглашения(Приглашения, ЭтотОбъект, Оповещение);
	ИначеЕсли Действие = "Отозвать" Тогда
		ПриглашенияЭДОСлужебныйКлиент.ОтозватьПриглашения(Приглашения, ЭтотОбъект, Оповещение);
	КонецЕсли;
