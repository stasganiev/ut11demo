...
Процедура ОбновитьОтборПоОрганизации()
	...
	Если ЗначениеЗаполнено(ВыбраннаяОрганизация) Тогда
		...
		|
		|ВЫБРАТЬ РАЗРЕШЕННЫЕ
		|	ЖурналМашиночитаемыхДоверенностейПереопределяемый.Хеш,
		|	ЖурналМашиночитаемыхДоверенностейПереопределяемый.Номер,
		|	ЖурналМашиночитаемыхДоверенностейПереопределяемый.ВсеДоверители,
		|	ЖурналМашиночитаемыхДоверенностейПереопределяемый.ВсеПредставители,
		|	ЖурналМашиночитаемыхДоверенностейПереопределяемый.ДатаВыдачи,
		|	ЖурналМашиночитаемыхДоверенностейПереопределяемый.ДатаОкончанияДействия,
		|	ЖурналМашиночитаемыхДоверенностейПереопределяемый.Верна,
		|	ЖурналМашиночитаемыхДоверенностейПереопределяемый.Действует,
		|	ЖурналМашиночитаемыхДоверенностейПереопределяемый.ПометкаУдаления,
		|	ЖурналМашиночитаемыхДоверенностейПереопределяемый.Доверенность,
		|	ЖурналМашиночитаемыхДоверенностейПереопределяемый.ДатаИзменения,
		|	ВЫБОР
		...
		|{ГДЕ
		|	ПометкаУдаления = &ПоказыватьПомеченныеНаУдаление}";
