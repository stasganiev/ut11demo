...
//  * ИНН - Строка
//  * КПП - Строка
Функция НовыеРеквизитыНатуральныхКлючей() Экспорт
	РеквизитыПриглашений = Новый ТаблицаЗначений;
	РеквизитыПриглашений.Колонки.Добавить("ИдентификаторСтроки", ОбщегоНазначения.ОписаниеТипаСтрока(50));
...
Функция НовыеКлючиПриглашений() Экспорт
	...
	НаборКлючей.Колонки.Добавить("ИдентификаторСтроки", ОбщегоНазначения.ОписаниеТипаСтрока(100));
	НаборКлючей.Колонки.Добавить("Ключ", ОписаниеТипаСтрока);
	НаборКлючей.Колонки.Добавить("ИдентификаторОрганизации", ОписаниеТипаСтрока);
	Возврат НаборКлючей;
КонецФункции

// Параметры:
//  РеквизитыПриглашений - см. НовыеРеквизитыНатуральныхКлючей
// 
// Возвращаемое значение:
...
Функция КлючиПриглашенийПоРеквизитам(РеквизитыПриглашений) Экспорт
	...
	Запрос.Текст =
		"ВЫБРАТЬ
		|	РеквизитыПриглашений.ИдентификаторСтроки,
...
Функция СтатусыПриглашений(КлючиПриглашений) Экспорт
	...
	Запрос.Текст =
		"ВЫБРАТЬ
		|	КлючиПриглашений.Ключ,
		|	КлючиПриглашений.ИдентификаторОрганизации,
		|	КлючиПриглашений.ИдентификаторСтроки
		...
		|		ПО КлючиПриглашений.Ключ = ПриглашенияКОбменуЭлектроннымиДокументами.Ключ
...
Функция ВходящиеПриглашенияПоКлючам(КлючиПриглашений) Экспорт
	...
	Выборка = ВыборкаДанныхВходящихПриглашенийПоКлючам(КлючиПриглашений);
	
	Пока Выборка.Следующий() Цикл
		Приглашение = ПриглашенияЭДОКлиентСервер.НовоеВходящееПриглашение();
		Приглашение.КлючПриглашения = Выборка.Ключ;
		...
		Результат.Вставить(Выборка.ИдентификаторСтроки, Приглашение);
	КонецЦикла;
...
Функция ВыборкаДанныхВходящихПриглашенийПоКлючам(КлючиПриглашений)
	...
	Запрос.Текст =
		...
		|		ПО ПриглашенияКОбменуЭлектроннымиДокументами.Ключ = КлючиПриглашений.Ключ
