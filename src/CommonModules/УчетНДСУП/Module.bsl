...
//
Функция СтавкаНДСПоНоменклатуреИНалогообложению(Номенклатура, НалогообложениеНДС, Организация, Дата) Экспорт
...
#Область ПартииНДСКРаспределению
	...
	|			И ЕСТЬNULL(СуммыДокументов.СуммаНДСРегл, 0) < 0
	|			И Ценности.ВидДеятельностиНДС <> ЗНАЧЕНИЕ(Перечисление.ТипыНалогообложенияНДС.ПроизводствоСДЦ))
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	#Область АнализНачисленийНДССАвансовПолученных
	...
	#Область АнализУчетаНДСПриЗачетеАвансовПолученных
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.АнализУчетаНДСПриЗачетеАвансовПолученных);
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
	ОписаниеВарианта.Описание =
		НСтр("ru= 'Анализ учета НДС по зачетам полученных авансов в разрезе контрагентов и документов оплаты'");
	#КонецОбласти
	
	#Область АнализУчетаНДСПриЗачетеАвансовВыданных
	...
	#Область ВедомостьПоНДСПредъявленному
