...
Функция ДанныеЗаполненияСписанияКодовМаркировкиИСМП(Организация) Экспорт
	...
	Иначе
		...
		Если ДанныеЗаполнения.ВидПродукции = Перечисления.ВидыПродукцииИС.Пиво Тогда
...
Функция ТекстЗапросаЗаполненияТоварыЗаказаНаЭмиссиюСУЗ()
	...
	|		И
	|			ДокументыПоНоменклатуре.Ссылка.СпособВводаВОборот <> ЗНАЧЕНИЕ(Перечисление.СпособыВводаВОборотСУЗ.МаркировкаОстатков)
