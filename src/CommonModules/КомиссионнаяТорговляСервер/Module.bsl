...
Процедура ИспользуетсяКомиссионнаяПродажаПриЗаписи(Источник, Отказ) Экспорт
	...
	Константы.ИспользуетсяКомиссионнаяПродажаУТ11.Установить(ЭтоУТ И Источник.Значение);
	Константы.ИспользуетсяКомиссионнаяПродажаУПКА20.Установить(НЕ ЭтоУТ И Источник.Значение);
