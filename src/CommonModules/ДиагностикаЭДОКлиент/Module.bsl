...
Процедура ОткрытьСписокСертификатов(Сертификаты, ДополнительныеПараметры) Экспорт // АПК:581 - используется в обработке ошибок учетных записей.
...
// Параметры:
//  Контекст - Структура:
// * ПараметрыВыполнения - См. ДиагностикаЭДОКлиентСервер.НовыеПараметрыВыполненияДиагностики.
Процедура ЗапроситьПаролиСертификатов(Контекст)
	...
	Если ОбщегоНазначенияБЭДКлиент.ЭтоВебКлиент() И Не ВыполнятьПроверкиСертификатовВВебКлиенте Тогда
