...
Процедура ОткрытьФормуФормированияУведомленияОбИспользованииПЭП_УНЭП(Организация, СписокПользователей,
	...
	ОткрытьФорму("Обработка.НастройкиВнутреннегоЭДО.Форма.ФормированиеУведомленияОбИспользованииПЭП_УНЭП",
		ПараметрыОткрытияФормы, ВладелецФормы, , , , , РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	
КонецПроцедуры

Процедура ОткрытьФормуФормированияПоложенияОбИспользованииПЭП_УНЭП(Организация, ВладелецФормы = Неопределено) Экспорт

	ПараметрыОткрытияФормы = Новый Структура;
	ПараметрыОткрытияФормы.Вставить("Организация", Организация);
	
	ОткрытьФорму("Обработка.НастройкиВнутреннегоЭДО.Форма.ФормированиеПоложенияОбИспользованииПЭП_УНЭП",
		ПараметрыОткрытияФормы, ВладелецФормы, , , , , РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
