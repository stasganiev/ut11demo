...
Функция ТаблицаПолейДанныйДляРасшифровкиОшибок() Экспорт
	...
	ПространствоИменСправочники = ИнтеграцияЗЕРНОСлужебный.ПространствоИменПоИмениПакетаXDTO("zerno_api_dictionaries");
	ПространствоИменОрганизации = ИнтеграцияЗЕРНОСлужебный.ПространствоИменПоИмениПакетаXDTO("zerno_organizations");
	ПространствоИменСДИЗ        = ИнтеграцияЗЕРНОСлужебный.ПространствоИменПоИмениПакетаXDTO("zerno_api_sdiz");
	ПространствоИменСДИЗППЗ     = ИнтеграцияЗЕРНОСлужебный.ПространствоИменПоИмениПакетаXDTO("zerno_api_gpb_sdiz");
