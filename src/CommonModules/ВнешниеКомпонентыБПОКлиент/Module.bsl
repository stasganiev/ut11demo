...
// 
// Параметры:
//   ИменаМакетовДляПереустановки - Массив из Строка
//
Процедура ПереустановитьКомпоненты(ИменаМакетовДляПереустановки) Экспорт

	Контекст = Новый Структура();
	Контекст.Вставить("МакетыДляПереустановки", Новый Массив);
	Для Каждого ИмяМакетаДрайвера Из ИменаМакетовДляПереустановки Цикл
...
//  Контекст - Структура:
//    * МакетыДляПереустановки - Массив из строка
//
Процедура УстановитьКомпонентуИзМакетаРекурсивно(Результат, Контекст) Экспорт
	...
	ОповещениеУстановки = Новый ОписаниеОповещения("УстановитьКомпонентуИзМакетаРекурсивно", ЭтотОбъект, Контекст);
	УстановитьКомпонентуИзМакета(ОповещениеУстановки, ТекущийМакет);
