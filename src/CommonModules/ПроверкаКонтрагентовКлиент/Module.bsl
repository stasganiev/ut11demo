		...
		ИначеЕсли НЕ ОтложитьПрорисовкуРезультатаПроверкиКонтрагентов Тогда
			...
			Если Результат.ЗаданиеВыполнено Тогда
				...
				Если Форма.ФормаДлительнойОперации <> Неопределено
					И ТипЗнч(Форма.ФормаДлительнойОперации) = Тип("ФормаКлиентскогоПриложения")
...
Процедура ОткрытьФормуПроверкиПодключенияКСервисам() Экспорт
	
	ОткрытьФорму("ОбщаяФорма.ПроверкаДоступаКСервисамКонтрагентов");
