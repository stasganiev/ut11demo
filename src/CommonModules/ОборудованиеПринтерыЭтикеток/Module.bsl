...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер.Наименование = НСтр("ru = 'Гексагон:Принтера этикеток Zebra,Proton,Toshiba-TEC,Datamax-O neil'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Скансити:Принтер печати этикеток TSC'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Сканкод:Принтера этикеток Godex EZPL8 (Native API)'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:Принтера этикеток'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
...
//  см. ОборудованиеПринтерыЭтикеток.ДанныеОперацииПринтерыЭтикеток.
