...
// Возвращаемое значение:
//   ДеревоЗначений:
//   * ТипОбъекта - Неопределено,Строка
//   * СсылкаНаОбъект - Неопределено,ЛюбаяСсылка
//   * ОписаниеТипа - Неопределено,Строка
//   * ИндексСтроки - Неопределено,Строка
//   * Реквизит - Неопределено,Строка
//   * ЗначениеРеквизита - Неопределено,Произвольный,ДеревоЗначений
//   * ОписаниеОбъекта - Неопределено,Строка
//   * ВидЭД - Неопределено,ПеречислениеСсылка.ТипыДокументовЭДО
//   * ВерсияФормата - Неопределено,Строка
//   * ИД - Неопределено,Строка
//   * НаправлениеЭД - Неопределено,ПеречислениеСсылка.НаправленияЭДО
...
//
// Параметры:
//  ДеревоРазбора - см. ИнициализироватьДеревоРазбора
//  ЗначениеТипаОбъекта - Произвольный - искомый тип объекта.
//
// Возвращаемое значение:
//  СтрокаДереваЗначений: см. ИнициализироватьДеревоРазбора
//
...
//
// Параметры:
//  ДеревоДанных - ДеревоЗначений,СтрокаДереваЗначений - объект поиска.
...
// Возвращаемое значение:
//  ДеревоЗначений:
//  * ТипЗначения - Неопределено,Строка
//  * Значение - Неопределено,Произвольный
//  * ПолныйПуть - Строка
//  * ТекстОшибки  - Неопределено,Строка - используется для переопределения стандартного текста ошибки.
//  * ПутьКДаннымСообщения - Неопределено,Строка - путь к данным для обработки через сообщение пользователю (см. СообщениеПользователю).
//  * КлючСообщения - Неопределено,ЛюбаяСсылка - ключ данных для обработки через сообщение пользователю (см. СообщениеПользователю).
//  * НавигационнаяСсылка - Неопределено,Строка - навигационная ссылка, по которой нужно перейти при клике на ошибку.
//  * ИмяФормы - Неопределено,Строка - имя формы, которую нужно открыть при клике на ошибку.
//  * ПараметрыФормы - Неопределено,Структура - параметры, передаваемые в форму, открываемую при клике на ошибку.
//
...
// См. ДеревоЭлектронногоДокументаБЭДСлужебный.ЭтоСсылочноеЗначениеДереваРазбора
...
//  СтрокаИсточник - СтрокаДереваЗначений
