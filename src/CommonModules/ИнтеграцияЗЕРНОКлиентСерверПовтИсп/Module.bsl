...
Функция ИменаПараметровПериодическогоПолученияДанных() Экспорт
	...
	ВозвращаемоеЗначение.Вставить(
		"ВерсияБСППоддерживаетПроверкуСохраненногоПароляСертификатаНаКлиенте",
		"ИнтеграцияЗЕРНО_ВерсияБСППоддерживаетПроверкуСохраненногоПароляСертификатаНаКлиенте");
	Возврат ВозвращаемоеЗначение;
