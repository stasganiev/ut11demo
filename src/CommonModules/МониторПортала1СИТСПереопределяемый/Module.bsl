...
// Вызывается при формировании текстов предупреждений в Мониторе портала 1С:ИТС.
//
// Параметры:
//  ДанныеСервиса- КлючИЗначение - данные предупреждений сервиса:
//    *Ключ - Строка - идентификатор сервиса;
//    *Значение - Соответствие - предупреждения сервиса:
//      **Ключ - Строка - идентификатор опции;
//      **Значение - Массив из Структура - предупреждения опции:
//        ***ИдентификаторСервиса - Строка - идентификатор сервиса;
//        ***ИдентификаторОпции - Строка - идентификатор опции;
//        ***ВидУведомления - Строка - вид предупреждения;
...
//  ТекстыПредупреждений - Массив - тексты предупреждений.
//
Процедура ПриФормированииТекстовПредупреждений(ДанныеСервиса, ТекстыПредупреждений) Экспорт

КонецПроцедуры

// Вызывается при заполнении параметров сервисов при получении уведомлений.
//
// Параметры:
//  ПараметрыСервисов- Соответствие - параметры сервисов.
//
