...
Процедура ПриСозданииНаСервереФормаНоменклатуры(Форма, 
	...
	СервисДоступен = ДоступнаФункциональностьПодсистемы();
...
Процедура ПриПолученииСпискаШаблонов(ШаблоныЗаданий) Экспорт
	...
	ШаблоныЗаданий.Добавить(Метаданные.РегламентныеЗадания.ОбработкаОчередиЗапросовФСА.Имя);
...
Процедура ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам) Экспорт
	...
	СоответствиеИменПсевдонимам.Вставить(Метаданные.РегламентныеЗадания.ОбработкаОчередиЗапросовФСА.ИмяМетода);
...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	НоваяСтрока = Настройки.Добавить();
	НоваяСтрока.РегламентноеЗадание = Метаданные.РегламентныеЗадания["ОбработкаОчередиЗапросовФСА"];
	НоваяСтрока.РаботаетСВнешнимиРесурсами = Истина;
...
Функция СервисАккредитацииДоступен() Экспорт
	...
	Возврат РаботаСНоменклатуройСлужебный.СервисАккредитацииДоступен();
...
//
Функция ДанныеСертификатаСоответствия(Номер, ДатаРегистрации, ДатаОкончанияДействия = Неопределено, 
	ПроверятьДоступность = Истина) Экспорт
	
	КонтекстПроверки = "РаботаСНоменклатурой.ДанныеСертификатаСоответствия";
	РаботаСНоменклатуройСлужебныйКлиентСервер.ПроверитьВходящиеПараметрыДокументаАккредитации(Номер, 
		ДатаРегистрации, ДатаОкончанияДействия, КонтекстПроверки);
	
	Результат = РаботаСНоменклатуройСлужебныйКлиентСервер.НовыеДанныеДокументаАккредитации();
	Результат.Статус = РаботаСНоменклатуройСлужебный.СтатусНеНайдено(); 
	Результат.Данные = НовыеДынныеСертификатаСоответствия();
	
	Если ПроверятьДоступность 
		И Не СервисАккредитацииДоступен() Тогда
		Результат.Статус = РаботаСНоменклатуройСлужебный.СтатусСервисНеДоступен();
		Возврат Результат;
	КонецЕсли;
	
	ПараметрыДокумента = РаботаСНоменклатуройСлужебный.НовыеПараметрыДокументаАккредитации();
	ПараметрыДокумента.ВидДокумента = РаботаСНоменклатуройСлужебныйКлиентСервер.ВидДокументаСертификат();
	ПараметрыДокумента.Номер = Номер;
	ПараметрыДокумента.ДатаРегистрации = ДатаРегистрации;
	ПараметрыДокумента.ДатаОкончанияДействия = ДатаОкончанияДействия;
	РаботаСНоменклатуройСлужебный.ПолучитьДанныеДокументаАккредитации(Результат, ПараметрыДокумента);
...
//                       "СервисНеДоступен" - сервис не доступен.
//
Функция ДанныеДекларацииСоответствия(Номер, ДатаРегистрации, ДатаОкончанияДействия = Неопределено, 
	ПроверятьДоступность = Истина) Экспорт
	
	КонтекстПроверки = "РаботаСНоменклатурой.ДанныеДекларацииСоответствия";
	РаботаСНоменклатуройСлужебныйКлиентСервер.ПроверитьВходящиеПараметрыДокументаАккредитации(Номер, 
		ДатаРегистрации, ДатаОкончанияДействия, КонтекстПроверки);
	
	Результат = РаботаСНоменклатуройСлужебныйКлиентСервер.НовыеДанныеДокументаАккредитации();
	Результат.Статус = РаботаСНоменклатуройСлужебный.СтатусНеНайдено(); 
	Результат.Данные = НовыеДынныеДекларацииСоответствия();
	...
	ПараметрыДокумента = РаботаСНоменклатуройСлужебный.НовыеПараметрыДокументаАккредитации();
	ПараметрыДокумента.ВидДокумента = РаботаСНоменклатуройСлужебныйКлиентСервер.ВидДокументаДекларация();
	ПараметрыДокумента.Номер = Номер;
	ПараметрыДокумента.ДатаРегистрации = ДатаРегистрации;
	ПараметрыДокумента.ДатаОкончанияДействия = ДатаОкончанияДействия;
	РаботаСНоменклатуройСлужебный.ПолучитьДанныеДокументаАккредитации(Результат, ПараметрыДокумента);
...
Процедура ОбработкаОчередиЗапросовФСА() Экспорт
	
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ОбработкаОчередиЗапросовФСА);
	
	РегистрыСведений.ОчередьЗапросовФСА.ВыполнитьОбработку();
	
	РаботаСНоменклатуройСлужебный.ОбновитьНастройкиРегламентногоЗаданияОбработкиОчередиЗапросовФСА();
...
// Метод-конструктор данных сертификата соответствия
//
// Возвращаемое значение:
//  Структура:
//   * Номер - Строка - Номер сертификата соответствия
//   * ДатаРегистрации - Дата - Дата регистрации сертификата соответствия
//   * ДатаОкончанияДействия - Дата - Дата окончания действия сертификата соответствия
//   * Статус - Строка - Статус сертификата соответствия, значение из фиксированного списка:
//                       "ИсключенИзРеестра"
//                       "Аннулирован"
//                       "СведенияИзменены"
//                       "Выдан"
...
//                       "Черновик"
//                       "Удален"
//                       "НаправленоУведомлениеЗаявителюОПрекращении"
//                       "ВыданоПредписание"
//                       "Продлен"
//                       "Отправлен"
//                       "Возобновлен"
//   * ДатаПоследнегоИзменения - Дата - Дата последнего изменения сертификата соответствия
//   * НаименованиеЗаявителя - Строка - Наименование заявителя
//   * ИНН - Строка - ИНН заявителя
//   * ОГРН - Строка - ОГРН заявителя
//   * НаименованиеИзготовителя - Строка - Наименование изготовителя
//   * НаименованиеПродукции - Строка - Наименование продукции
//   * Гиперссылка - Строка - URL на страничку сертификата соответствия на сайте ФСА
//   * ТНВЭД - Массив из Строка - Коды ТН ВЭД, на которые зарегистрирован сертификата соответствия
//   * ОКПД2 - Массив из Строка - Коды ОКПД2
//   * ТехническиеРегламенты - Массив из Строка - Технические регламенты
//   * Штрихкоды - Массив из Строка - список GTIN
//
Функция НовыеДынныеСертификатаСоответствия()
	
	Результат = Новый Структура;
	Результат.Вставить("Номер", "");
	Результат.Вставить("ДатаРегистрации", Дата(1, 1, 1));
	Результат.Вставить("ДатаОкончанияДействия", Дата(1, 1, 1));
	Результат.Вставить("Статус", "");
	Результат.Вставить("ДатаПоследнегоИзменения", Дата(1, 1, 1));
	Результат.Вставить("НаименованиеЗаявителя", "");
	Результат.Вставить("ИНН", "");
	Результат.Вставить("ОГРН", "");
	Результат.Вставить("НаименованиеИзготовителя", "");
	Результат.Вставить("НаименованиеПродукции", "");
	Результат.Вставить("Гиперссылка", "");
	Результат.Вставить("ТНВЭД", Новый Массив);
	Результат.Вставить("ОКПД2", Новый Массив);
	Результат.Вставить("ТехническиеРегламенты", Новый Массив);
...
// Метод-конструктор данных декларации соответствия
//
// Возвращаемое значение:
//  Структура:
//   * Номер - Строка - Номер декларации соответствия
//   * ДатаРегистрации - Дата - Дата регистрации декларации соответствия
//   * ДатаОкончанияДействия - Дата - Дата окончания действия декларации соответствия
//   * Статус - Строка - Статус ДС, значение из фиксированного списка:
//                       "ИсключенИзРеестра"
//                       "Аннулирован"
//                       "СведенияИзменены"
//                       "Выдан"
...
//                       "Отправлен"
//                       "Возобновлен"
//   * ДатаПоследнегоИзменения - Дата - Дата последнего изменения декларации соответствия
//   * НаименованиеЗаявителя - Строка - Наименование заявителя
//   * ИНН - Строка - ИНН заявителя
//   * ОГРН - Строка - ОГРН заявителя
//   * НаименованиеИзготовителя - Строка - Наименование изготовителя
//   * НаименованиеПродукции - Строка - Наименование продукции
//   * Гиперссылка - Строка - URL на страничку ДС на сайте ФСА
//   * ТНВЭД - Массив из Строка - Коды ТН ВЭД, на которые зарегистрирован декларации соответствия
//   * ОКПД2 - Массив из Строка - Коды ОКПД2
//   * ТехническиеРегламенты - Массив из Строка - Технические регламенты
//   * Штрихкоды - Массив из Строка - список GTIN
//
Функция НовыеДынныеДекларацииСоответствия()
