...
//
Функция ТаблицаМаркируемойПродукцииДокумента(Контекст, ВидМаркируемойПродукции, Сценарий = 0) Экспорт
	...
	Иначе
		...
		Если ИнтеграцияИС.СодержитсяВПодсистеме("ГосИС.ИСМП", МетаданныеДокумента)
				Или МетаданныеДокумента.Имя = "ОтчетОбИмпортеЕГАИС"
...
Процедура ДополнитьКолонкамиПоВидуПродукции(ВидМаркируемойПродукции, ТаблицаМаркируемойПродукции)
	...
	ИначеЕсли ИнтеграцияИСМПКлиентСервер.ЭтоВидПродукцииСоСрокамиГодности(ВидМаркируемойПродукции, Ложь) Тогда
...
Функция СформироватьТаблицуИзмененийПодобраннойПродукции(ТаблицаМаркируемойПродукции, ДанныеДокумента, ПараметрыСканирования, ВидПродукции)
	...
	КолонкиТаблицы = КолонкиДляТаблицыИзмененийПодобраннойПродукции(ВидПродукции);
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.МорепродуктыПодконтрольныеВЕТИС Тогда
		...
		ОписаниеСвойства = Новый Структура("Имя, ПрисутствуетВДанныхДокумента", "ГоденДо", ПрисутствуютВДанныхДокумента);
		СписокСвойствВидаПродукции.Добавить(ОписаниеСвойства);
	ИначеЕсли ИнтеграцияИСМПКлиентСервер.ЭтоВидПродукцииСоСрокамиГодности(ВидПродукции, Ложь) Тогда
		ПрисутствуютВДанныхДокумента = ПроверкаИПодборПродукцииИСМПКлиентСервер.ДокументИспользуетДанныеВЕТИС(ДанныеДокумента.ПроверяемыйДокумент)
			И Не ПараметрыСканирования.ЭтоАгрегацияКодовМаркировкиИСМП;
		ОписаниеСвойства = Новый Структура("Имя, ПрисутствуетВДанныхДокумента", "ГоденДо", ПрисутствуютВДанныхДокумента);
		СписокСвойствВидаПродукции.Добавить(ОписаниеСвойства);
...
Функция КолонкиДляТаблицыИзмененийПодобраннойПродукции(ВидПродукции) Экспорт
...
Процедура СвернутьТаблицуИзмененийПодобраннойПродукции(ТаблицаИзменений, ВидПродукции) Экспорт
	
	Если ТипЗнч(ТаблицаИзменений) = Тип("Массив") Тогда
		ТаблицаИзмененийПодобраннойПродукции         = Новый ТаблицаЗначений;
		ЗначенияСтрокиПоУмолчаниюДляТаблицыИзменений = Новый Структура;
		Для Каждого ОписаниеКолонки Из КолонкиДляТаблицыИзмененийПодобраннойПродукции(ВидПродукции) Цикл
			ТаблицаИзмененийПодобраннойПродукции.Колонки.Добавить(ОписаниеКолонки.Имя, ОписаниеКолонки.ОписаниеТипов);
