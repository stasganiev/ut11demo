...
// Возвращает запрещенные расширения файлов к публикации: программы, скрипты, ярлыки, которые могут нанести вред.
// 
// Возвращаемое значение:
...
Функция ЗапрещенныеРасширенияФайла() Экспорт
	...
	Возврат ".exe;.application;.msi;.msp;.pif;.com;.scr;.msc;.cpl;.gadget;.jar;.hta;.bat;.cmd;.vb;.vbs;.vbe;.ws;.wsf;.wsc;.wsh;.js;.jse;.ps1;.ps1xml;.ps2;.ps2xml;.psc1;.psc2;.msh;.msh1;.msh2;.mshxml;.msh1xml;.msh2xml;.scf;.inf;.lnk;.reg;";
