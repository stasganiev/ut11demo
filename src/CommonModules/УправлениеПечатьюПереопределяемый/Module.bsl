...
Процедура ПередДобавлениемКомандПечати(ИмяФормы, КомандыПечати, СтандартнаяОбработка) Экспорт
	...
	ИнтеграцияС1СДокументооборотБазоваяФункциональность.ПередДобавлениемКомандПечати(
		ИмяФормы,
		КомандыПечати,
...
Процедура ПриОпределенииИсточниковДанныхПечати(Объект, ИсточникиДанныхПечати) Экспорт
	...
	Если Объект = "Справочник.ФизическиеЛица.Наименование" Или Объект = "Справочник.ФизическиеЛица.ФИО"
		Или Объект = "Справочник.КонтактныеЛицаПартнеров.Наименование" Тогда	
