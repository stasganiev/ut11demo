...
Процедура ЗаполнитьДоступныеУчетныеЗаписи(РезультатДиагностики, ПараметрыВыполненияДиагностики) 
	...
	Иначе
		...
		ТаблицаДоступныхСертификатов = ТаблицаДоступныхСертификатов(ПараметрыВыполненияДиагностики, ОтборСертификатов);
...
Функция НовыйОтчетДляАдминистратора() 
	...
	НовыйОтчетДляАдминистратора = Новый Структура();
	НовыйОтчетДляАдминистратора.Вставить("Текст", "");
	НовыйОтчетДляАдминистратора.Вставить("Заголовок", "");
	
	Возврат НовыйОтчетДляАдминистратора;
...
Функция ТаблицаДоступныхСертификатов(ПараметрыВыполненияДиагностики, ОтборСертификатов = Неопределено)
