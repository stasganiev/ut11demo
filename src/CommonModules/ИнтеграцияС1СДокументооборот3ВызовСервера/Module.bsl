...
//
Функция ДлительнаяОперацияНадЗадачей(ТипОперации, ДанныеПоЗадаче, УникальныйИдентификатор,
...
//   см. ДлительныеОперации.ВыполнитьВФоне
//
Функция ДлительнаяОперацияСОбработкой(ТипОперации, ДанныеОбработки, УникальныйИдентификатор,
...
//   см. ДлительныеОперации.ВыполнитьВФоне
//
Функция ПолучитьHTMLПредпросмотрОбъектаАсинхронно(УникальныйИдентификатор, ID, Тип, ИгнорироватьМаксРазмер = Ложь) Экспорт
...
//   см. ДлительныеОперации.ВыполнитьВФоне
//
Функция ПроверитьУчастниковАсинхронно(ДействиеXDTOСтрока, УникальныйИдентификатор) Экспорт
...
Функция ИзменитьСрокИсполненияПоПредставлению(Дата, Дни, Часы, Минуты, ВариантУстановкиСрока, Представление,
	...
	Если ИнтеграцияС1СДокументооборотБазоваяФункциональность.ПроверитьТип(Прокси, Ответ, "DMError") Тогда
		...
		ЗаписьЖурналаРегистрации(
			...
			ПараметрыИзмененияСрока.ТекстСообщенияПредупреждения);
	Иначе
