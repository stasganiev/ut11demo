...
Процедура ПерезаполнитьОбъектУчетаПоЭлектронномуДокументу(ОбъектУчета, Знач ЭлектронныйДокумент, СпособОбработки = "", 
	КонтекстОперации = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
...
Функция ДополнительныеПараметрыПерезаполненияДокументаИБ() Экспорт
	...
	Возврат ИнтеграцияЭДО.ДополнительныеПараметрыПерезаполненияДокументаИБ();
...
Процедура ПодключитьИспользованиеФорматаДоговорныхДокументовXML() Экспорт
	...
	ЭлектронныеДокументыЭДО.ПодключитьИспользованиеФорматаДоговорныхДокументовXML();
