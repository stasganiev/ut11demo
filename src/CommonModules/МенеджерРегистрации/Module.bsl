// Регистрация ERP Синхронизация данных через универсальный формат (2.5.12, v.1) от 02.02.2024 16:34:59
...
Функция ПараметрыРегистрации() Экспорт
	...
	Результат.Вставить("Наименование", НСтр("ru = 'ERP Синхронизация данных через универсальный формат (2.5.12, v.1)'"));
	Результат.Вставить("ДатаВремяСоздания", Дата(2024,1,10,14,49,0));
	...
	Результат.Вставить("ВерсияКонфигурации", "2.5.15.13");
...
Функция Документ_РеализацияТоваровУслуг_ОтборПоСвойствамОбъекта()
	Возврат "<ОтборПоСвойствамОбъекта>
			...
			|		<СвойствоОбъекта>ХозяйственнаяОперация</СвойствоОбъекта>
			|		<Вид>АлгоритмЗначения</Вид>
			|		<ЗначениеКонстанты>Значение = ПредопределенноеЗначение(""Перечисление.ХозяйственныеОперации.РеализацияЧерезКомиссионераБезПереходаПраваСобственности"") ;</ЗначениеКонстанты>
			|		<ТаблицаСвойствОбъекта>
			|			<Свойство>
			|				<Наименование>ХозяйственнаяОперация</Наименование>
			|				<Тип>ПеречислениеСсылка.ХозяйственныеОперации</Тип>
			...
			|		<СвойствоОбъекта>ХозяйственнаяОперация</СвойствоОбъекта>
			|		<Вид>АлгоритмЗначения</Вид>
			|		<ЗначениеКонстанты>Значение =  ПредопределенноеЗначение(""Перечисление.ХозяйственныеОперации.РеализацияЧерезКомиссионера"");</ЗначениеКонстанты>
			|		<ТаблицаСвойствОбъекта>
			|			<Свойство>
			|				<Наименование>ХозяйственнаяОперация</Наименование>
			|				<Тип>ПеречислениеСсылка.ХозяйственныеОперации</Тип>
...
Процедура ДобавитьПРО_Справочник_СерииНоменклатуры(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	...
	УстановитьОтборы(НовоеПравило, 
		ОтборПоСвойствамПланаОбмена_19(),
		ОтборПоСвойствамОбъекта_2());
КонецПроцедуры
...
Функция ОтборПоСвойствамПланаОбмена_16()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>false</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Дата</ТипСвойстваОбъекта>
...
Функция ОтборПоСвойствамПланаОбмена_19()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>true</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Строка</ТипСвойстваОбъекта>
