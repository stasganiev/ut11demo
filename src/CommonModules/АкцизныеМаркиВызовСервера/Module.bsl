...
Функция ОбработатьДанныеШтрихкодаПослеВыбораНоменклатуры(РезультатВыбора, РезультатОбработкиШтрихкода, ПараметрыСканирования) Экспорт
	...
	Если ДанныеШтрихкода.ТипУпаковки = Перечисления.ТипыУпаковок.МаркированныйТовар Тогда
		...
		ДанныеКодовМаркировки = Новый Массив;
		ДанныеКодовМаркировки.Добавить(ДанныеШтрихкода);
		ШтрихкодированиеЕГАИС.ЗаполнитьТаблицуДанныеКодовМаркировкиОписаниемНоменклатуры(ДанныеКодовМаркировки, ПараметрыСканирования);
		ШтрихкодированиеЕГАИС.ЗаполнитьРезультатОбработкиШтрихкодаЧастичноеВыбытие(ДанныеШтрихкода, РезультатОбработкиШтрихкода, ПараметрыСканирования);
