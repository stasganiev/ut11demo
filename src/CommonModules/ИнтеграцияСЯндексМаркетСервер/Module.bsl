...
Функция ОбновитьКлючиДоступа(ДанныеАвторизации)
	...
	Попытка
		...
		HTTPЗапрос = ИнтеграцияСЯндексМаркетСервер.ЗапросОбновитьТокеныДоступа(Идентификатор);
...
// Параметры:
//   УчетнаяЗапись               - СправочникСсылка.УчетныеЗаписиМаркетплейсов - учетная запись подключения к сервису;
//   ПрефиксыРегламентныхЗаданий - СписокЗначений Из Строка, Неопределено - см. ИнтеграцияСЯндексМаркетСервер.ПрефиксыРегламентныхЗаданий.
// 
// Возвращаемое значение:
...
//
// Параметры:
//   ДанныеУчетнойЗаписи      - Структура - данные учетной записи (см. ИнтеграцияСЯндексМаркетСервер.ДанныеУчетнойЗаписиЯндексМаркет);
...
//
// Параметры:
//   ОстаткиТоваров - ТаблицаЗначений - см. ИнтеграцияСЯндексМаркетСервер.ПолучитьРазницуОстатковТоваровДляВыгрузки.
//
