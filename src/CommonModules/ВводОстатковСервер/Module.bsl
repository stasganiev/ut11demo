...
#Область ВзаиморасчетыСПартнерами
	ОписаниеРаздела = ОписаниеРазделаВводаОстатковОстаткиВзаиморасчетовСПартнерами();
	ДобавитьОписаниеРазделаВводаОстатков(ОписаниеРазделовВводаОстатков, ОписаниеРаздела);
#КонецОбласти	
...
Функция ОписаниеРазделаВводаОстатковОстаткиВзаиморасчетовСПартнерами()
	...
	ОписаниеРаздела.ХозяйственныеОперации = ОписаниеХозяйственныхОперацийВводаОстатковВзаиморасчетовСПартнерами();
	
	Возврат ОписаниеРаздела;
	
КонецФункции

Функция ОписаниеХозяйственныхОперацийВводаОстатковВзаиморасчетовСПартнерами()
