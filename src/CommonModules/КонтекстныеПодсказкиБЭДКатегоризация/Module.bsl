...
// АПК:299-выкл используется в см. КонтекстныеПодсказкиБЭДПовтИсп.СписокВнеконтекстныхКатегорий
...
Функция ПараметрыДоступныхЗначенийКатегории_LED_DocAccSts() Экспорт
	...
	Если ИнтеграцияЭДО.ЕстьПодсистемаОтражениеВУчетеЭДО() Тогда
		Состояния = ИнтеграцияЭДО.ОбщийМодульОтражениеВУчетеЭДО().СостоянияКонтроляОтраженияВУчете();
