...
Процедура ОткрытьЛичныйКабинетПоставщикаЕИС(ОповещениеОбратногоВызова = Неопределено) Экспорт
	...
	ФайловаяСистемаКлиент.ЗапуститьПрограмму(ГиперссылкаЛКП, ПараметрыЗапускаПрограммы);
...
Процедура ОткрытьЛичныйКабинетПоставщикаЕИСЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если ЗначениеЗаполнено(ОповещениеОбратногоВызова) Тогда
		ВыполнитьОбработкуОповещения(ДополнительныеПараметры.ОповещениеОбратногоВызова, Результат.КодВозврата = 0);
	КонецЕсли;
