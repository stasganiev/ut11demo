...
#Область НастройкиЭДОСлужебный_ТипПодписиЭД
	...
	Обработчик.ПроцедураПроверки = "";
	Обработчик.ЗапускатьИВПодчиненномУзлеРИБСФильтрами = Истина;
	Обработчик.Комментарий = НСтр("ru = '1С:Обмен с контрагентами: Включает тип подписи по умлочанию для электронных документов'");
...
#Область НастройкиЭДОСлужебный_ТипПодписиМЧД
	...
	Обработчик.ПроцедураПроверки = "";
	Обработчик.ЗапускатьИВПодчиненномУзлеРИБСФильтрами = Истина;
	Обработчик.Комментарий = НСтр("ru = '1С:Обмен с контрагентами: Включает тип подписи по умлочанию для машиночитаемых доверенностей'");
