...
Процедура УточнитьДанныеРазбораПоВидуПродукции(СтрокаДанных, ВидПродукции, ПараметрыСканирования) Экспорт
		...
		Для Каждого СтрокаИнформации Из НайденныеШтрихкодыEAN Цикл
			...
			Если ЗначениеЗаполнено(СтрокаИнформации.ВидПродукции) Тогда
				...
				Если СтрокаДанных.ВидПродукции <> СтрокаИнформации.ВидПродукции Тогда
					УточнитьДанныеРазбораПоВидуПродукции(СтрокаДанных, СтрокаИнформации.ВидПродукции, ПараметрыСканирования);
				КонецЕсли;
			...
			Если ЗначениеЗаполнено(СтрокаДанных.ВидПродукции) 
				...
				УточнитьДанныеРазбораПоВидуПродукции(СтрокаДанных, СтрокаДанных.ВидПродукции, ПараметрыСканирования);
...
Функция ДопустимаПродукцияИСМП(ПараметрыСканирования, ВключаяТабачнуюПродукцию = Ложь) Экспорт
	...
	Для Каждого ВидПродукции Из ПараметрыСканирования.ДопустимыеВидыПродукции Цикл
		...
		ИначеЕсли ОбщегоНазначенияИСПовтИсп.ЭтоПродукцияИСМП(ВидПродукции, ВключаяТабачнуюПродукцию) Тогда
			Возврат Истина;
		КонецЕсли;
	КонецЦикла;
