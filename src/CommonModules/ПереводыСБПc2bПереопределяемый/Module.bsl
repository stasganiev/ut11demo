	...
	Попытка
		...
		Иначе
			...
			Если СтатусОплаты = Перечисления.ТипыСтатусовОплатыСБП.Выполнена Тогда
				...
				ДокументОперацииОбъект.Дата = ПреобразоватьДатуСоСмещением(РезультатОбработки.ПараметрыОперации.ДатаОперации);
...
// Возвращает дату, приведенную к часовому поясу сеанса.
//
// Параметры:
//  ЛокальнаяДата - Дата - дата на клиенте.
// 
// Возвращаемое значение:
//   ДатаСоСмещением - Дата - результат преобразования.
//
Функция ПреобразоватьДатуСоСмещением(ЛокальнаяДата) Экспорт
	
	Смещение = СмещениеСтандартногоВремени(ЧасовойПоясСеанса());
	
	ДатаСоСмещением = ЛокальнаяДата + Смещение;	
	
	Возврат ДатаСоСмещением;
