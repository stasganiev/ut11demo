...
Процедура ПриНачалеРаботыСистемы() Экспорт
	...
	ВнешниеКомпонентыБПОКлиент.ПереустановитьКомпоненты(ПараметрыРаботыКлиента.ИменаМакетовДляПереустановки);
...
Функция ПараметрыРаботыКлиентаПриЗапуске() Экспорт
	...
	Если ОбщегоНазначенияБПОКлиент.ИспользуетсяБСП() Тогда
		...
		Если ПараметрыРаботыКлиента.Свойство("ИменаМакетовДляПереустановки") Тогда
