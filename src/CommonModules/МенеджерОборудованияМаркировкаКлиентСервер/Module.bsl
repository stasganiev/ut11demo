...
//   * НаименованиеРеквизита - Строка - 
//
Функция РазобратьШтриховойКодТовараСлужебная(Знач Штрихкод, Знач ШтрихкодВBase64 = Ложь) Экспорт;
...
Функция ЗаполнитьИменаРеквизитовКодаТовара(КодРазобран = Ложь)
	...
	ДанныеКодаТовара.Вставить("ЕстьКриптохвост", Ложь); // в штрихкоде присутсвует криптохвост
