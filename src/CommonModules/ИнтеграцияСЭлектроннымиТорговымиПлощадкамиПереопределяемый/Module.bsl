...
Процедура ДополнитьСКДПодбораТоваровПоОтбору(СхемаКомпоновкиДанных, ДополнительныеПараметры) Экспорт
	Если ПолучитьФункциональнуюОпцию("ИспользоватьИнтеграциюСЭТПБидзаар") Тогда

		ЗаголовокФормы = "";
		Если ДополнительныеПараметры.Свойство("Заголовок", ЗаголовокФормы) Тогда

			Если СтрНайти(НРег(ЗаголовокФормы), "бидзаар") > 0 Тогда
