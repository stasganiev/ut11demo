...
// Возвращает пустой контекст диагностики.
// 
// Возвращаемое значение:
//  Структура - Новый контекст диагностики:
//  * ЗаголовокОперации - Строка
//  * Диагностика - Структура:
//  ** Ошибки - Массив из см. ОбработкаНеисправностейБЭД.НоваяОшибка
//  * ТекущийПользовательИБ - Строка
//  * ДатаНачалаОперации - Дата
//  * ДатаОкончанияОперации - Дата
//  * ОшибкиОбработаны - Булево
