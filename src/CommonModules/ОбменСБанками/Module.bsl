...
//
Функция ПолучитьПричинуОтклонениияДокументаБанком(ПлатежныйДокумент)Экспорт
