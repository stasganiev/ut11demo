...
Функция РезультатЛабораторныхИсследований(КодИлиЗначение) Экспорт
	...
	ИначеЕсли КодИлиЗначение = "UNDEFINED" Тогда
		Результат = Перечисления.РезультатыЛабораторныхИсследованийВЕТИС.РезультатНевозможноОпределить;
	...
	ИначеЕсли КодИлиЗначение = Перечисления.РезультатыЛабораторныхИсследованийВЕТИС.НетДанных Тогда
		Результат = "UNKNOWN"
	ИначеЕсли КодИлиЗначение = Перечисления.РезультатыЛабораторныхИсследованийВЕТИС.РезультатНевозможноОпределить Тогда
		Результат = "UNDEFINED"
...
Функция ПредставленияНастроекОптимизации() Экспорт
	...
	ВозвращаемоеЗначение.Вставить(
		"ВыполнятьСинхронизацииТолькоВРегламентномЗадании",
		НСтр("ru = 'Выполнять синхронизации только в регламентном задании'"));
	ВозвращаемоеЗначение.Вставить(
		"ЗагружатьДокументыСозданныеЧерезWeb",
		НСтр("ru = 'Загружать документы созданные через WEB'"));
