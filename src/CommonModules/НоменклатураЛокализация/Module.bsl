...
Процедура ОтборПолитикУчетаСерийПоПараметрам(Отбор, Параметры) Экспорт
	...
	ЭтоПодконтрольнаяПродукцияВЕТИС = Параметры.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.ПодконтрольнаяПродукцияВЕТИС
		...
		Или Параметры.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.ЗерноВЕТИС
		Или Параметры.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.ПродуктыПереработкиЗернаВЕТИС
		Или Параметры.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.КормаДляЖивотныхПодконтрольныеВЕТИС
		Или Параметры.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.МясоПодконтрольноеВЕТИС
		Или Параметры.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.КонсервированнаяПродукцияПодконтрольнаяВЕТИС
		Или Параметры.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.МорепродуктыПодконтрольныеВЕТИС;
	
	Если Параметры.ТипНоменклатуры = Перечисления.ТипыНоменклатуры.Товар
		И Параметры.ОсобенностьУчета = Перечисления.ОсобенностиУчетаНоменклатуры.ПродукцияИзНатуральногоМеха
...
Функция ОсобенностиУчетаВЕТИС()
	...
	Особенности.Добавить("МолочнаяПродукцияПодконтрольнаяВЕТИС");
	Особенности.Добавить("ЗерноВЕТИС");
	Особенности.Добавить("ПродуктыПереработкиЗернаВЕТИС");
	Особенности.Добавить("МорепродуктыПодконтрольныеВЕТИС");
