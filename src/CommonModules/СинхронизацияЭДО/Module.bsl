...
// 
// Параметры:
// 	ЗапросОбъектов - см. ОбщегоНазначенияБЭД.НовоеОписаниеЗапроса
...
//  * РезультатыОтправкиПолучения - см. ИнтерфейсДокументовЭДОКлиентСервер.НовыеРезультатыОтправкиПолучения
...
Функция ОтправитьОбъекты(ЗапросОбъектов, КонтекстДиагностики, ОтпечаткиСертификатов, ВыбранныеСертификаты = Неопределено,
	ДополнительныеПараметры = Неопределено, РасшифрованныеМаркеры = Неопределено) Экспорт
	...
	Если ЗначениеЗаполнено(РасшифрованныеМаркеры) Тогда
		ЗаполнитьКлючиСинхронизацииТокенамиАутентификации(ДанныеДляСинхронизации.КлючиСинхронизации,
	...
	РезультатОтправки = СинхронизацияЭДОСлужебный.СформироватьИОтправитьТранспортныеКонтейнеры(КонтекстОтправки,
		КонтекстДиагностики, ДанныеДляСинхронизации.КлючиСинхронизации,, ДополнительныеПараметры);
	
	РезультатОтправки.Вставить("ДанныеДляСинхронизации", ДанныеДляСинхронизации);
...
// Параметры:
//  КлючиСинхронизации - Массив из см. СинхронизацияЭДОКлиентСервер.НовыйКлючСинхронизации
//  РасшифрованныеМаркеры - Соответствие из КлючИЗначение:
//  * Ключ - Строка - идентификатор учетной записи ЭДО.
//  * Значение - Структура:
//  ** Сертификат - СправочникСсылка.СертификатыКлючейЭлектроннойПодписиИШифрования
//  ** Данные - ДвоичныеДанные - данные расшифрованнного маркера.
Процедура ЗаполнитьКлючиСинхронизацииТокенамиАутентификации(КлючиСинхронизации, РасшифрованныеМаркеры) Экспорт
	
	Для Каждого КлючСинхронизации Из КлючиСинхронизации Цикл
		ПараметрыМаркера = РасшифрованныеМаркеры[КлючСинхронизации.Ключ];
		Если ПараметрыМаркера = Неопределено Тогда
			Продолжить;
		КонецЕсли;
		КлючСинхронизации.Значение.ВыбранныйСертификат = ПараметрыМаркера.Сертификат;
		КлючСинхронизации.Значение.МаркерРасшифрованный = ПараметрыМаркера.Данные;
	КонецЦикла;
...
Функция НовыеДанныеОбъектов() Экспорт
	...
	ДанныеОбъектов.Колонки.Добавить("ОписаниеДополнительныхДанных"); // DataImage
...
Функция ПоддерживаетсяПередачаМЧДВТранспортномКонтейнере(СпособОбмена) Экспорт
	...
	Возврат СпособОбмена = Перечисления.СпособыОбменаЭД.ЧерезСервис1СЭДО
		Или СпособОбмена = Перечисления.СпособыОбменаЭД.ЧерезОператораЭДОТакском;
	
КонецФункции

// Возвращает дату последнего изменения данных в сервисе настроек по переданному типу синхронизации.
// 
// Параметры:
//  ТипСинхронизации - ПеречислениеСсылка.ТипыСинхронизацииСервисаНастроекЭДО
// 
// Возвращаемое значение:
//  ДатаВремя - дата последнего изменения
//
Функция ДатаПоследнегоИзмененияДанныхСервисаНастроек(ТипСинхронизации) Экспорт
	...
	Запрос.Текст =
		...
		|ГДЕ
		|	СостоянияСинхронизацииСервисНастроекЭДО.ТипСинхронизации = &ТипСинхронизации";
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ДатаПоследнегоИзменения = ВыборкаДетальныеЗаписи.ДатаПоследнегоИзменения;
...
//
// Возвращаемое значение:
//  См. СинхронизацияЭДОСлужебный.ДанныеДляСинхронизации
//
Функция ДанныеДляСинхронизации(ОтпечаткиСертификатов, КонтекстДиагностики, УчетныеЗаписи = Неопределено, ВыбранныеСертификаты = Неопределено) Экспорт
	Возврат СинхронизацияЭДОСлужебный.ДанныеДляСинхронизации(ОтпечаткиСертификатов, КонтекстДиагностики, УчетныеЗаписи, ВыбранныеСертификаты);
КонецФункции
...
// 
// Возвращаемое значение:
//  См. СинхронизацияЭДОСлужебный.ПолучитьКонтейнеры
Функция ПолучитьКонтейнеры(КлючиСинхронизации, ОтпечаткиСертификатов, КонтекстДиагностики, РезультатыОтправкиПолучения = Неопределено, ПовторноеПолучение = Ложь) Экспорт
	Возврат СинхронизацияЭДОСлужебный.ПолучитьКонтейнеры(КлючиСинхронизации, ОтпечаткиСертификатов, КонтекстДиагностики,
...
// 
// Возвращаемое значение:
//  См. СинхронизацияЭДОСлужебный.СертификатыПоОтпечаткам
Функция СертификатыПоОтпечаткам(РезультатыПолученияОтпечатков) Экспорт
	Возврат СинхронизацияЭДОСлужебный.СертификатыПоОтпечаткам(РезультатыПолученияОтпечатков);
КонецФункции
...
// 
// Параметры:
//  КонтекстДиагностики - Неопределено - значение по умолчанию
//                      - см. ОбработкаНеисправностейБЭД.НовыйКонтекстДиагностики
//  
// Возвращаемое значение:
//  Структура - содержание результатов:
//   * КонтекстДиагностики - см. ОбработкаНеисправностейБЭД.НовыйКонтекстДиагностики
//                         - Неопределено
//
Функция ОбновитьКешиОператоровЭДОИФорматов(КонтекстДиагностики = Неопределено) Экспорт
	...
	СинхронизацияФорматовЭД                        = ТипыСинхронизации.СинхронизацияФорматовЭД;
	СинхронизацияСовместимостиОператоровЭДО        = ТипыСинхронизации.СинхронизацияСовместимостиОператоровЭДО;
	ОбновлениеАбонентовЭДО                         = ТипыСинхронизации.ОбновлениеАбонентовЭДО;
	СвязьТиповИФорматовЭД                          = ТипыСинхронизации.СвязьТиповИФорматовЭД;
	СинхронизацияКонтрагентовСоздаваемыхБезусловно = ТипыСинхронизации.СинхронизацияКонтрагентовСоздаваемыхБезусловно;
		...
		Попытка
			...
			ИначеЕсли ВыборкаДетальныеЗаписи.ТипСинхронизации = СинхронизацияКонтрагентовСоздаваемыхБезусловно Тогда
				СинхронизироватьКонтрагентовСоздаваемыхБезусловно(СинхронизацияКонтрагентовСоздаваемыхБезусловно,
					ВыборкаДетальныеЗаписи.ДатаПоследнегоИзменения, КонтекстДиагностики);
			ИначеЕсли ВыборкаДетальныеЗаписи.ТипСинхронизации = ОбновлениеКлассификатораПолномочийФНСМЧД002 Тогда
				
				ПараметрыСинхронизации = ПараметрыСинхронизацииКлассификатораПолномочийФНС_МЧД002();
				ПараметрыСинхронизации.ДатаПоследнегоИзменения = ВыборкаДетальныеЗаписи.ДатаПоследнегоИзменения;
				ПараметрыСинхронизации.КонтекстДиагностики     = КонтекстДиагностики;
				
				СинхронизироватьКлассификаторПолномочийФНС_МЧД002(ПараметрыСинхронизации);
				
			ИначеЕсли ВыборкаДетальныеЗаписи.ТипСинхронизации = ОбновлениеКлассификатораПолномочийФНСМЧД003 Тогда
				
				ПараметрыСинхронизации = ПараметрыСинхронизацииКлассификатораПолномочийФНС_МЧД003();
				ПараметрыСинхронизации.ДатаПоследнегоИзменения = ВыборкаДетальныеЗаписи.ДатаПоследнегоИзменения;
				ПараметрыСинхронизации.КонтекстДиагностики     = КонтекстДиагностики;
				
				СинхронизироватьКлассификаторПолномочийФНС_МЧД003(ПараметрыСинхронизации);
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Попытка
			СервисНастроекЭДО.ОтправитьДанныеАбонентаВСервисНастроек(ВыборкаДетальныеЗаписи.ИдентификаторЭДО);
		Исключение
...
// Проверяет наличие учетных записей электронного документооборота у переданных организаций.
// 
// Параметры:
// 	Организации - Массив из ОпределяемыйТип.Организация
// Возвращаемое значение:
// 	Массив из ОпределяемыйТип.Организация
Функция ОрганизацииСУчетнойЗаписью(Организации) Экспорт
	...
	ОрганизацииСУчетнымиЗаписями = Выгрузка.ВыгрузитьКолонку("Организация");
	
	Возврат ОрганизацииСУчетнымиЗаписями;
...
// Заполняет описание дополнительных данных документа дополнительным файлом.
// В случае, если у документа несколько дополнительных файлов,
// они формируются в zip-архив с префиксом см. ПрефиксАрхиваДополнительныхФайлов.
//
// Параметры:
//  ДанныеДокумента - см. СинхронизацияЭДО.НовыеДанныеОбъектов
//  ДополнительныеФайлы - См. НовоеОписаниеДополнительныхФайлов
//  Отказ - Булево - при выполнении операции произошла ошибка. Если при создании zip-архива произошла ошибка,
//                   выполняется запись в журнал регистрации и выводится ошибка пользователю.
//
Процедура ЗаполнитьОписаниеДополнительныхДанныхДокумента(ДанныеДокумента, Знач ДополнительныеФайлы, Отказ) Экспорт
	
	Если Не ЗначениеЗаполнено(ДополнительныеФайлы)Тогда
		Возврат;
	КонецЕсли;
	
	НайденныеФайлы = ДополнительныеФайлы.НайтиСтроки(Новый Структура("ОбъектУчета", ДанныеДокумента.Объект));
	...
	Если НайденныеФайлы.Количество() = 1 Тогда
		...
		ДополнительныйФайл = НайденныеФайлы[0];

		ДвоичныеДанныеФайла = ДополнительныйФайл.ДвоичныеДанныеФайла;
		ИмяФайла            = ДополнительныйФайл.ИмяФайла;
	Иначе
		
		АдресКаталога = ФайловаяСистема.СоздатьВременныйКаталог();
		ФайлыДобавляемыеВАрхив = Новый Массив;
		Для Каждого ДополнительныйФайл Из НайденныеФайлы Цикл
		
			ПутьКФайлу = АдресКаталога + ДополнительныйФайл.ИмяФайла;
			ДополнительныйФайл.ДвоичныеДанныеФайла.Записать(ПутьКФайлу);
			
			ФайлыДобавляемыеВАрхив.Добавить(ПутьКФайлу);
		КонецЦикла;
		...
		ИмяФайла = СтрШаблон("%1%2.zip", ПрефиксАрхиваДополнительныхФайлов(), Строка(Новый УникальныйИдентификатор));
		ИмяФайла = ОбщегоНазначенияКлиентСервер.ЗаменитьНедопустимыеСимволыВИмениФайла(ИмяФайла);
		
	КонецЕсли;
	
	ДанныеДокумента.ОписаниеДополнительныхДанных.ДвоичныеДанные = ДвоичныеДанныеФайла;
	ДанныеДокумента.ОписаниеДополнительныхДанных.ИмяФайла       = ИмяФайла;
	
КонецПроцедуры

// Прочитывает дополнительные данные электронного документа.
// В случае, если дополнительные данные лежат в zip-архиве с префиксом см. ПрефиксАрхиваДополнительныхФайлов,
// то распаковываем содержимое на отдельные файлы.
//
// Параметры:
//  ДополнительныеФайлы - См. НовоеОписаниеДополнительныхФайлов - дополнительные файлы документа из zip-архива. Выходной параметр.
//  ОписаниеДополнительныхДанных - См. РаботаСФайламиБЭДКлиентСервер.НовоеОписаниеФайла
//  КонтекстДиагностики - См. ОбработкаНеисправностейБЭД.НовыйКонтекстДиагностики.
//
Процедура ПрочитатьДополнительныеДанныеДокумента(ДополнительныеФайлы, Знач ОписаниеДополнительныхДанных, КонтекстДиагностики = Неопределено) Экспорт
	
	Если ОписаниеДополнительныхДанных = Неопределено
		Или ОписаниеДополнительныхДанных.ДвоичныеДанные = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	Если Не СтрНачинаетсяС(ОписаниеДополнительныхДанных.ИмяФайла, ПрефиксАрхиваДополнительныхФайлов()) Тогда
		ДополнительныйФайл = ДополнительныеФайлы.Добавить();
		ДополнительныйФайл.ИмяФайла            = ОписаниеДополнительныхДанных.ИмяФайла;
		ДополнительныйФайл.ДвоичныеДанныеФайла = ОписаниеДополнительныхДанных.ДвоичныеДанные;
		
		ДанныеФайла = ОбщегоНазначенияКлиентСервер.РазложитьПолноеИмяФайла(ДополнительныйФайл.ИмяФайла);
		ДополнительныйФайл.ИмяБезРасширения   = ДанныеФайла.ИмяБезРасширения;
		ДополнительныйФайл.РасширениеБезТочки = ОбщегоНазначенияКлиентСервер.РасширениеБезТочки(
			ДанныеФайла.Расширение);
		Возврат;
	КонецЕсли;
	
	ДвоичныеДанныеФайла = ОписаниеДополнительныхДанных.ДвоичныеДанные;
	...
	РезультатРаспаковки = Неопределено;
	ВидОперации = НСтр("ru = 'Распаковка дополнительных файлов ЭДО'", ОбщегоНазначения.КодОсновногоЯзыка());
	ТекстСообщения = НСтр("ru = 'Ошибка при распаковке дополнительных файлов ЭДО'", ОбщегоНазначения.КодОсновногоЯзыка());
	Попытка
		РезультатРаспаковки = РаботаСФайламиБЭД.РаспаковатьАрхив(ДвоичныеДанныеФайла, КаталогРаспаковки, КонтекстДиагностики,
			ВидОперации, ПараметрыРаспаковки);
	Исключение
	...
	Для Каждого СтрокаФайл Из РезультатРаспаковки Цикл
		ДополнительныйФайл = ДополнительныеФайлы.Добавить();
		ДополнительныйФайл.ИмяФайла            = СтрокаФайл.Имя;
		ДополнительныйФайл.ДвоичныеДанныеФайла = Новый ДвоичныеДанные(СтрокаФайл.ПолноеИмя);
		ДополнительныйФайл.ИмяБезРасширения    = СтрокаФайл.ИмяБезРасширения;
		ДополнительныйФайл.РасширениеБезТочки  = СтрокаФайл.Расширение;
	КонецЦикла;
	
КонецПроцедуры

// Возвращаемое значение:
//  ТаблицаЗначений - описание дополнительных файлов электронного документа:
//   * ОбъектУчета         - Неопределено, ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО - ссылка на объект учета.
//   * ИмяФайла            - Строка - представление файла.
//   * ДвоичныеДанныеФайла - ДвоичныеДанные - данные файла в двоичных данных.
//   * РасширениеБезТочки  - Строка - расширение файла без точки.
//   * ИмяБезРасширения    - Строка - имя файла без расширения.
//
Функция НовоеОписаниеДополнительныхФайлов() Экспорт
	
	ТипыОбъектУчета = Метаданные.ОпределяемыеТипы.ОснованияЭлектронныхДокументовЭДО.Тип.Типы();
	
	Результат = Новый ТаблицаЗначений;
	Результат.Колонки.Добавить("ОбъектУчета"        , Новый ОписаниеТипов(ТипыОбъектУчета));
	Результат.Колонки.Добавить("ИмяФайла"           , Новый ОписаниеТипов("Строка"));
	Результат.Колонки.Добавить("ДвоичныеДанныеФайла", Новый ОписаниеТипов("ДвоичныеДанные"));
	Результат.Колонки.Добавить("РасширениеБезТочки" , Новый ОписаниеТипов("Строка"));
	Результат.Колонки.Добавить("ИмяБезРасширения"   , Новый ОписаниеТипов("Строка"));
...
Процедура СинхронизироватьКлассификаторПолномочийФНС_МЧД002(ПараметрыОперации, АдресРезультата = Неопределено) Экспорт
	...
	ДанныеКлассификатора = СервисНастроекЭДО.ПолучитьКлассификаторПолномочийФНС_МЧД002(ПараметрыОперации.КонтекстДиагностики);
	Если ДанныеКлассификатора = Неопределено Тогда
		Возврат;
	КонецЕсли;
	НачатьТранзакцию();
	Попытка
		МашиночитаемыеДоверенности.ОбновитьКлассификаторПолномочийФНС_МЧД002(ДанныеКлассификатора);
		СервисНастроекЭДО.ИзменитьСостояниеСинхронизации(ПараметрыОперации.ТипСинхронизации,
...
Процедура СинхронизироватьКлассификаторПолномочийФНС_МЧД003(ПараметрыОперации, АдресРезультата = Неопределено) Экспорт
	...
	ДанныеКлассификатора = СервисНастроекЭДО.ПолучитьКлассификаторПолномочийФНС_МЧД003(ПараметрыОперации.КонтекстДиагностики);
	Если ДанныеКлассификатора = Неопределено Тогда
		Возврат;
	КонецЕсли;
	НачатьТранзакцию();
	Попытка
		МашиночитаемыеДоверенности.ОбновитьКлассификаторПолномочийФНС_МЧД003(ДанныеКлассификатора);
		СервисНастроекЭДО.ИзменитьСостояниеСинхронизации(ПараметрыОперации.ТипСинхронизации,
			ДанныеКлассификатора.ДатаПоследнегоИзменения);
		ЗафиксироватьТранзакцию();
	Исключение
...
// * КонтекстДиагностики     - Неопределено
//
Функция ПараметрыСинхронизацииКлассификатораПолномочийФНС_МЧД002()
...
// * КонтекстДиагностики     - Неопределено
//
Функция ПараметрыСинхронизацииКлассификатораПолномочийФНС_МЧД003()
...
// Возвращаемое значение:
//  Строка - префикс архива дополнительных файлов.
Функция ПрефиксАрхиваДополнительныхФайлов()
