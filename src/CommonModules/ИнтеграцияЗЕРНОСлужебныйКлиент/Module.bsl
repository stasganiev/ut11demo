...
Функция ПарольСертификатаУстановлен(СертификатСсылка) Экспорт
	...
	Если ПараметрыРаботыКлиента[ИменаПараметров.ВерсияБСППоддерживаетПроверкуСохраненногоПароляСертификатаНаКлиенте] Тогда
		
		МодульЭлектроннаяПодписьКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("ЭлектроннаяПодписьКлиент");
		//@skip-check unknown-method-property
		Возврат МодульЭлектроннаяПодписьКлиент.ПарольСертификатаУстановлен(СертификатСсылка);
	...
	Иначе
		...
		Возврат Форма.ПарольСертификатаУстановлен(СертификатСсылка);
	...
	Если Результат.ДанныеАвтоподписания <> Неопределено Тогда
		...
		Для Каждого КлючИЗначение Из Результат.ДанныеАвтоподписания Цикл
			...
			Для Каждого Сертификат Из Результат.ДоступныеСертификаты[Организация] Цикл
				...
				Если ПарольСертификатаУстановлен(Сертификат) Тогда
