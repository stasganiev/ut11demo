...
Функция ЗапросПолученияРезультатаОбработкиЗаявкиXML(ХозяйствующийСубъект, ИдентификаторЗаявки, НастройкаОбмена) Экспорт
	...
	ЗапросКвитанции = РаботаСXMLИС.ОбъектXDTOПоИмениСвойства(ПространствоИмен, ИмяТипа);
...
Функция ЗаявкаXML(Запрос, НастройкаОбмена, ХранилищеВременныхДат) Экспорт
	...
	Заявка = РаботаСXMLИС.ОбъектXDTOПоИмениСвойства(ПространствоИмен, ИмяПакета);
	Заявка.apiKey = НастройкаОбмена.КлючAPI;
	
	Заявка.application = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Заявка, "application");
	...
	Заявка.application.data = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Заявка.application, "data");
...
Функция ЗапросНаРегистрациюИзменениеПредприятияXML(ХозяйствующийСубъект, ДанныеПредприятия, ПараметрыОбмена) Экспорт
	...
	Запрос = РаботаСXMLИС.ОбъектXDTOПоИмениСвойства(ПространствоИмен, ИмяТипа);
	
	Запрос.initiator = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос, "initiator");
	...
	Запрос.modificationOperation = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос, "modificationOperation");
	...
	Запрос.modificationOperation.resultingList = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос.modificationOperation, "resultingList");
	...
	enterprise = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос.modificationOperation.resultingList, "enterprise");
	...
	enterprise.activityList = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(enterprise, "activityList");
	
	Для Каждого ВидДеятельности Из ДанныеПредприятия.ВидыДеятельности Цикл
		
		activity = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(enterprise.activityList, "activity");
	...
	Если ДанныеПредприятия.Свойство("СобственникПредприятия")
		...
		enterprise.owner = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(enterprise, "owner");
...
Функция ЗапросНаРегистрациюИзменениеХозяйствующегоСубъектаXML(ХозяйствующийСубъект, ДанныеХозяйствующегоСубъекта, ПараметрыОбмена) Экспорт
	...
	businessEntity = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос.modificationOperation.resultingList, "businessEntity");
	...
	businessEntity.incorporationForm = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(businessEntity, "incorporationForm");
...
Функция ЗапросНаСозданиеУдалениеСвязиМеждуХозяйствующимСубъектомИПредприятиемXML(ХозяйствующийСубъект, Предприятие, СпособИзменения, GLN, ПараметрыОбмена) Экспорт
	...
	Запрос.modificationOperation.businessEntity = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос.modificationOperation, "businessEntity");
	Запрос.modificationOperation.businessEntity.guid = НастройкаОбмена.Идентификатор;
	
	activityLocation = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос.modificationOperation, "activityLocation");
	...
	activityLocation.enterprise = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(activityLocation, "enterprise");
...
Функция ЗапросНаАннулированиеВетеринарноСопроводительногоДокументаПоUUIDXML(ХозяйствующийСубъект, ПараметрыЗапроса, ПараметрыОбмена) Экспорт
	...
	Запрос.specifiedPerson = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос, "initiator");
...
Функция ЗапросВетеринарноСопроводительныхДокументовXML(ХозяйствующийСубъект, ПараметрыЗапроса, ПараметрыОбмена) Экспорт
	...
	Если ПараметрыЗапроса.ПараметрыОтбора <> Неопределено Тогда
		...
		Если ПараметрыОтбора.Свойство("Интервал") И ТипЗнч(ПараметрыОтбора.Интервал) = Тип("Структура") Тогда
			Запрос.issueDateInterval = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос, "issueDateInterval");
		...
		Если ПараметрыОтбора.Свойство("ГрузоотправительПредприятие") И ЗначениеЗаполнено(ПараметрыОтбора.ГрузоотправительПредприятие) Тогда
			ЭлементConsignor  = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос, "consignor");
			ЭлементEnterprise = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(ЭлементConsignor, "enterprise");
			...
			Если ПараметрыОтбора.Свойство("ГрузоотправительХозяйствующийСубъект")
			   И ЗначениеЗаполнено(ПараметрыОтбора.ГрузоотправительХозяйствующийСубъект) Тогда
				ЭлементBusinessEntity = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(ЭлементConsignor, "businessEntity");
		...
		Если ПараметрыОтбора.Свойство("СвязанныйДокумент") И ТипЗнч(ПараметрыОтбора.СвязанныйДокумент) = Тип("Структура") Тогда
			Запрос.referencedDocument = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос, "referencedDocument");
...
Функция ЗапросЗаписейСкладскогоЖурналаXML(ХозяйствующийСубъект, ПараметрыЗапроса, ПараметрыОбмена) Экспорт
	...
	Запрос = РаботаСXMLИС.ОбъектXDTOПоИмениСвойства(ПараметрыЗапросаВЕТИС.ПространствоИмен, ПараметрыЗапросаВЕТИС.ТипВЕТИС);
	...
	Запрос.searchPattern = РаботаСXMLИС.ОбъектXDTOПоИмениСвойства(ПараметрыЗапросаВЕТИС.ПространствоИмен, "searchPattern", Запрос);
...
Функция ЗапросНаСозданиеИзменениеПродукцииXML(ХозяйствующийСубъект, ДанныеПродукции, ПараметрыОбмена) Экспорт
	...
	productItem = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос.modificationOperation.resultingList, "productItem");
	...
	productItem.product    = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(productItem, "product");
	productItem.subProduct = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(productItem, "subProduct");
	...
	Если ЗначениеЗаполнено(ДанныеПродукции.ХозяйствующийСубъектПроизводитель) Тогда
		productItem.producer = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(productItem, "producer");
	...
	КонецЕсли;
	Если ЗначениеЗаполнено(ДанныеПродукции.ХозяйствующийСубъектСобственникТорговойМарки) Тогда
		productItem.tmOwner = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(productItem, "tmOwner");
	...
	Для Каждого Производитель Из ДанныеПродукции.Производители Цикл
		...
		ЭлементДанных = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(productItem, "producing");
		ЭлементДанных.location = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(ЭлементДанных, "location");
	...
	productItem.packaging = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(productItem, "packaging");
	
	Если ЗначениеЗаполнено(ДанныеПродукции.ФасовкаУпаковка) Тогда
		productItem.packaging.packagingType = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(productItem.packaging, "packagingType");
	...
	Если ЗначениеЗаполнено(ДанныеПродукции.ФасовкаЕдиницаИзмерения) Тогда
		productItem.packaging.unit = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(productItem.packaging, "unit");
...
Функция ЗапросДанныхПользователяXML(ХозяйствующийСубъект, ПараметрыЗапроса, ПараметрыОбмена) Экспорт
	...
	Запрос.user = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос, "user");
...
Функция ЗапросНаИзменениеПравПользователей(ХозяйствующийСубъект, ПараметрыЗапроса, ПараметрыОбмена) Экспорт
	...
	ЭлементUser = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос, "user");
	...
	Для Каждого ДанныеПользователя Из ПараметрыЗапроса.ДанныеПользователей Цикл
		...
		ЭлементAuthorityList = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(ЭлементUser, "authorityList");
		...
		Для Каждого ПравоДоступаВЕТИС Из ДанныеПользователя.ПраваДоступа Цикл
			...
			Если ИдентификаторРоли <> Неопределено Тогда
				ЭлементAuthority = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(ЭлементAuthorityList, "authority");
...
Функция ЗапросНаИзменениеЗонОтветственностиПользователейXML(ХозяйствующийСубъект, ПараметрыЗапроса, ПараметрыОбмена) Экспорт
	...
	Для Каждого ДанныеПользователя Из ПараметрыЗапроса.ДанныеПользователей Цикл
		...
		Если ДанныеПользователя.Предприятия.Количество() > 0
			...
			ЭлементWorkingAreaList = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(ЭлементUser, "workingAreaList");
			...
			Для Каждого Предприятие Из ДанныеПользователя.Предприятия Цикл
				...
				ЭлементWorkingArea = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(ЭлементWorkingAreaList, "workingArea");
				ЭлементWorkingArea.enterprise = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(ЭлементWorkingArea, "enterprise");
...
Функция ЗапросНаРегистрациюИПривязкуПользователейХозяйствующегоСубъектаXML(ХозяйствующийСубъект, ПараметрыЗапроса, ПараметрыОбмена) Экспорт
	...
	Для Каждого ДанныеПользователя Из ПараметрыЗапроса.ДанныеПользователей Цикл
		...
		Иначе
			...
			ЭлементIdentity = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(ЭлементUser, "identity");
			...
			ЭлементCitizenship = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(ЭлементUser, "citizenship");
			ЭлементCountry     = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(ЭлементCitizenship, "country");
...
Функция ЗапросНаВнесениеСведенийОВетеринарныхОперацияхXML(ХозяйствующийСубъект, ПараметрыЗапроса, ПараметрыОбмена) Экспорт
	...
	Запрос.enterprise = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос, "enterprise");
	...
	Для каждого СведенияОЗаписиЖурнала Из ПараметрыЗапроса.ЗаписиСкладскогоЖурнала Цикл
		...
		stockEntry = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(Запрос, "stockEntry");
		...
		Если (СведенияОЗаписиЖурнала.Свойство("ЛабораторныеИсследования")
		 ...
		 ИЛИ (СведенияОЗаписиЖурнала.Свойство("Иммунизации")
			...
			stockEntry.vetEventList = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(stockEntry, "vetEventList");
			...
			Если СведенияОЗаписиЖурнала.Свойство("ЛабораторныеИсследования")
			   ...
			   И СведенияОЗаписиЖурнала.ЛабораторныеИсследования.Количество() > 0 Тогда
				...
				Для каждого СведенияОЛабораторномИсследовании Из СведенияОЗаписиЖурнала.ЛабораторныеИсследования Цикл
					...
					laboratoryResearch = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(stockEntry.vetEventList, "laboratoryResearch");
					...
					Если СведенияОЛабораторномИсследовании.Свойство("НаименованиеЛаборатории")
					   И ЗначениеЗаполнено(СведенияОЛабораторномИсследовании.НаименованиеЛаборатории) Тогда
						laboratoryResearch.operator = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(laboratoryResearch, "operator");
						laboratoryResearch.operator.name = СведенияОЛабораторномИсследовании.НаименованиеЛаборатории;
					КонецЕсли;
					
					referencedDocument = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(laboratoryResearch, "referencedDocument");
					...
					Если СведенияОЛабораторномИсследовании.Свойство("НаименованиеПоказателя")
					   ...
					   И СведенияОЛабораторномИсследовании.ТипПоказателя = "Показатель" Тогда
						laboratoryResearch.indicator = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(laboratoryResearch, "indicator");
					...
					Если СведенияОЛабораторномИсследовании.Свойство("НаименованиеПоказателя")
					   ...
					   И СведенияОЛабораторномИсследовании.ТипПоказателя = "Болезнь" Тогда
						laboratoryResearch.disease = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(laboratoryResearch, "disease");
					...
					Если СведенияОЛабораторномИсследовании.Свойство("МетодИсследования")
					   И ЗначениеЗаполнено(СведенияОЛабораторномИсследовании.МетодИсследования) Тогда
						laboratoryResearch.method = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(laboratoryResearch, "method");
			...
			Если СведенияОЗаписиЖурнала.Свойство("Иммунизации")
			   ...
			   И СведенияОЗаписиЖурнала.Иммунизации.Количество() > 0 Тогда
				...
				Для каждого СведенияОбИммунизации Из СведенияОЗаписиЖурнала.Иммунизации Цикл
					...
					immunization = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(stockEntry.vetEventList, "immunization");
					...
					immunization.disease = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(immunization, "disease");
					...
					Если (СведенияОбИммунизации.Свойство("НазваниеИПроизводительВакциныПрепарата")
					 ...
					 ИЛИ (СведенияОбИммунизации.Свойство("НомерСерииВакциныПрепарата")
						...
						immunization.medicinalDrug = РаботаСXMLИС.ОбъектXDTOПоИмениТипа(immunization, "medicinalDrug");
