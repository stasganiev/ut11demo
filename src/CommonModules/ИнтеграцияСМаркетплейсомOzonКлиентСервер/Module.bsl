...
//
// Возвращаемое значение:
//  Структура - Список обязательных атрибутов сертификата с пользовательским представлением.
//
...
//
// Параметры:
//  ОбъектПометки               - ДанныеФормыДерево,
//                              - ДанныеФормыЭлементДерева,
//                              - ДеревоЗначений,
//                              - СтрокаДереваЗначений - данные для установки пометки.
