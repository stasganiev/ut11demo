...
Процедура ПодготовитьТехническуюИнформацию(ДанныеСообщения, ДанныеВложений)
	...
	ДанныеТехническойИнформации.НастройкиИнтернетПоддержки = НастройкиИнтернетПоддержки();
	...
	// Добавить файл технической информации.
	ПараметрыВложения = Новый Структура;
...
//
Функция НастройкиИнтернетПоддержки()
