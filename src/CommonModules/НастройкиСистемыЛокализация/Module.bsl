...
Процедура ПриСозданииНаСервере_НачальноеЗаполнение(Форма) Экспорт
	...
	Элементы.ГруппаПереносДанныхЗарплатаКадры.Видимость = ПолучитьФункциональнуюОпцию("ИспользоватьНачислениеЗарплатыУТ") И Не РазделенныйРежим;
...
Процедура УстановитьДоступность_Продажи(РеквизитПутьКДанным, Форма) Экспорт
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьДоговорыСКлиентами"
		...
		ИспользуетсяКомиссионнаяПродажаПоДоговорам = ЗначениеКонстантыКомиссионныхПродаж
			И ЗначениеКонстантыИспользоватьДоговорыСКлиентами;
		...
		Элементы.ЛокализацияПредупреждениеИспользоватьДоговорыСКлиентами275ФЗ.Видимость = ЗначениеКонстанты275ФЗ;
		Элементы.ЛокализацияПредупреждениеИспользоватьДоговорыСКлиентамиЕИС.Видимость = ЗначениеКонстантыЕИС;
