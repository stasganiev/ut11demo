...
// Возвращает описания установленных подписей по документу ЭДО. Результат см. НовыйРезультатПолученияУстановленныхПодписей
// 
// Параметры:
//  ИдентификаторДокумента - Строка
// 
...
Функция НовыйРезультатПолученияУстановленныхПодписей() Экспорт
	Возврат Новый Массив;
КонецФункции
