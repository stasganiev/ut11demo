...
Процедура ИсправитьПроблемыВДвиженияхИДокументах(ПараметрыРасчета) Экспорт
	...
	РасчетСебестоимостиПрикладныеАлгоритмы.УничтожитьВременныеТаблицы(Запрос, "ВТДвиженияСебестоимостьТоваров");
...
// Выполняет заполнение/очистку партий в регистре Себестоимость товаров при изменении метода оценки со средней на ФИФО и обратно. 
//
