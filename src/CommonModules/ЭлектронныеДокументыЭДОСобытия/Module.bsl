...
Процедура ПослеЗагрузкиНовогоЭлектронногоДокумента(ЗагруженныйДокумент, КонтекстДиагностики) Экспорт
	...
	Если ИнтеграцияЭДО.ЕстьПодсистемаОтражениеВУчетеЭДО() Тогда
		ИнтеграцияЭДО.ОбщийМодульОтражениеВУчетеЭДО().ПослеЗагрузкиНовогоЭлектронногоДокумента(
			ЗагруженныйДокумент, КонтекстДиагностики);
	КонецЕсли;
...
Процедура ПослеЗагрузкиДополнительныхСведенийПоАктуОРасхождениях(ЭлектронныйДокумент, ОписаниеДанных, КонтекстДиагностики) Экспорт
	...
	ИнтеграцияЭДО.ПослеЗагрузкиДополнительныхСведенийПоАктуОРасхождениях(ЭлектронныйДокумент, ОписаниеДанных, КонтекстДиагностики);
...
Процедура ЗаписатьМашиночитаемуюДоверенностьВЖурнал(Источник, Отказ) Экспорт
	Если Источник.ОбменДанными.Загрузка Тогда
		Возврат;
	КонецЕсли;
	МашиночитаемыеДоверенности.ЗаписатьМашиночитаемуюДоверенностьВЖурнал(Источник, Отказ);
КонецПроцедуры
