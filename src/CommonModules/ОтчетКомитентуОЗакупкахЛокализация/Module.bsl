...
Функция ПолучитьДанныеДляПечатнойФормыУПД_Товары(ПараметрыПечати, МассивОбъектов)
	...
	|ИЗ
	|	Документ.ПриобретениеТоваровУслуг.ШтрихкодыУпаковок КАК ТаблицаДокумента
	|	ЛЕВОЕ СОЕДИНЕНИЕ ТаблицаДанныхДокументов_Предварительная КАК ОтчетыКомитентуОЗакупках
	...
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ ТаблицаДанныхДокументов_Предварительная КАК ОтчетыКомитентуОЗакупках
	|		ПО ОтчетыКомитентуОЗакупках.ДокументПриобретения = ТаблицаДокумента.Ссылка
	|УПОРЯДОЧИТЬ ПО
	|	Ссылка
	|
	...
	|	ТаблицаДанныхДокументов.Организация      КАК Контрагент,
	|	ТаблицаДанныхДокументов.Организация.КПП  КАК КПППокупателя,
	|	ТаблицаДанныхДокументов.Организация.ИНН  КАК ИННПокупателя
	|ИЗ
	...
	РезультатПоПоставщикам		= МассивРезультатов[4];
	РезультатПоКонтрагентам		= МассивРезультатов[5];
