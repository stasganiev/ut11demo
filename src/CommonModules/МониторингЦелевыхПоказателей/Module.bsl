...
Функция ПолучитьИсточникДанныхВариантаАнализа(ВариантАнализа, ВариантОтображения, ПринудительноОбновитьДанные = Ложь, ДинамическиеПараметры = Неопределено, ДемоДанные = Ложь) Экспорт
	...
	РеквизитыВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа, "ПометкаУдаления, ПериодАктуальностиРасчета");
	...
	Иначе
		...
		Если Не РеквизитыВариантаАнализа.ПериодАктуальностиРасчета = 0 И Не ПринудительноОбновитьДанные И Не РеквизитыВариантаАнализа.ПометкаУдаления Тогда
		...
		Если ПолучатьДанныеИзИБ Тогда
			...
			Если Не РеквизитыВариантаАнализа.ПометкаУдаления И ДинамическиеПараметры = Неопределено Тогда
...
Функция ПолучитьИсточникДанныхВариантаАнализаИзДемоДанных(ВариантАнализа, ВариантОтображения, ДинамическиеПараметры = Неопределено, ТаблицаДанных = Неопределено) Экспорт
	...
	Цель = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВариантАнализа, "Владелец");
...
Функция ПредставлениеПериодаВариантаАнализа(Знач ИсточникДанных) Экспорт
	...
	ДанныеВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ИсточникДанных.ВариантАнализа,
		"ТипАнализа, ПериодАнализа, ПериодСравнения");
	
	Если ДанныеВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ПокомпонентноеСравнение
		ИЛИ ДанныеВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ИзмерениеТекущегоСостояния Тогда
		
		СтандартныйПериодАнализа = ДанныеВариантаАнализа.ПериодАнализа.Получить(); // СтандартныйПериод -
		ТекстовоеПредставлениеПериода = Строка(Формат(СтандартныйПериодАнализа.ДатаОкончания, "ДЛФ=D"));
	ИначеЕсли ДанныеВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ДинамикаИзменения
		ИЛИ ДанныеВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ПокомпонентноеСравнениеДинамика Тогда
		
		ПериодАнализа = ДанныеВариантаАнализа.ПериодАнализа.Получить();
		...
		КонецЕсли;
	ИначеЕсли ДанныеВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.СравнениеСПрошлымПериодом Тогда
		СтандартныйПериодАнализа = ДанныеВариантаАнализа.ПериодАнализа.Получить(); // СтандартныйПериод - 
		СтандартныйПериодСравнения = ДанныеВариантаАнализа.ПериодСравнения.Получить(); // СтандартныйПериод - 
...
Функция ЗаполнитьДиаграммуДляМонитора(Диаграмма, ВариантАнализа, ИсточникСПараметрами) Экспорт
	...
	ДанныеВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа, "ТипАнализа, РассчитыватьПрогноз");
	
	Если Не ИсточникДанныхДляДиаграммы.Колонки.Найти("Признак") = Неопределено 
		И ДанныеВариантаАнализа.РассчитыватьПрогноз 
	...
	Если ДанныеВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ИзмерениеТекущегоСостояния Тогда
...
Процедура ЗаполнитьТаблицуДляМонитора(ТаблицаЗначенийМонитора, ИдентификаторЭлементаФормы, ВариантАнализа, ИсточникСПараметрами) Экспорт
	...
	ТочностьРасчетаДробнойЧасти = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВариантАнализа, "ТочностьРасчетаДробнойЧасти");
...
Функция ПолучитьСтрокуПредставленияЧисел(ВариантАнализа) Экспорт
	...
	ВидПредставленияЧисла = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВариантАнализа, "КратностьЗначений");
	ВидыПредставленияЧисел = Перечисления.ВидыПредставленияЧисел;
...
Функция ПолучитьЦветаСостоянияИТрендаПоказателя(ВариантАнализа, ИсточникДанных) Экспорт
	...
	РеквизитыВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа,
		"ХранилищеНастроекОформления, ТочностьРасчетаДробнойЧасти");
	НастройкиОформления = РеквизитыВариантаАнализа.ХранилищеНастроекОформления.Получить();
	...
	ЗонаАнализа = ЗонаАнализаЗначения(ИсточникДанных,
			ЦелевойТренд,
			ВидЦелевогоЗначения,
			РеквизитыВариантаАнализа.ТочностьРасчетаДробнойЧасти);
...
Функция ПериодАктуальностиРасчетаВМинутах(ВариантАнализа)
	...
	ДанныеВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа, "ПериодАктуальностиРасчета, ВидПериодаАктуальностиРасчета");
	
	ПериодВМинутах = 0;
	КоличествоПериодов = ДанныеВариантаАнализа.ПериодАктуальностиРасчета;
	ВидПериодаАктуальностиРасчета = ДанныеВариантаАнализа.ВидПериодаАктуальностиРасчета;
...
Процедура ЗаполнитьДанныеДиаграммы(ТабличныйДокумент, ВариантАнализа, ИсточникДанных)
	...
	ДанныеВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа,
		"ТипАнализа, РассчитыватьПрогноз, ОтображатьЛегенду");
	...
	Если Не ИсточникДанных.ОшибкаРасчета И Не ИсточникДанных.Пустой И ИсточникДанных.РасчетыАктуальны Тогда
		...
		Если ДанныеВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ДинамикаИзменения
			Или ДанныеВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ПокомпонентноеСравнениеДинамика Тогда
			УстановитьИменаТочекДиаграммы(Диаграмма.Точки,
					ДинамическиеСвойстваВариантаАнализа.ЗначениеАнализа,
					ДинамическиеСвойстваВариантаАнализа.ПериодичностьРасчетаПоказателя);
		...
		Диаграмма.ОтображатьЛегенду = ДанныеВариантаАнализа.ОтображатьЛегенду;
...
Процедура УстановитьИсточникДанныхДиаграммы(Диаграмма, ИсточникДанных, ВариантАнализа, Минидиаграмма = Ложь)
	...
	ДанныеВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа,
		"ТипАнализа, ТолькоЦветОсновнойСерии, ГрадиентДляПокомпонентногоСравнения");
	ТипыАнализа = Перечисления.ТипыАнализаПоказателей;
	ТипАнализа = ДанныеВариантаАнализа.ТипАнализа;
	...
	ЕстьГрадиент = ((ТипАнализа = ТипыАнализа.ПокомпонентноеСравнение)
			И ДанныеВариантаАнализа.ТолькоЦветОсновнойСерии
			И ДанныеВариантаАнализа.ГрадиентДляПокомпонентногоСравнения);
	ПоВесуСерии = Ложь;
...
Процедура УстановитьНастройкиИзмерительнойДиаграммы(Диаграмма, ВариантАнализа, ИсточникДанных)
	...
	РеквизитыВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа,
		"ХранилищеНастроекОформления, ВключатьНоль, ТочностьРасчетаДробнойЧасти");
	ЦветаПоказателя = РеквизитыВариантаАнализа.ХранилищеНастроекОформления.Получить().Цвета;
	ВключатьНоль = РеквизитыВариантаАнализа.ВключатьНоль;
...
Процедура УстановитьНастройкиПоУмолчаниюОбъектаДиаграммы(Диаграмма, ВариантАнализа, СвойстваОбщейСтатистики)
	...
	РеквизитыВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа,
		"ОтображатьЛегенду, ТипДиаграммы, РежимСглаживанияДиаграмм, ТипАнализа, РежимПокомпонентногоСравнения, ВыводитьПодписиКДиаграммам, ОкантовкаДиаграмм");
	Диаграмма.ОтображатьЛегенду = РеквизитыВариантаАнализа.ОтображатьЛегенду;
	
	ИмяТипаДиаграммы = ПолучитьИмяЗначенияПеречисления(РеквизитыВариантаАнализа.ТипДиаграммы);
	Диаграмма.ТипДиаграммы = ТипДиаграммы[ИмяТипаДиаграммы];
	
	Если РеквизитыВариантаАнализа.РежимСглаживанияДиаграмм Тогда
	...
	Если РеквизитыВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ПокомпонентноеСравнение
		И РеквизитыВариантаАнализа.РежимПокомпонентногоСравнения = 0 Тогда
		Диаграмма.СерииВСтроках = Истина;
	КонецЕсли;
	
	Если Перечисления.ТипыДиаграммПоказателей.Гистограммы().Найти(РеквизитыВариантаАнализа.ТипДиаграммы) <> Неопределено Тогда
		Диаграмма.РежимПробелов = РежимПробеловДиаграммы.ПоловинаШирины;
		
		Если РеквизитыВариантаАнализа.ВыводитьПодписиКДиаграммам 
			И НЕ РеквизитыВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ПокомпонентноеСравнениеДинамика
			И НЕ РеквизитыВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ДинамикаИзменения Тогда
	...
	Диаграмма.Окантовка = РеквизитыВариантаАнализа.ОкантовкаДиаграмм;
...
Процедура УстановитьНастройкиПоУмолчаниюОбластиПостроенияДиаграммы(Диаграмма, ВариантАнализа)
	...
	ДанныеВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа,
		"ТипАнализа, ТипДиаграммы, ОтображатьЛегенду, ТочностьРасчетаДробнойЧасти");
	ОтображатьЛегенду = ДанныеВариантаАнализа.ОтображатьЛегенду;
	ИмяТипаДиаграммы = ПолучитьИмяЗначенияПеречисления(ДанныеВариантаАнализа.ТипДиаграммы);
	...
	Если ДанныеВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ДинамикаИзменения
		...
		ИЛИ ДанныеВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.СравнениеСПрошлымПериодом Тогда
		
		ОбластьПостроения.ШкалаТочек.ОриентацияПодписей = ОриентацияПодписейДиаграммы.Горизонтально;;
		
	ИначеЕсли ДанныеВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ПокомпонентноеСравнение
		ИЛИ ДанныеВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ИзмерениеТекущегоСостояния Тогда
	...
	ОбластьПостроения.ФорматШкалыЗначений = "ЧДЦ=" + ДанныеВариантаАнализа.ТочностьРасчетаДробнойЧасти;
...
Процедура УстановитьНастройкиПоУмолчаниюОбластиЛегендыДиаграммы(Диаграмма, ВариантАнализа)
	ОтображатьЛегенду = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВариантАнализа, "ОтображатьЛегенду");
...
Процедура УстановитьНастройкиПоУмолчаниюТочекДиаграммы(Диаграмма, ВариантАнализа)
	...
	Если ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВариантАнализа, "ТипАнализа")
		= Перечисления.ТипыАнализаПоказателей.СравнениеСПрошлымПериодом Тогда
		Для Каждого ТочкаДиаграммы Из ТочкиДиаграммы Цикл 
			Если СтрНайти(ТочкаДиаграммы.Значение, "Прогноз") Тогда
				ТочкаДиаграммы.Цвет = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВариантАнализа,
					"ХранилищеНастроекОформления").Получить().Цвета["Прогноз"];
...
Процедура УстановитьПользовательскиеНастройкиСерийДиаграммы(СерииДиаграммы, ИсточникДанных)
	...
	ТипыДиаграмм = Перечисления.ТипыДиаграммПоказателей;
	ДанныеВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ИсточникДанных.ВариантАнализа,
		"ВыводитьМаркерТочекПрогноза, ВыводитьМаркерыТочек, ТолькоЦветОсновнойСерии, ГрадиентДляПокомпонентногоСравнения, ВыделятьМаксимальноеЗначениеДляПокомпонентногоСравнения, ХранилищеНастроекОформления");
	Цвета = ДанныеВариантаАнализа.ХранилищеНастроекОформления.Получить().Цвета;
	...
	Если Не (ТипАнализа = ТипыАнализа.ПокомпонентноеСравнение 
		...
		Для Каждого СерияДиаграммы Из СерииДиаграммы Цикл
			...
			ИначеЕсли СтрНайти(ИдентификаторСерии, "Прогноз")
				...
				Если ДанныеВариантаАнализа.ВыводитьМаркерТочекПрогноза Тогда
			...
			ИначеЕсли СтрНайти(ИдентификаторСерии, ЗначениеАнализаИмяПоля) Тогда 
				Если ДанныеВариантаАнализа.ВыводитьМаркерыТочек Тогда
	...
	ИначеЕсли ТипАнализа = ТипыАнализа.ПокомпонентноеСравнение 
		...
		Если ДанныеВариантаАнализа.ТолькоЦветОсновнойСерии Тогда
			...
			Если ПоВесуСерии Тогда 
				Если ДанныеВариантаАнализа.ГрадиентДляПокомпонентногоСравнения Тогда
			...
			Пока НомерОформляемойСерии <= КоличествоСерийДиаграммы Цикл 
				...
				Если ДанныеВариантаАнализа.ГрадиентДляПокомпонентногоСравнения Тогда
					Если ПоВесуСерии Тогда
						...
						// По весу серии
						Если ДанныеВариантаАнализа.ВыделятьМаксимальноеЗначениеДляПокомпонентногоСравнения И ВесСерии
				...
				Если ПоВесуСерии Тогда 
					Если ДанныеВариантаАнализа.ГрадиентДляПокомпонентногоСравнения
						И ДанныеВариантаАнализа.ВыделятьМаксимальноеЗначениеДляПокомпонентногоСравнения И ВесСерии
						= ВесМаксимальнойСерии Тогда
						// Если выделять первое значение ИсходнаяНасыщенность * КоэффициентВесаСерии
						ПолучитьКрасныйЗеленыйСинийПоТонуНасыщенностиЯркости(ИсходныйТон,
							100,
				...
				Иначе
					Если ДанныеВариантаАнализа.ГрадиентДляПокомпонентногоСравнения
						И ДанныеВариантаАнализа.ВыделятьМаксимальноеЗначениеДляПокомпонентногоСравнения
...
Процедура УстановитьПользовательскиеНастройкиТочекДиаграммы(ТочкиДиаграммы, ВариантАнализа, ПериодыСПризнаком)
	...
	ЦветаПоказателя = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВариантАнализа,
		"ХранилищеНастроекОформления").Получить().Цвета;
...
Процедура ЗаполнитьСправочныеДанныеПоказателя(ТабличныйДокумент, ВариантАнализа, ИсточникДанных)
	...
	РеквизитыВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа, "ТипАнализа, РассчитыватьПрогноз");
	
	ТипыАнализа = Перечисления.ТипыАнализаПоказателей;
	ТипАнализа = РеквизитыВариантаАнализа.ТипАнализа;
	...
	// Выведем информацию о параметрах анализа
	Если РеквизитыВариантаАнализа.РассчитыватьПрогноз 
		И Не ИсточникДанных.СвойстваПрогнозаДанныхПоПериодам.СтатистическиеПараметрыТренда = Неопределено
		И Не ИсточникДанных.СвойстваПрогнозаДанныхПоПериодам.СтатистическиеПараметрыТренда.Пустой Тогда
...
Функция ИнициализироватьИсточникДанных(ВариантАнализа) Экспорт
	...
	ИсточникДанных = Новый Структура;
	ИсточникДанных.Вставить("Цель", ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ВариантАнализа, "Владелец"));
...
Процедура ПодготовитьИсточник(ИсточникДанных, ВариантАнализа)
	...
	ДанныеВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа,
		"ТипАнализа, МетодРасчетаЗначений, РассчитыватьПрогноз, ПериодичностьРасчетаПоказателя");
		...
		Если ТипАнализа = ТипыАнализа.ПокомпонентноеСравнениеДинамика Тогда
			Если ИсточникДанных.ПараметрыРасчета.РежимПокомпонентногоСравнения = 0 Тогда
				...
				Для Каждого ОбъектАнализа Из ОбъектыАнализа Цикл 
					...
					Если ДанныеВариантаАнализа.МетодРасчетаЗначений = Перечисления.МетодыРасчетаВариантовАнализаЦелевыхПоказателей.Сумма Тогда
	...
	ИначеЕсли ТипАнализа = ТипыАнализа.ИзмерениеТекущегоСостояния Тогда
		...
		Если ДанныеВариантаАнализа.РассчитыватьПрогноз Тогда
...
Функция СхемаКомпоновкиДанныхДляРасчета(ПараметрыРасчета)
	...
	Если Не СхемаКомпоновкиДанных = Неопределено Тогда
		...
		ПривестиВыраженияПолейИтоговКУказаннойТочности(СхемаКомпоновкиДанных, ДанныеВариантаАнализа.КратностьЗначений,
			ДанныеВариантаАнализа.ТочностьРасчетаДробнойЧасти);
...
// 
// Параметры:
// 	ВариантАнализа - СправочникСсылка.ВариантыАнализаЦелевыхПоказателей - Описание
...
Функция ПараметрыРасчета(ВариантАнализа, ВариантОтображения, ДинамическиеПараметры)
	...
	ДанныеВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа,
		"ТипАнализа, ТипДиаграммы, ПериодАнализа, ПериодСравнения, МетодРасчетаЗначений, РежимПокомпонентногоСравнения, ПериодичностьРасчетаПоказателя");
	...
	ПараметрыРасчета.Вставить("ТипАнализа", ДанныеВариантаАнализа.ТипАнализа);
	ПараметрыРасчета.Вставить("ТипДиаграммы", ДанныеВариантаАнализа.ТипДиаграммы);
	ПараметрыРасчета.Вставить("МетодыРасчета", Перечисления.МетодыРасчетаВариантовАнализаЦелевыхПоказателей);
	ПараметрыРасчета.Вставить("ПериодАнализа", ДанныеВариантаАнализа.ПериодАнализа.Получить());
	ПараметрыРасчета.Вставить("ПериодСравнения", ДанныеВариантаАнализа.ПериодСравнения.Получить());
	ПараметрыРасчета.Вставить("ЕстьСравнение", Ложь);
	ПараметрыРасчета.Вставить("ЕстьНарастающийИтог", ДанныеВариантаАнализа.МетодРасчетаЗначений = ПараметрыРасчета.МетодыРасчета.СуммаНарастающимИтогом);
	ПараметрыРасчета.Вставить("РассчитыватьПрогноз", Ложь);
	ПараметрыРасчета.Вставить("ДляТаблицы", Ложь);
	ПараметрыРасчета.Вставить("РежимПокомпонентногоСравнения", ДанныеВариантаАнализа.РежимПокомпонентногоСравнения);
	...
	Иначе
		ПериодичностьРасчетаПоказателя = ДанныеВариантаАнализа.ПериодичностьРасчетаПоказателя;
	КонецЕсли;
	...
	РеквизитыВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа,
		"РассчитыватьПрогноз, ГоризонтПрогноза, ГлубинаАнализаПрогноза, ОбъектАнализа, ЗначениеАнализа, ЗначениеАнализаДополнительное");
	
	ПараметрыРасчета.Вставить("ДобавлятьПрогноз", ПараметрыРасчета.РассчитыватьПрогноз И РеквизитыВариантаАнализа.РассчитыватьПрогноз);
	ПараметрыРасчета.Вставить("ГоризонтПрогноза", ?(ПараметрыРасчета.ДобавлятьПрогноз, РеквизитыВариантаАнализа.ГоризонтПрогноза, 0));
	ПараметрыРасчета.Вставить("ГлубинаАнализаПрогноза", РеквизитыВариантаАнализа.ГлубинаАнализаПрогноза);
	...
	Иначе
		Если ТипЗнч(РеквизитыВариантаАнализа.ОбъектАнализа) = Тип("Строка") Тогда
			ОбъектАнализаПоле = Новый ПолеКомпоновкиДанных(РеквизитыВариантаАнализа.ОбъектАнализа);
		ИначеЕсли РеквизитыВариантаАнализа.ОбъектАнализа = Неопределено Тогда
			ОбъектАнализаПоле = Неопределено;
		Иначе
			ОбъектАнализаПоле = РеквизитыВариантаАнализа.ОбъектАнализа.Получить();
		КонецЕсли;
	...
	Если ТипЗнч(РеквизитыВариантаАнализа.ЗначениеАнализа) = Тип("Строка") Тогда
		ЗначениеАнализаПоле = Новый ПолеКомпоновкиДанных(РеквизитыВариантаАнализа.ЗначениеАнализа);
	ИначеЕсли РеквизитыВариантаАнализа.ЗначениеАнализа = Неопределено Тогда
		ЗначениеАнализаПоле = Неопределено;
	Иначе
		ЗначениеАнализаПоле = РеквизитыВариантаАнализа.ЗначениеАнализа.Получить();
	КонецЕсли;
	...
	Если ТипЗнч(РеквизитыВариантаАнализа.ЗначениеАнализаДополнительное) = Тип("Строка") Тогда
		ЗначениеАнализаДополнительноеПоле = Новый ПолеКомпоновкиДанных(РеквизитыВариантаАнализа.ЗначениеАнализаДополнительное);
	ИначеЕсли РеквизитыВариантаАнализа.ЗначениеАнализаДополнительное = Неопределено Тогда
		ЗначениеАнализаДополнительноеПоле = Неопределено;
	Иначе
		ЗначениеАнализаДополнительноеПоле = РеквизитыВариантаАнализа.ЗначениеАнализаДополнительное.Получить();
	КонецЕсли;
...
Функция ПараметрыБазовогоЗначенияДляДиаграмм(ВариантАнализа, СвойстваОбщейСтатистики)
	...
	РеквизитыВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа,
		"ТипАнализа, РежимПокомпонентногоСравнения, РежимШкалыЗначений, ВключатьНоль");
	Если (РеквизитыВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ПокомпонентноеСравнение
		Или РеквизитыВариантаАнализа.ТипАнализа = Перечисления.ТипыАнализаПоказателей.ПокомпонентноеСравнениеДинамика)
		И РеквизитыВариантаАнализа.РежимПокомпонентногоСравнения = 0 Тогда
	...
	Если РеквизитыВариантаАнализа.РежимШкалыЗначений = Перечисления.РежимШкалыЗначенийДиаграмм.Авто
		И Не РеквизитыВариантаАнализа.ВключатьНоль Тогда
		Если Не (ИспользуемаяСтатистика.Максимум > 0 И ИспользуемаяСтатистика.Минимум < 0)
			...
			КонецЕсли;
		КонецЕсли;
	ИначеЕсли РеквизитыВариантаАнализа.РежимШкалыЗначений = Перечисления.РежимШкалыЗначенийДиаграмм.ПоМинимальномуЗначению Тогда
...
Функция ПолучитьЦелевыеЗначенияНаДаты(МассивДат, ВариантАнализа)
	...
	ДанныеВариантаАнализа = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВариантАнализа, "КратностьЗначений, ТочностьРасчетаДробнойЧасти");
	
	Если ДанныеВариантаАнализа.КратностьЗначений = ВидыПредставленияЧисел.ВТысячах Тогда
		Знаменатель = Формат(Pow(10, 3), "ЧГ=0;");
		ЗнаменательТребуется = Истина;
	ИначеЕсли ДанныеВариантаАнализа.КратностьЗначений = ВидыПредставленияЧисел.ВМиллионах Тогда
		Знаменатель = Формат(Pow(10, 6), "ЧГ=0;");
		ЗнаменательТребуется = Истина;
	КонецЕсли;
	
	Разрядность = ДанныеВариантаАнализа.ТочностьРасчетаДробнойЧасти;
	...
	ЗапросЦелевыхЗначений.УстановитьПараметр("ВариантАнализа", ВариантАнализа);
	Текст =
	"ВЫБРАТЬ
