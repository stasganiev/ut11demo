...
Процедура ИнициализироватьСхемуКомпоновки(Источник, Форма = Неопределено) Экспорт
	...
	Если Источник.СхемаКомпоновкиДанных.НаборыДанных.Найти("НаборДанных") <> Неопределено Тогда
...
//
// Параметры:
//	ОбъектНастройки - НастройкиКомпоновкиДанных
...
//	Недоступный - Булево - установить режим отображения параметра "Недоступный".
//
// Возвращаемое значение:
