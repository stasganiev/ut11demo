...
// Вызывается из ОбработкаНовостейСлужебный.ПолучитьКонтекстныеНовостиДляФормы после получения массива структур контекстных новостей.
...
//
Процедура ЗаполнитьПрограммныеЗначенияКатегорий_Общие() Экспорт
...
//
Процедура ЗаполнитьПрограммныеЗначенияКатегорий_ДляОбластиДанных() Экспорт


КонецПроцедуры

// Метод для определения, использовать ли автоматический расчет значений категорий.
// Если включен автоматический расчет категорий, то для разделенных категорий может потребоваться
//  вход в область данных, что является очень "дорогой" операцией.
// Предпочтительнее использовать кэш значений:
//  - ОбработкаНовостей.ДобавитьПрограммноеЗначениеОтбора_*,
//  - ОбработкаНовостей.УдалитьПрограммноеЗначениеОтбора_*.
//
// Параметры:
//  АвтоматическийРасчет - Булево - Истина - при необходимости входить в область данных для расчета значений разделенных категорий,
//                          Ложь - всегда использовать кэш значений.
//
