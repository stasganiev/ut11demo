...
Функция ДанныеУстройства(Идентификатор, КодЯзыка = Неопределено) Экспорт
	...
	Возврат МенеджерОборудования.ДанныеУстройства(Идентификатор, КодЯзыка);
...
// Устарела: следует использовать МенеджерОборудования.УстановитьПризнакПереустановкиДрайвера.
...
// Устарела: следует использовать МенеджерОборудования.ДрайвераПоТипуОборудования.
// Возвращает драйвера по типу оборудования
//
// Параметры:
...
Функция ДрайвераПоТипуОборудования(ТипОборудования, ТолькоДоступные = Истина, СнятыеСПоддержкиДрайвера = Ложь) Экспорт
	...
	Возврат МенеджерОборудования.ДрайвераПоТипуОборудования(ТипОборудования, ТолькоДоступные, СнятыеСПоддержкиДрайвера);
	
КонецФункции

// Устарела: следует использовать МенеджерОборудования.НовыйДрайверОборудования.
// Создает запись в справочнике о новом драйвере.
//
// Параметры:
...
Функция НовыйДрайверОборудования(ПараметрыСоздания) Экспорт
	...
	Возврат МенеджерОборудования.НовыйДрайверОборудования(ПараметрыСоздания);
...
// Выполняет привязку идентификатора клиента к элементу спрочника рабочего места
//
// Параметры:
...
Функция ПривязатьРабочееМестоПоMACАдресу(ИдентификаторКлиента, MACАдрес) Экспорт
	...
	СписокРабочиеМеста = МенеджерОборудованияВызовСервера.НайтиРабочиеМестаПоИдентификатору(ИдентификаторКлиента, "", MACАдрес);
