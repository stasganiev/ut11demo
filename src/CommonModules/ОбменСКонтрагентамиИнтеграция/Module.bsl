...
Функция НовыеЭлектронныеДокументы(ДокументыОснования) Экспорт 
	...
	РезультатФормирования = ЭлектронныеДокументыЭДО.ВыполнитьДействияЭДО(ПараметрыВыполненияДействийПоЭДО);
...
//   * СписокТипов - См. ОтражениеВУчетеЭДО.СписокОперацийВидаДокумента
//
Функция ОписаниеПакета(ОписаниеФайла) Экспорт
	...
	СписокОпераций = ИнтеграцияЭДО.СписокОперацийВидаДокумента(ВидДокумента);
	
	ДанныеПакета.Вставить("СписокТипов", СписокОпераций);
...
Функция ДанныеНеСопоставленнойНоменклатурыДокумента(ОписаниеФайла, Контрагент) Экспорт
	...
	ДанныеДокументооборота = ОбщийМодульОтражениеВУчетеЭДО.НовыеДанныеЭлектронногоДокументаДляОтраженияВУчете();
	ДанныеДокументооборота.ДанныеОсновногоФайла = ОписаниеФайла;
	ДанныеДокументооборота.Отправитель = Контрагент;
	
	Возврат ОбщийМодульОтражениеВУчетеЭДО.НоменклатураЭлектронногоДокументаБезСопоставления(ДанныеДокументооборота);
...
Функция НачатьЭДОПоОбъектамУчета(ОбъектыУчета, НастройкиОтправкиОбъектовУчета = Неопределено) Экспорт
	...
	КонецЕсли;
	Возврат ЭлектронныеДокументыЭДО.ВыполнитьДействияЭДО(ПараметрыВыполнения);
КонецФункции
...
Процедура ОтразитьВУчетеЭлектронныйДокумент(Параметры, ОбъектыУчета, Отказ) Экспорт
	...
	ОбщийМодульОтражениеВУчетеЭДО.ОтразитьДанныеЭлектронногоДокумента(ДанныеДокументооборота,
		Параметры.СпособОбработки, ОбъектыУчета);
...
// Все возможные пустые значения определяемого типа См. ОпределяемыйТип.ДоговорСКонтрагентомЭДО
// 
// Возвращаемое значение:
//  Массив Из ОпределяемыйТип.ДоговорСКонтрагентомЭДО
Функция ВсеПустыеЗначенияДоговораСКонтрагентомЭДО() Экспорт
	Возврат ОбщегоНазначенияБЭД.ПустыеЗначенияОписанияТипов(Метаданные.ОпределяемыеТипы.ДоговорСКонтрагентомЭДО.Тип);
КонецФункции
