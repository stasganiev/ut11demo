...
Процедура ОбработатьРезультатЗапросаСоздатьИзменитьЗаказНаДоставку(СтруктураОтвета, Результат)
	...
	Результат.Вставить("ЧастичныйОтказИзменений", ПолучитьЗначение(СтруктураОтвета, "descriptionOfCanceled"));
...
Процедура ОбработатьРезультатЗапросаОформитьЗаказНаДоставку(СтруктураОтвета, Результат)
	...
	Результат.Вставить(
		...
		ПолучитьЗначение(СтруктураОтвета, "availableEdit"));
...
Функция ПредставлениеОснованияДляСписка(Основания, КоличествоИдентификаторовДокументовОснований)
	...
	Если Основания.Количество() = 0 Тогда
		Если КоличествоИдентификаторовДокументовОснований > 0 Тогда
			ПредставлениеОснования = "Документ основания введен в другой информационной системе";
		Иначе
			ПредставлениеОснования = "";
		КонецЕсли;
