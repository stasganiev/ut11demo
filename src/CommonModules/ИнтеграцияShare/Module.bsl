...
//
// Параметры:
//  Отказ - Булево - признак наличия ошибок при выполнении запроса в сервисе получение настроек. 
...
// Данные используются при повторной загрузки в базу.
//
// Параметры:
...
//                   При наличие ошибок выполняется запись в журнал регистрации и вывод сообещния пользователю.
//
...
//   * ДанныеОсновногоФайла - Неопределено, См. РаботаСФайламиБЭДКлиентСервер.НовоеОписаниеФайла - данные файла электронного документа.
...
//   * ДанныеЗагрузкиДокумента - См. НовоеОписаниеДанныхЗагрузкиЭлектронногоДокумента - заполнен, если документ
...
//
Функция НовоеОписаниеДанныхЭлектронногоДокумента() Экспорт
...
//
Функция НовоеОписаниеДанныхТранспортногоКонтейнера() Экспорт
...
Процедура ЗаполнитьФайлыДокументаДляВыбораКПубликации(ДанныеФайлов, Знач Документ) Экспорт
	...
	Для Каждого ФайлДокумента Из ПрисоединенныеФайлыДокумента Цикл
		...
		Если ЗначенияРеквизитовФайла.ПометкаУдаления Тогда
			Продолжить;
		КонецЕсли;
