...
//                                     Если значение реквизита заполнено, используется он, иначе МераКоличестваПредметаРасчета
...
//   * ЗапросРазрешенияПродажиКМ - Булево - должен выполняться запрос разрешения продажи
...
//   * ВремяЗапросаРазрешения - Строка, Дата - таймштамп полученный с удаленого сервера
//
...
//   * ОжидатьПолученияОтветаПроверкиКМ - (не используется) Булево - ожидать завершения запроса от удаленного сервера ОИСМ (ИСМП).
//   * ЗапросыКМ - Массив из ПараметрыЗапросКМ - массив запросов КМ
//
...
// Устарела: следует использовать механизм ШаблоныФискальныхДокументов.ШаблонИнфоКвитанция.
