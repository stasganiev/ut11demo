...
Процедура НачатьФормированиеОтчетаОТекущемСостоянииРасчетов(ОповещениеПриЗавершении, ИдентификаторКлиента, ИдентификаторУстройства, ПараметрыОперации, ДополнительныеПараметры = Неопределено) Экспорт
	...
	ПараметрыВыполнениеКоманды = МенеджерОборудованияКлиентСервер.ПараметрыВыполнениеКоманды("ReportCurrentStatusOfSettlements", 
		"ОборудованиеЧекопечатающиеУстройства", ДополнительныеПараметры, Истина, Ложь);
...
Функция ПланируемыеСтатусыМаркированногоТовара() Экспорт
	...
	// ++ Локализация
	Соответствие.Вставить("ШтучныйТоварРеализован"      , ПредопределенноеЗначение("Перечисление.ПланируемыйСтатусМаркируемогоТовара.ШтучныйТоварРеализован"));
	Соответствие.Вставить("МерныйТоварВСтадииРеализации", ПредопределенноеЗначение("Перечисление.ПланируемыйСтатусМаркируемогоТовара.МерныйТоварВСтадииРеализации"));
	Соответствие.Вставить("ШтучныйТоварВозвращен"       , ПредопределенноеЗначение("Перечисление.ПланируемыйСтатусМаркируемогоТовара.ШтучныйТоварВозвращен"));
	Соответствие.Вставить("ЧастьТовараВозвращена"       , ПредопределенноеЗначение("Перечисление.ПланируемыйСтатусМаркируемогоТовара.ЧастьТовараВозвращена"));
	Соответствие.Вставить("СтатусТовараНеИзменился"     , ПредопределенноеЗначение("Перечисление.ПланируемыйСтатусМаркируемогоТовара.СтатусТовараНеИзменился"));
	// -- Локализация
