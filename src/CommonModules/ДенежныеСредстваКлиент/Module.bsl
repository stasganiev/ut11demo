...
Процедура УстановитьДоступностьЭлементаРасшифровкаПлатежаДоговор(Форма) Экспорт
	...
	ЯчейкаТабличнойЧасти.ТолькоПросмотр = Форма.СуммаНераспределено = 0
											Или (ЗначениеЗаполнено(СтрокаТабличнойЧасти.ОбъектРасчетов)
											И Объект.Ссылка <> СтрокаТабличнойЧасти.ОбъектОбъектаРасчетов)
											Или СписокКонтрагентов;
