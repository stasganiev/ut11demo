...
Функция ПозицииНоменклатурыПоДокументу(ДокументСсылка) Экспорт
	...
	Запрос.Текст = "
	|ВЫБРАТЬ
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.НомерСтроки,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.Номенклатура,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.Характеристика,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.Упаковка,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.КоличествоУпаковок КАК Количество,
	|	(ВЫРАЗИТЬ((ВыкупВозвратнойТарыКлиентомТаблицаТоваров.СуммаБезНДС + ВыкупВозвратнойТарыКлиентомТаблицаТоваров.СуммаНДС) /
	|		ВыкупВозвратнойТарыКлиентомТаблицаТоваров.КоличествоУпаковок КАК ЧИСЛО(31,2))) КАК Цена,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.СуммаБезНДС + ВыкупВозвратнойТарыКлиентомТаблицаТоваров.СуммаНДС КАК Сумма,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.СтавкаНДС КАК СтавкаНДС,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.СуммаНДС КАК СуммаНДС
	|ПОМЕСТИТЬ ТаблицаНоменклатуры
	|ИЗ
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров КАК ВыкупВозвратнойТарыКлиентомТаблицаТоваров
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
...
Функция ПредметыРасчетовПоДокументу(ДокументСсылка) Экспорт
	...
	Запрос.Текст = "
	|ВЫБРАТЬ
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.НомерСтроки                   КАК НомерСтроки,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.Номенклатура                  КАК Номенклатура,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.Номенклатура.ТипНоменклатуры  КАК ТипНоменклатуры,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.Номенклатура.ПодакцизныйТовар КАК ПодакцизныйТовар,
	|	
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.Номенклатура.НаименованиеПолное   КАК НоменклатураНаименование,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.Характеристика.НаименованиеПолное КАК ХарактеристикаНаименование,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.Упаковка                          КАК Упаковка,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.Упаковка                          КАК УпаковкаНаименование,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.Номенклатура.ЕдиницаИзмерения     КАК БазоваяУпаковка,
	|	
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.КоличествоУпаковок КАК КоличествоУпаковок,
	|	
	|	(ВЫРАЗИТЬ((ВыкупВозвратнойТарыКлиентомТаблицаТоваров.СуммаБезНДС + ВыкупВозвратнойТарыКлиентомТаблицаТоваров.СуммаНДС) /
	|		ВыкупВозвратнойТарыКлиентомТаблицаТоваров.КоличествоУпаковок КАК ЧИСЛО(31,2))) КАК Цена,
	|	
	...
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.СтавкаНДС КАК СтавкаНДС,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.СуммаНДС КАК СуммаНДС,
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.СуммаБезНДС + ВыкупВозвратнойТарыКлиентомТаблицаТоваров.СуммаНДС КАК СуммаСНДС
	|ИЗ
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров КАК ВыкупВозвратнойТарыКлиентомТаблицаТоваров
	|
	|УПОРЯДОЧИТЬ ПО
