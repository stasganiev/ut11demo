...
Функция НовыйСтатусПриглашения() Экспорт
	...
	СтатусПриглашения.Вставить("Ключ", "");
...
Процедура ОбновитьСтатусПриглашения(СтатусПриглашения) Экспорт
	...
	НаборЗаписей.Отбор.Ключ.Установить(СтатусПриглашения.Ключ);
...
// * Отчество - Строка
// * Должность - Строка
Функция НовыеДанныеОрганизацииДляШаблонаПисьмаОВыбореОператора() Экспорт
	Данные = Новый Структура;
	Данные.Вставить("Наименование", "");
	Данные.Вставить("ИНН", "");
	Данные.Вставить("КПП", "");
...
//  ДанныеОрганизации - см. НовыеДанныеОрганизацииДляШаблонаПисьмаОВыбореОператора
// 
// Возвращаемое значение:
//  ДвоичныеДанные
