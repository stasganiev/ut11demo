...
Процедура РаспределитьМарки(ШтрихкодыУпаковокНакладной, 
							...
							ТаблицаТовары, 
							ЗаполнятьДанныеПоМаркам) Экспорт
	
	//++ Локализация
	Если НЕ (ЗаполнятьДанныеПоМаркам 
				И (ШтрихкодыУпаковокНакладной.Количество() > 0 Или ТаблицаШтрихкодыУпаковок.Количество() > 0)) Тогда
		Возврат;
	КонецЕсли;
...
Процедура ДополнитьРеквизитамиМаркировки(Форма, ЗаполнятьДанныеПоМаркам) Экспорт
	...
	//++ Локализация
	Если Не ЗаполнятьДанныеПоМаркам Тогда
		Возврат;
	КонецЕсли;
