...
//  * ДополнительныйФайл - Неопределено - если дополнительный файл отсутствует.
//                       - см. РаботаСФайламиБЭДКлиентСервер.НовоеОписаниеФайла
//  * ОбъектыУчета - Массив из ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО
Функция НовоеОписаниеДокументаДляФормированияПоФайлам() Экспорт
	...
	Описание.Вставить("ОсновнойФайл", Неопределено);
	Описание.Вставить("ДополнительныйФайл", Неопределено);
...
// * СоставительДокументаДоверенность - Строка
//
Функция ДанныеРучногоФормированияДополнительныхСведений(Форма) Экспорт
	Данные = Новый Структура;
