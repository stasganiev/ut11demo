...
Функция ТипыПлатежнойСистемыККТ() Экспорт
	...
	Соответствие.Вставить("СистемаБыстрыхПлатежей" , ПредопределенноеЗначение("Перечисление.ТипыПлатежнойСистемыККТ.СистемаБыстрыхПлатежей"));
	Соответствие.Вставить("СертификатНСПК"         , ПредопределенноеЗначение("Перечисление.ТипыПлатежнойСистемыККТ.СертификатНСПК"));
	Соответствие.Вставить("ЮКасса"                 , ПредопределенноеЗначение("Перечисление.ТипыПлатежнойСистемыККТ.ЮКасса"));
