...
Процедура СформироватьОтчет(ПараметрыОтчета, АдресХранилища) Экспорт
	...
	ДанныеОтчета.Вставить("СостояниеДосье",    "");
	...
	Если ДанныеОтчета.СостояниеДосье = "ПолученыДанные" Тогда
		...
		ДанныеДосье.Вставить("РезультатГлавное",                 Неопределено);
		ДанныеДосье.Вставить("РезультатАнализОтчетности",        Неопределено);
		ДанныеДосье.Вставить("РезультатБухгалтерскаяОтчетность", Неопределено);
		ДанныеДосье.Вставить("РезультатФинансовыйАнализ",        Неопределено);
		ДанныеДосье.Вставить("РезультатНалоги",                  Неопределено);
		ДанныеДосье.Вставить("РезультатДанныеПрограммы",         Неопределено);
...
Процедура ПолучитьСостояниеКонтрагентаПоДаннымЕГРН(ИнформацияОСвязях, Контрагент)
	...
	ЭтоЮридическоеЛицо = (СтрДлина(ИнформацияОСвязях.ИНН) = 10);
	КПП = ?(ЭтоЮридическоеЛицо, ИнформацияОСвязях.КПП, "");
