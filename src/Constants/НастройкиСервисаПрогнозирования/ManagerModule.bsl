	...
	Попытка
		...
		Если СохраненныеНастройкиПрогнозирования <> Неопределено Тогда
			...
			Если СохраненныеНастройкиПрогнозирования.ИмяСервиса <> ШаблонНовыхНастроек.ИмяСервиса Тогда
				...
				Если ЗначениеЗаполнено(СохраненныеНастройкиПрогнозирования.ТокенПриложения)
					И СохраненныеНастройкиПрогнозирования.СтатусПодключения = СервисПрогнозирования.СтатусПодключенияАктивен() Тогда
