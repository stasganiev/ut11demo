...
Процедура УправлениеФормой(Форма)
	...
	СтруктураДействий = ПолучитьССервераКлиентскиеДействияДляУправленияФормой(СтруктураПараметров);
...
Функция ПолучитьССервераКлиентскиеДействияДляУправленияФормой(Знач СтруктураПараметров)

	// СтруктураПараметров:
	//  * ЗаполняетсяАвтоматически;
	//  * Ссылка;
	//  * ТипЗначения;
	//  * ТипЗначенияВспомогательный;
	//  * ОбновляетсяССервера.
	...
	ЗаполненоИмяСтраницыЗначенийКатегорий = Ложь;
	...
	Если СтруктураПараметров.ЗаполняетсяАвтоматически = Истина Тогда
		...
		Если ПустаяСтрока(Значение) Тогда
			...
			ЗаполненоИмяСтраницыЗначенийКатегорий = Истина;
		Иначе
	...
	Если ЗаполненоИмяСтраницыЗначенийКатегорий = Ложь Тогда
		Если (ТипЗнч(СтруктураПараметров.ТипЗначения) = ТипОписаниеТипов) Тогда // Несколько типов
			...
			Иначе
				СтруктураДействий.Вставить("СтраницаЗначенийКатегорий", "СтраницаПустая");
			КонецЕсли;
		ИначеЕсли (ТипЗнч(СтруктураПараметров.ТипЗначения) = ТипТип) Тогда // Один тип значения
