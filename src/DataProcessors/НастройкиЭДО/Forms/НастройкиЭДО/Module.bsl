...
Процедура НастроитьОтображениеСтраницСервер()
	...
	НастройкиОтправки.Параметры.УстановитьЗначениеПараметра("ПустойДоговор", ПустойДоговор);
...
Процедура ОткрытьФормуНастроекПолучения(ФормаСоздания = Ложь)
	...
	НастройкиЭДОКлиент.ОткрытьНастройкуОтраженияВУчете(ПараметрыФормы, ПараметрыОткрытия);
