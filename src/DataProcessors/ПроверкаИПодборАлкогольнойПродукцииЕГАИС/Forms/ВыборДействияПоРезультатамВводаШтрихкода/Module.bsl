...
Процедура ВнешнееСобытие(Источник, Событие, Данные)
	...
	СобытияФормИСКлиент.ВнешнееСобытиеПолученыШтрихкоды("ПоискПоШтрихкодуЗавершение", ЭтотОбъект, Источник, Событие, Данные, ПараметрыСканирования);
...
Процедура СформироватьИнформациюОРезультатахПоиска()
	...
	Иначе
		...
		ТекстШтрихкодНеНайден = Новый ФорматированнаяСтрока(
			НСтр("ru = 'Штрихкод'"), " """, СтрокаШтрихкод, """ ", НСтр("ru = 'в данных документа не найден.'"));
