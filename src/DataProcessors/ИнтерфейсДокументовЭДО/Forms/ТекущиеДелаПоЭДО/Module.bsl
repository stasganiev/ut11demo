...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОтложеннаяОтправкаЭлектронныхДокументов = НастройкиЭДО.ОтложеннаяОтправкаЭлектронныхДокументов();
	...
	Если НЕ ЭлектронныеДокументыЭДО.ЕстьПравоОбработкиДокументов() Тогда
		...
		НедоступныеКоманды.Добавить("ЗагрузитьФайлы");
	...
	Сформировать.Параметры.УстановитьЗначениеПараметра("ТипыДоговорСКонтрагентомЭДО", ТипыДоговорСКонтрагентомЭДО);
	
	УстановитьОтображениеЭлементовПоНастройкамПользователя();
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = ИнтерфейсДокументовЭДОКлиент.ИмяСобытияОбновленияСостоянияЭДО()
		...
		ТекущийЭДСпискаСовпадаетСПараметромОповещения = Ложь;
		Если ТипЗнч(Параметр) = Тип("Структура") И Параметр.Свойство("ЭлектронныеДокументы") Тогда
			ТекущийЭДСпискаСовпадаетСПараметромОповещения = 
				Параметр.ЭлектронныеДокументы.Найти(ТекущийЭлектронныйДокумент) <> Неопределено;
		КонецЕсли;
		Если Параметр = Неопределено Или ТекущийЭДСпискаСовпадаетСПараметромОповещения Тогда
...
Процедура ПриОткрытии(Отказ)
	...
	ПоказатьВыборВариантаИнтерфейса();
...
Процедура ТекущийДокументУчетаПредставлениеНажатие(Элемент, СтандартнаяОбработка)
	...
	ИначеЕсли ТекущийСписок = Элементы.ВходящиеЭД Тогда
		...
		ПоказатьДанныеВЗависимостиОтОтраженияВУчете(ТекущиеДанные.КонтрольОтраженияВУчете);
...
Процедура БыстрыеОтборыПриАктивизацииСтроки(Элемент)
	...
	СтрокаБыстрыеОтборы = Элементы.БыстрыеОтборы.ТекущаяСтрока;
	ДанныеБыстрыеОтборы = Элементы.БыстрыеОтборы.ТекущиеДанные;
	
	Если ДанныеБыстрыеОтборы = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	Если ТекущаяСтрокаВОтбореВПапке <> СтрокаБыстрыеОтборы Тогда
		НеобходимВыпадающийСписок = Не (ДанныеБыстрыеОтборы.Тип = "Дата" Или ДанныеБыстрыеОтборы.Тип = "Число");
		Элементы.БыстрыеОтборыЗначение.КнопкаВыпадающегоСписка = НеобходимВыпадающийСписок;
		ТекущаяСтрокаВОтбореВПапке = СтрокаБыстрыеОтборы;
...
Процедура БыстрыеОтборыЗначениеПриИзменении(Элемент)
	...
	ДанныеБыстрыеОтборы = Элемент.Родитель.ТекущиеДанные;
	Если ДанныеБыстрыеОтборы = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	Если ДанныеБыстрыеОтборы.Тип = "Число" Тогда
		ВведеноЧисло = Истина;
	КонецЕсли;
...
Процедура БыстрыеОтборыПриНачалеРедактирования(Элемент, НоваяСтрока,
	...
	ДанныеБыстрыеОтборы = Элемент.ТекущиеДанные;
	Если ДанныеБыстрыеОтборы = Неопределено Тогда
		Возврат;
	КонецЕсли;

	Если ДанныеБыстрыеОтборы.Значение = Неопределено И Не ДанныеБыстрыеОтборы.Тип = "Булево" Тогда
		ДанныеБыстрыеОтборы.Значение = 0;
	Иначе
		ВведеноЧисло = Истина;
	КонецЕсли;
...
Процедура БыстрыеОтборыПриОкончанииРедактирования(Элемент, НоваяСтрока,	ОтменаРедактирования)
	...
	Если Не ВведеноЧисло И ДанныеБыстрыеОтборы.Тип = "Число" Тогда
		ДанныеБыстрыеОтборы.Значение = Неопределено;
	КонецЕсли;
...
Процедура БыстрыеОтборыЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ДанныеБыстрыеОтборы.Параметр = "ВидДокумента" Тогда
...
Процедура БыстрыеОтборыЗначениеОчистка(Элемент, СтандартнаяОбработка)
	...
	Если ДанныеБыстрыеОтборы.Тип = "Строка" Тогда
		ДанныеБыстрыеОтборы.Значение = "";
	ИначеЕсли ДанныеБыстрыеОтборы.Тип = "Дата" Тогда
		ДанныеБыстрыеОтборы.Значение = Дата(1, 1, 1);
	ИначеЕсли ДанныеБыстрыеОтборы.Тип = "Число" Тогда
		ДанныеБыстрыеОтборы.Значение = Неопределено;
	ИначеЕсли ДанныеБыстрыеОтборы.Тип = "Булево" Тогда
		ДанныеБыстрыеОтборы.Значение = Неопределено;
	ИначеЕсли ДанныеБыстрыеОтборы.Тип = "ПеречислениеСсылка.ТипыДокументовЭДО" Тогда
		ДанныеБыстрыеОтборы.Значение = ПредопределенноеЗначение("Перечисление.ТипыДокументовЭДО.ПустаяСсылка");
	ИначеЕсли ДанныеБыстрыеОтборы.Тип = "СправочникСсылка." + НазваниеСправочникаКонтрагенты Тогда
		ДанныеБыстрыеОтборы.Значение = ПредопределенноеЗначение("Справочник." + НазваниеСправочникаКонтрагенты 
			+ ".ПустаяСсылка");
	ИначеЕсли ДанныеБыстрыеОтборы.Тип = "СправочникСсылка." + НазваниеСправочникаОрганизации Тогда
		ДанныеБыстрыеОтборы.Значение = ПредопределенноеЗначение("Справочник." + НазваниеСправочникаОрганизации 
			+ ".ПустаяСсылка");
	ИначеЕсли ДанныеБыстрыеОтборы.Тип = "СправочникСсылка.Пользователи" Тогда
		ДанныеБыстрыеОтборы.Значение = ПредопределенноеЗначение("Справочник.Пользователи.ПустаяСсылка");
	ИначеЕсли ДанныеБыстрыеОтборы.Тип = "ПеречислениеСсылка.НаправленияЭДО" Тогда
		ДанныеБыстрыеОтборы.Значение = ПредопределенноеЗначение("Перечисление.НаправленияЭДО.ПустаяСсылка");
	КонецЕсли;
...
Процедура ДеревоДействийПриАктивизацииСтроки(Элемент)
	...
	Если НовыйРаздел <> ТекущийРаздел Тогда
		ПриИзмененииРаздела(НовыйРаздел, Истина);
		ПодключитьОбработчикОжидания("УстановитьУсловноеОформлениеКлиент", 0.1, Истина);
	КонецЕсли;
...
Процедура ВходящиеЭДВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ВходящиеЭДОтражениеВУчете" И Не ЭтоКаталогТоваров Тогда
		СтандартнаяОбработка = Ложь;
		ПоказатьДанныеВЗависимостиОтОтраженияВУчете(ДанныеСтроки.КонтрольОтраженияВУчете);
	Иначе
		СтандартнаяОбработка = Ложь;
...
Процедура ВыполнитьКомандаПодписать()	
	...
	Если ТекущийРаздел <> "ПодписатьИсх" Тогда
	...
	ЭлектронныеДокументыЭДОКлиентСервер.ДобавитьДействие(НаборДействий, ПредопределенноеЗначение("Перечисление.ДействияПоЭДО.ПодготовитьКОтправке"));
	Если Не ОтложеннаяОтправкаЭлектронныхДокументов Тогда
		ЭлектронныеДокументыЭДОКлиентСервер.ДобавитьДействие(НаборДействий, ПредопределенноеЗначение("Перечисление.ДействияПоЭДО.Отправить"));
	КонецЕсли;
...
&НаКлиенте
Процедура ПерейтиНаЛегкийИнтерфейс(Команда)
	
	ИнтерфейсДокументовЭДОКлиент.ИзменитьВариантИнтерфейсаПользователя(Истина, ЭтотОбъект);
...
Процедура ПоказатьКомментарийСостояния(Команда)
	...
	ОбщегоНазначенияКлиент.ПоказатьФормуРедактированияКомментария(ТекущийКомментарийСостояния, ЭтотОбъект, 
		"ТекущийКомментарийСостояния");
...
Функция ПоляРаздела(Знач Раздел, Знач ПакетноеОтображение)
	...
	ПоляТаблицыНоменклатураКонтрагентов = "Контрагент, Сопоставить";
...
&НаКлиенте
Процедура ПриИзмененииРаздела(Знач НовыйРаздел, ИсключитьСерверныеВызовы = Ложь)
...
// &ЗамерПроизводительности
	...
	Если ИсключитьСерверныеВызовы Тогда
		ТекущийРаздел = НовыйРаздел;
		ПодключитьОбработчикОжидания("ПоказатьРазделКлиент", 0.1, Истина);
	Иначе
...
&НаКлиенте
Процедура ПоказатьРазделКлиент()
	ПоказатьРаздел(ТекущийРаздел);
КонецПроцедуры
...
Процедура ОбработатьПересечениеПользовательскихОтборовИОтбораПоРазделу(Знач Раздел,
	...
	ПользовательскийОтбор = ИнтерфейсДокументовЭДО.ПользовательскийОтборСписка(Список);
	ЭлементыПользовательскогоОтбора = ИнтерфейсДокументовЭДО.ЭлементыОтбора(ПользовательскийОтбор);

	ГруппаОтборПоРазделам = ОбщегоНазначенияКлиентСервер.НайтиЭлементОтбораПоПредставлению(Список.Отбор.Элементы, 
		"ОтборПоРазделам");
	Если ГруппаОтборПоРазделам = Неопределено Тогда
		Возврат;
	КонецЕсли;
	ЭлементыОтбораПоРазделам = ИнтерфейсДокументовЭДО.ЭлементыОтбора(ГруппаОтборПоРазделам);
	...
	Для Каждого ЭлементПользовательскогоОтбора Из ЭлементыПользовательскогоОтбора Цикл
		...
		Для каждого ЭлементОтбораПоРазделам Из ЭлементыОтбораПоРазделам Цикл

			Если ЭлементПользовательскогоОтбора.ЛевоеЗначение = ЭлементОтбораПоРазделам.ЛевоеЗначение Тогда
...
Процедура ОбработатьПересечениеПользовательскихОтборовИБыстрыхОтборов(Знач Раздел,
	...
	ГруппаБыстрыйОтбор = ОбщегоНазначенияКлиентСервер.НайтиЭлементОтбораПоПредставлению(Список.Отбор.Элементы, 
		"БыстрыйОтбор");
	Если ГруппаБыстрыйОтбор = Неопределено Тогда
		Возврат;
	КонецЕсли;
	ЭлементыБыстрогоОтбора = ИнтерфейсДокументовЭДО.ЭлементыОтбора(ГруппаБыстрыйОтбор);
	...
	Для Каждого ЭлементПользовательскогоОтбора Из ЭлементыПользовательскогоОтбора Цикл
		...
		Для каждого ЭлементБыстрогоОтбора Из ЭлементыБыстрогоОтбора Цикл

			Если ЭлементПользовательскогоОтбора.ЛевоеЗначение = ЭлементБыстрогоОтбора.ЛевоеЗначение Тогда
...
Процедура УстановитьТекстКнопкиБыстрыхОтборов(Знач Раздел)
	...
	ТекстКнопкиПользовательскогоОтбора = НСтр("ru = 'еще'");
	Если ЗначениеЗаполнено(КоличествоЭлементов) Тогда
		ТекстКнопкиПользовательскогоОтбора = НСтр("ru = 'и еще'") + " " + Строка(КоличествоЭлементов);
	КонецЕсли;
	...
	Для каждого СтрокаОтбора Из БыстрыеОтборы Цикл
		...
		Если СтрокаОтбора.Параметр = "ПользовательскийОтбор" Тогда
			Если СтрокаОтбора.Кнопка <> ТекстКнопкиПользовательскогоОтбора Тогда
				СтрокаОтбора.Кнопка = ТекстКнопкиПользовательскогоОтбора;
			КонецЕсли;
			Продолжить;
		КонецЕсли;

		ТекстКнопки = "";
		УстановленПользовательскийОтбор = Ложь;
		...
		Для каждого ЭлементПользовательскогоОтбора Из ЭлементыПользовательскогоОтбора Цикл
			...
			ИмяПоля = Строка(ЭлементПользовательскогоОтбора.ЛевоеЗначение);
			...
			Если СтрНайти(ПараметрыОтбора, СтрокаОтбора.Параметр) <> 0 Тогда
				...
				Если ЭлементПользовательскогоОтбора.Родитель = Неопределено И Не УстановленПользовательскийОтбор Тогда

					ТекстКнопки = СтрокаОтбора.ПредставлениеПараметра + " "
						+ Строка(ЭлементПользовательскогоОтбора.ВидСравнения) + " "
						+ Строка(ЭлементПользовательскогоОтбора.ПравоеЗначение);
				...
				УстановленПользовательскийОтбор = Истина;
...
Процедура УстановитьДоступностьСбросаОтбора(Знач Раздел)
	...
	Если Не ЕстьОтборы Тогда
		...
		ИмяСписка = СписокРаздела(Раздел);
		Список = ЭтотОбъект[ИмяСписка];
		Отбор = ИнтерфейсДокументовЭДО.ПользовательскийОтборСписка(Список);
		ВсеЭлементыОтбора = ИнтерфейсДокументовЭДО.ЭлементыОтбора(Отбор);
...
Процедура СинхронизироватьПользовательскиеОтборы(Знач ИмяСпискаИсточника)
	...
	ОтборИсточник = ИнтерфейсДокументовЭДО.ПользовательскийОтборСписка(СписокИсточник);
	...
	Для каждого ИмяСписка Из ВсеСписки Цикл
		...
		ОтборПриемник = ИнтерфейсДокументовЭДО.ПользовательскийОтборСписка(СписокПриемник);
...
Функция МакетРасчетаПоРазделу(Знач Раздел,
	...
	// Убираем пользовательские отборы.
		ПользовательскийОтбор = ИнтерфейсДокументовЭДО.ПользовательскийОтборСписка(СписокЭД);
	...
	ЗапросСпискаСодержитАгрегатнуюФункциюИГруппировку = Ложь;
	ПоляДляДобавления = Новый Массив;
		
	Для Каждого Оператор Из ПоследнийЗапрос.Операторы Цикл

		Если Оператор.Группировка.Количество() Тогда  
			
			ПоляДляУдаления = Новый Массив;
			
			Для Каждого ВыбираемоеПоле Из Оператор.ВыбираемыеПоля Цикл
				
				Если ВыбираемоеПоле.СодержитАгрегатнуюФункцию() Тогда
					ЗапросСпискаСодержитАгрегатнуюФункциюИГруппировку = Истина;
					
					// Убираем поля с агрегатной функцией и добавляем новое, преобразовав к обычному выражению.
					АгрегатноеВыражение = Строка(ВыбираемоеПоле); 
					НачалоПараметра = СтрНайти(АгрегатноеВыражение, "(");
					ДлинаПараметраВыражения = СтрДлина(АгрегатноеВыражение) - НачалоПараметра - 1;
					ПараметрВыражения = Сред(АгрегатноеВыражение, НачалоПараметра + 1, ДлинаПараметраВыражения);
					ПутьКПолю = СокрЛП(СтрЗаменить(ПараметрВыражения, "РАЗЛИЧНЫЕ", ""));
	
					НовоеПолеСхемыЗапроса = Оператор.ВыбираемыеПоля.Добавить(ПутьКПолю);
					КолонкаПоля = ПоследнийЗапрос.Колонки.Найти(НовоеПолеСхемыЗапроса);
					ПоляДляДобавления.Добавить(КолонкаПоля.Псевдоним);
					
					ПоляДляУдаления.Добавить(ВыбираемоеПоле);
				КонецЕсли;
				
			КонецЦикла;
			
			Для Каждого ПолеДляУдаления Из ПоляДляУдаления Цикл
				ИндексПоля = Оператор.ВыбираемыеПоля.Индекс(ПолеДляУдаления);
		...
		Если Не ЗапросСпискаСодержитАгрегатнуюФункциюИГруппировку Тогда
			// Добавляем в настройках только поле-счетчик.
			...
			ПоляДляДобавления.Добавить(КолонкаСчетчик.Псевдоним);
		КонецЕсли;
	...
	Для Каждого ПолеДляДобавления Из ПоляДляДобавления Цикл
		ВыбранноеПоле = ДетальныеЗаписи.Выбор.Элементы.Добавить(Тип("ВыбранноеПолеКомпоновкиДанных"));
		ВыбранноеПоле.Поле = Новый ПолеКомпоновкиДанных(ПолеДляДобавления);
	КонецЦикла;
...
Процедура ПоказатьЭлементыРаздела(Знач Раздел)
	...
	ОчиститьОбластьПросмотра(ЭтотОбъект);
...
Процедура ИзменитьРежимПросмотраОкончание(Результат,
	...
	Если Результат.ВыбранЛегкийВариантИнтерфейса Тогда
		ИнтерфейсДокументовЭДОКлиент.ИзменитьВариантИнтерфейсаПользователя(Истина, ЭтотОбъект);
		Возврат;
	КонецЕсли;
...
&НаКлиенте
Процедура УстановитьУсловноеОформлениеКлиент()
	УстановитьУсловноеОформление();
КонецПроцедуры
...
Процедура УстановитьУсловноеОформление()
	...
	ИменаСписков = "ВходящиеЭД,ИсходящиеЭД,ОзнакомитьсяЭД,ОтправитьЭД,ОшибкиЭД,Сформировать";
	...
	Для каждого ИмяСписка Из ИменаСписков Цикл
		...
		ПолеЕстьНевалидныеПодписиПоМЧД = Новый ПолеКомпоновкиДанных("ЕстьНевалидныеПодписиПоМЧД");
		...
		Если ЭтотОбъект[ИмяСписка].УсловноеОформление.ДоступныеПоляПолей.НайтиПоле(ПолеПометкаУдаления) <> Неопределено Тогда
			...
			ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
			ОтборЭлемента.ЛевоеЗначение = ПолеПометкаУдаления;
			ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
			ОтборЭлемента.ПравоеЗначение = Истина;
			
			ПолеПрочтен = Новый ПолеКомпоновкиДанных("Прочтен");
			Если ЭтотОбъект[ИмяСписка].УсловноеОформление.ДоступныеПоляПолей.НайтиПоле(ПолеПрочтен) <> Неопределено
				...
				ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
				ОтборЭлемента.ЛевоеЗначение = ПолеПрочтен;
				ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
				ОтборЭлемента.ПравоеЗначение = Ложь;
	...
	Для Каждого СтрокаТаблицы Из МассивКонтейнеров Цикл
		...
		Исключение
			...
			Ошибка = ОбработкаНеисправностейБЭД.НоваяОшибка(ТекстОперации,
				ОбработкаНеисправностейБЭДКлиентСервер.ВидОшибкиНеизвестнаяОшибка(), ОбработкаОшибок.ПодробноеПредставлениеОшибки(
				ИнформацияОбОшибке()), ОбработкаОшибок.КраткоеПредставлениеОшибки(ИнформацияОбОшибке()), ДополнительныеПараметрыОшибки);
...
&НаСервере
Процедура УстановитьОтображениеЭлементовПоНастройкамПользователя()
...
Процедура ОбновитьЗаголовкиЭлементов()
	...
	Если ОтложеннаяОтправкаЭлектронныхДокументов Тогда
		...
		Элементы.КомандаПодписатьИсх.Заголовок = НСтр("ru = 'Подписать'");
...
Процедура УстановитьСвойстваПереопределяемыхЭлементовФормы()
	...
	Элементы.НоменклатураКонтрагентовКонтрагент.Заголовок = МетаданныеСопоставления.ВладелецНоменклатурыПредставлениеОбъекта;
...
&НаКлиенте
Процедура ПоказатьВыборВариантаИнтерфейса()

	Если Не ИнтерфейсДокументовЭДОВызовСервера.ТребуетсяПоказатьОкноВыбораВариантаИнтерфейса() Тогда
		Возврат;
	КонецЕсли;

	ФормаВыбораИнтерфейса = ИнтерфейсДокументовЭДОКлиентСервер.ФормаВыбораВариантаИнтерфейса();
	ОткрытыеФормы = ОбщегоНазначенияБЭДКлиент.ОткрытаяФормаОкнаПриложения(ФормаВыбораИнтерфейса);
	
	Если ОткрытыеФормы.Количество() Тогда
		Для Каждого ОткрытаяФорма Из ОткрытыеФормы Цикл
			ОткрытаяФорма.Закрыть();
		КонецЦикла;
	КонецЕсли;
	
	ОповещениеОЗавершении = Новый ОписаниеОповещения("ВыборВариантаИнтерфейсаЗавершение", ЭтотОбъект);
	ОткрытьФорму(ФормаВыбораИнтерфейса,, ЭтотОбъект,,,, ОповещениеОЗавершении, 
		РежимОткрытияОкнаФормы.БлокироватьОкноВладельца); 
		
КонецПроцедуры

&НаКлиенте
Процедура ВыборВариантаИнтерфейсаЗавершение(Результат, ДополнительныеПараметры) Экспорт

	Если Результат = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	ИнтерфейсДокументовЭДОВызовСервера.СохранитьВыборВариантаИнтерфейсаИзФормыВыбора(
		Результат.ВыбранЛегкийВариантИнтерфейса);
	ИнтерфейсДокументовЭДОКлиент.ИзменитьВариантИнтерфейсаПользователя(Результат.ВыбранЛегкийВариантИнтерфейса, 
		ЭтотОбъект, Ложь);
...
&НаКлиенте
Процедура ПоказатьДанныеВЗависимостиОтОтраженияВУчете(КонтрольОтраженияВУчете)
...
Процедура ПоказатьСопоставлениеНоменклатуры()
	...
	Если ТекущийРаздел = "НоменклатураКонтрагентов" Тогда
		...
		Для Каждого СтрокаСписка Из Элементы.НоменклатураКонтрагентов.ВыделенныеСтроки Цикл
			...
			Владельцы.Добавить(ДанныеСтроки.Контрагент);
		КонецЦикла;
...
&НаКлиентеНаСервереБезКонтекста
Процедура ОчиститьОбластьПросмотра(Форма)
	
	Форма.ТекущийЭлектронныйДокумент = Неопределено;
	Форма.ТекущееСообщениеЭДО = Неопределено;
	
	Форма.Элементы.ГруппаФайл.Видимость = Ложь;
	Форма.Элементы.ТекущийДокументУчетаПредставление.Видимость = Ложь;
	Форма.ТекущийДокументТабличныйДокумент = Новый ТабличныйДокумент;
	Форма.ТекущийДокументPDF = Неопределено;
	
	Форма.Элементы.ТекущееСостояниеЭДОФайл.Видимость = Ложь;
	Форма.Элементы.ТекущееСостояниеЭДОУчет.Видимость = Ложь;
	
	Форма.Элементы.ПоказатьКомментарийСостоянияЭДОФайл.Видимость = Ложь;
	Форма.Элементы.ПоказатьКомментарийСостоянияЭДОУчет.Видимость = Ложь;
	
	Форма.Элементы.СтраницыПредставленийДокумента.ТекущаяСтраница = Форма.Элементы.СтраницаПустая;
...
Функция СтруктураЭлементаСхемыРегламента()
	...
	ЭлементСхемыРегламента.Вставить("АдресФайла", "");
...
&НаСервереБезКонтекста
Функция СтруктураЭлементаСхемыРегламентаСЗависимымЭлементом()
	ЭлементСхемыРегламента = СтруктураЭлементаСхемыРегламента();
	ЭлементСхемыРегламента.Вставить("ЗависимыйЭлементСхемыРегламента", СтруктураЭлементаСхемыРегламента());
	Возврат ЭлементСхемыРегламента;
КонецФункции
...
Функция СтруктураДанныхОбластиПросмотра()
	...
	ДанныеОбластиПросмотра.Вставить("КомментарийСостояния", "");
	...
	ДанныеОбластиПросмотра.Вставить("ЭлементСхемыРегламента", СтруктураЭлементаСхемыРегламентаСЗависимымЭлементом());
	ДанныеОбластиПросмотра.Вставить("ПроштампованныйФайл", Неопределено);
	ДанныеОбластиПросмотра.Вставить("Сообщение", Неопределено);
	ДанныеОбластиПросмотра.Вставить("ПовторноеСрабатывание", Ложь);
...
Процедура ЗаполнитьДанныеОбластиПросмотраПоФайлу(СтруктураВозврата, ПараметрыФормирования)
	...
	ЗначенияПараметров.Вставить("Дата", Формат(ПараметрыДокумента.ДатаДокумента, "ДЛФ=D"));
	...
	ДанныеПроштамповки = ИнтерфейсДокументовЭДО.ПроштампованныйФайлPDF(
		ЭлементСхемыРегламента.Сообщение, ПараметрыФормирования.УникальныйИдентификатор);
	СтруктураВозврата.ФормированиеПредставления = ДанныеПроштамповки.ДлительнаяОперация;
	...
	Если ДанныеПроштамповки.ИспользоватьПросмотрПроштампованногоФайла Тогда
		...
		ОбновитьПредставлениеДокумента(ПараметрыФормирования.ТекущийЭлектронныйДокумент,
			СтруктураВозврата.ФормированиеПредставления, ЭлементСхемыРегламента, СтруктураВозврата.ПредставлениеДокумента,
			СтруктураВозврата.Статус, СтруктураВозврата.ПрочтениеДолжноБытьУстановлено,
			ПараметрыФормирования.ЕстьОтборПоНепрочтенным);
	Иначе
		СтруктураВозврата.Статус = "ВыполненоПустая";
	КонецЕсли;
...
Функция ПопыткаЗаполнитьЭлементСхемыРегламента(СтруктураВозврата, ПараметрыФормирования)
	...
	Если ИнформацияПолучателя <> Неопределено Тогда
		ЗаполнитьЗначенияСвойств(ЭлементСхемыРегламента.ЗависимыйЭлементСхемыРегламента, ИнформацияПолучателя);
	КонецЕсли;
...
Функция ДанныеОбластиПросмотра(Знач ПараметрыФормирования)
	...
	ЗаполнитьДанныеПоСостоянию(СтруктураВозврата, ТекущийЭлектронныйДокумент);
	...
	Если ЭлементСхемыРегламентаЗаполнен Тогда
		...
		Если ТекущееСообщениеЭДО = ЭлементСхемыРегламента.Сообщение Тогда
			СтруктураВозврата.ПовторноеСрабатывание = Истина;
			Возврат СтруктураВозврата;
		КонецЕсли;
		
		ТипДокумента = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ТекущийЭлектронныйДокумент, "ВидДокумента.ТипДокумента");
		
		Если ТипДокумента <> Перечисления.ТипыДокументовЭДО.ДоговорныйДокумент Тогда
 			ЭлементСхемыРегламента.Распознан = РаспознатьДокумент(ТекущийЭлектронныйДокумент);
 		Иначе
 			ЭлементСхемыРегламента.Распознан = Ложь;
		КонецЕсли;
		
		Если Не ЭлементСхемыРегламента.Распознан И ЭлементСхемыРегламента.Направление <> Перечисления.НаправленияЭДО.Внутренний
		...
		КонецЕсли;
		ТекущееСообщениеЭДО = ЭлементСхемыРегламента.Сообщение;
	КонецЕсли;
	Если СтруктураВозврата.ПредставлениеДокумента = Неопределено Тогда
		ЗаполнитьДанныеОбластиПросмотраПоФайлу(СтруктураВозврата, ПараметрыФормирования);
	КонецЕсли;
	Возврат СтруктураВозврата;
...
Процедура ОбновитьПредставлениеДокумента(ТекущийДокументЭДО, ФормированиеПредставления, 
	...
	ИначеЕсли ФормированиеПредставления.Статус = "Выполнено" Тогда
		...
		ПодготовитьПредставлениеДокумента(ТекущийДокументЭДО, ФормированиеПредставления, 
			...
			ЕстьОтборПоНепрочтенным, Статус);
...
Процедура ПодготовитьПредставлениеДокумента(ТекущийЭлектронныйДокумент, ФормированиеПредставления, 
	...
	ИначеЕсли РезультатФормирования.ПредставлениеДокумента = Неопределено Тогда
		Если Не ЭлементСхемыРегламента.Распознан Тогда
			Если ЗначениеЗаполнено(РезультатФормирования.ТекстОшибки) Тогда
				Статус = "";
			Иначе
				Статус = "ВыполненоПустая";
			КонецЕсли;
		КонецЕсли;
		...
		Возврат;
	Иначе
		Если ТипЗнч(РезультатФормирования.ПредставлениеДокумента) = Тип("ДвоичныеДанные") Тогда
			
			Отказ = Ложь;
			
			Попытка
				ТекущийДокументPDF.Прочитать(РезультатФормирования.ПредставлениеДокумента.ОткрытьПотокДляЧтения());
			Исключение
				Отказ = Истина;
			...
			Если Отказ Тогда
				Статус = "";
			Иначе
				Статус = "ВыполненоТекущийДокументPDF";
			КонецЕсли;
			
        Иначе
			ЭлектронныеДокументыЭДО.ДополнитьТабличныйДокументШтампамиПодписей(РезультатФормирования.ПредставлениеДокумента, 
				ЭлементСхемыРегламента.Сообщение);
			Статус = "ВыполненоТабличныйДокумент";
			ПредставлениеДокумента = РезультатФормирования.ПредставлениеДокумента;
		КонецЕсли;
	КонецЕсли;
...
Процедура ПоказатьПредставлениеДанныхДокументаПослеФормирования(Результат, Контекст) Экспорт
	...
	// Если электронные документы не совпадают, значит визуализация неактуальна.
	Если Контекст.ЭлектронныйДокумент <> ТекущийЭлектронныйДокумент Тогда
		Возврат;
	КонецЕсли;
...
&НаСервереБезКонтекста
Процедура ЗаполнитьДанныеПоСостоянию(ДанныеОбластиПросмотра, ТекущийЭлектронныйДокумент)
	...
	ДанныеОбластиПросмотра.ТекущееСостояниеЭДО = ПредставлениеСостояния;
	ДанныеОбластиПросмотра.КомментарийСостояния = СостояниеДокументаПодробное.Комментарий;
...
Процедура УстановитьСтраницуПредставления(Статус)
	...
	Если Статус = "Выполнено" Или Статус = "ВыполненоТабличныйДокумент" Тогда
		 Элементы.СтраницыПредставленийДокумента.ТекущаяСтраница = Элементы.СтраницаТабличныйДокумент;
	ИначеЕсли Статус = "ВыполненоТекущийДокументPDF" Тогда
		 Элементы.СтраницыПредставленийДокумента.ТекущаяСтраница = Элементы.СтраницаТекущийДокументPDF;
	ИначеЕсли Статус = "ВыполненоПустая" Тогда
		Элементы.СтраницыПредставленийДокумента.ТекущаяСтраница = Элементы.СтраницаПустая;	
...
Процедура ОбновитьОбластьПросмотра()
	...
	Если ДанныеПросмотра.ПовторноеСрабатывание Тогда
		Возврат;
	КонецЕсли;
	...
	ТекущийКомментарийСостояния = ДанныеПросмотра.КомментарийСостояния;
	...
	ЕстьКомментарийСостояния = ЗначениеЗаполнено(ДанныеПросмотра.КомментарийСостояния);

	Элементы.ГруппаФайл.Видимость = ПоказатьФайл;
	Элементы.ТекущееСостояниеЭДОФайл.Видимость =  ПоказатьФайл и Не ПоказатьДокументУчета;
	Элементы.ПоказатьКомментарийСостоянияЭДОФайл.Видимость = ПоказатьФайл И ЕстьКомментарийСостояния;
	...
	Элементы.ПоказатьКомментарийСостоянияЭДОУчет.Видимость = ПоказатьДокументУчета И ЕстьКомментарийСостояния;
