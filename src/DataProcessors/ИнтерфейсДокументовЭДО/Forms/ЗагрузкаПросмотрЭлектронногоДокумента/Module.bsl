...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ (ПараметрыФайла = Неопределено Или ПараметрыФайла.ОтражениеВУчете = Неопределено) Тогда
		...
		СписокТипов = ИнтеграцияЭДО.СписокОперацийВидаДокумента(ВидДокумента);
...
Процедура ЗагрузитьДокументЭДО()
	...
	Если Не ЗначениеЗаполнено(Контрагент) 
		И (ТипДокумента <> ПредопределенноеЗначение("Перечисление.ТипыДокументовЭДО.РеквизитыОрганизации")
		Или СпособЗагрузкиДокумента = 1 И ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыДокументовЭДО.РеквизитыОрганизации")) Тогда
	...
	Если ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыДокументовЭДО.РеквизитыОрганизации") Тогда 
	...
	Если ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыДокументовЭДО.РеквизитыОрганизации") 
	...
	Если ВыбранныеСпособыОбработки.Количество() = 2 Тогда
		ВыбранныеСпособыОбработки = Новый Структура("СчетФактура, ПервичныйДокумент", ВыбранныеСпособыОбработки[0],
			ВыбранныеСпособыОбработки[1]);
	ИначеЕсли ТипДокумента <> ПредопределенноеЗначение("Перечисление.ТипыДокументовЭДО.РеквизитыОрганизации") Тогда 
	...
	ОбщийМодульОтражениеВУчетеЭДОКлиент.НачатьОтражениеДокументаВУчете(ОповещениеОкончанияОтраженияВУчете,
		ДанныеДокументооборота, ОбъектыУчета, ВыбранныеСпособыОбработки);
