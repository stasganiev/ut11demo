...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ПросмотрВходящихСообщенийУТМ.Видимость           = ПравоДоступа("Использование", Метаданные.Обработки.ВходящиеСообщенияУТМЕГАИС);
	
	Элементы.ГруппаПроизводствоИмпорт.Видимость               = ОбщегоНазначения.ПодсистемаСуществует("ГосИС.ИСМП");
...
Процедура ОбновитьСпискиДокументовЕГАИС()
	...
	ДобавитьДокумент(
		...
		НСтр("ru = 'Уведомления о планируемом импорте ЕГАИС'"));
	
	ДобавитьДокумент(
		ТаблицаДокументы,
		Метаданные.Документы.ОтчетОбИмпортеЕГАИС,
		НСтр("ru = 'Отчеты об импорте ЕГАИС'"));
	
	ДобавитьДокумент(
		ТаблицаДокументы,
		Метаданные.Документы.ОтчетОПроизводствеЕГАИС,
		НСтр("ru = 'Отчеты о производстве ЕГАИС'"));
	
	ДобавитьДокумент(
		ТаблицаДокументы,
		Метаданные.РегистрыСведений.ВскрытыеПотребительскиеУпаковкиИС,
		ИнтеграцияИСПовтИсп.ПредставленияВскрытыхПотребительскихУпаковок("ЕГАИС").ЗаголовокСписка,
		Ложь,    // Оформите
		Ложь,  // Отработайте
		Ложь); // Ожидайте
