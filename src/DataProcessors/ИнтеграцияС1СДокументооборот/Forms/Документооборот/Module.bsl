...
Функция ОбработатьФормуСогласноВерсииСервиса()
	...
	Попытка
		...
		Иначе
			...
			ИспользоватьСвязанныеДокументы1СДокументооборота = (ДокументТип <> "DMCorrespondent")
				И Константы.ИспользоватьСвязанныеДокументы1СДокументооборота.Получить();
			ИспользоватьЭлектроннуюПочту1СДокументооборота =
				Константы.ИспользоватьЭлектроннуюПочту1СДокументооборота.Получить();
			ИспользоватьЕжедневныеОтчеты1СДокументооборота = (ДокументТип <> "DMCorrespondent")
				И Константы.ИспользоватьЕжедневныеОтчеты1СДокументооборота.Получить();
