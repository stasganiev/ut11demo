...
Функция ПолучитьСообщение(ШаблонИмениСообщения)
	...
	HTTPСоединение = Новый HTTPСоединение("cloud-api.yandex.net",,,,,Таймаут, ЗащищенноеСоединение);
	...
	HTTPСоединение = Новый HTTPСоединение(СсылкаПоЧастям.ИмяСервера,,,,,Таймаут, ЗащищенноеСоединение);
	...
	HTTPСоединение = Новый HTTPСоединение(СсылкаПоЧастям.ИмяСервера,,,,,
