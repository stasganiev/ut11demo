...
Процедура ДекорацияГиперссылкаНажатие(Элемент)
	...
	ОткрытьФорму("Обработка.ФорматДоговорнойДокумент101XML.Форма.ФормаСправкиПомощникПДФ_А3ДляЭД", ПараметрыФормы);
...
Процедура ОК(Команда)
	...
	Если ТипЗнч(ПараметрыФормыЭД) = Тип("Структура") Тогда   
		ИнтерфейсДокументовЭДОУТКлиент.ОткрытьДоговорнойДокумент101ИзФайла(ВыбранныйФайл, ПараметрыФормыЭД);	 	
	Иначе	
		ИнтерфейсДокументовЭДОУТКлиент.ЗапроситьФайлДляДоговорногоДокумента101Завершение(ВыбранныйФайл, ПараметрыФормыЭД); 
	КонецЕсли; 
