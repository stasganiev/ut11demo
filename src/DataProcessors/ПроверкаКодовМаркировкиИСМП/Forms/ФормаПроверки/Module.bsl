...
Процедура УстановитьПоляПредставленияСтроки(Форма, ТекущиеДанные)
	...
	КонецЕсли;
	ЭтоПродукцияСоСрокамиГодности   = ИнтеграцияИСМПКлиентСервер.ЭтоВидПродукцииСоСрокамиГодности(СтрокаДанных["ВидПродукции"]);
	...
	Если ОбщегоНазначенияИСКлиентСерверПовтИсп.ПоддерживаетсяЧастичноеВыбытие(СтрокаДанных["ВидПродукции"])
		...
		Если СтрокаДанных["ВидПродукции"] = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Пиво") Тогда
			...
			Если СтрокаДанных["ЧастичноеВыбытиеОстаток"] <> Неопределено Тогда
				ДанныеСтрокиЧастичногоВыбытия.Добавить(
					СтрШаблон(
						...
						ИнтеграцияИСКлиентСервер.ПредставлениеЕдиницыЧастичногоВыбытия(СтрокаДанных["ВидПродукции"])));
				ДанныеСтрокиЧастичногоВыбытия.Добавить(" ");
				ДанныеСтрокиЧастичногоВыбытия.Добавить(
		...
		Если ЭтоАльтернативныйТабак Или ЭтоБАД Или ЭтоНСП Тогда
