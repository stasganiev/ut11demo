...
Функция ТипыСторонДоговора() Экспорт
	...
	Шаблон = "ОбработкаТабличнаяЧастьСтрока.ФорматДоговорныйДокумент101.%1";
...
//  СведенияОбОбщейСтоимости - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеСведенияОбОбщейСтоимости
//  КонструкторЭД            - ОбработкаОбъект.ФорматДоговорныйДокумент101
//  Ошибки                   - Неопределено
//                           - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект          - ОбъектXDTO
//  ЭлементПредмета - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыйПредмет
//  КонструкторЭД   - ОбработкаОбъект.ФорматДоговорныйДокумент101
//  Ошибки          - Неопределено
//                  - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект          - ОбъектXDTO
//  УсловияПоставки - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеУсловияПоставки
//  Ошибки          - Неопределено
//                  - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект         - ОбъектXDTO
//  ПорядокРасчета - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыйПорядокРасчета
//  Ошибки         - Неопределено
//                 - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект       - ОбъектXDTO
//  СрокДействия - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыйСрокДействия
//  Ошибки       - Неопределено
//               - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
//  Сведения - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеСведенияОбИномДоговорномДокументе
//  Ошибки   - Неопределено
//           - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
//   * ДопСвСт     - СписокXDTO
//   * ПодписантСт - СписокXDTO
//  СторонаДоговора         - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НоваяСторонаДоговора
//  КонструкторЭД           - ОбработкаОбъект.ФорматДоговорныйДокумент101
//  Ошибки                  - Неопределено
//                          - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
...
// Параметры:
//  Объект        - ОбъектXDTO
//  СведенияОЛице - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеИдентификационныеСведенияИП
//                - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеИдентификационныеСведенияОрганизации
//                - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеИдентификационныеСведенияИностранногоЛица
//                - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеИдентификационныеСведенияФизЛица
//  КонструкторЭД - ОбработкаОбъект.ФорматДоговорныйДокумент101
//  Ошибки        - Неопределено
//                - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
//  Объект        - ОбъектXDTO:
//   * КПП - СписокXDTO
//  СведенияОЛице - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеИдентификационныеСведенияОрганизации
//  Ошибки        - Неопределено
//                - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект        - ОбъектXDTO
//  СведенияОЛице - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеИдентификационныеСведенияИностранногоЛица
//  КонструкторЭД - ОбработкаОбъект.ФорматДоговорныйДокумент101
//  Ошибки        - Неопределено
//                - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект        - ОбъектXDTO
//  СведенияОЛице - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеИдентификационныеСведенияФизЛица
//  КонструкторЭД - ОбработкаОбъект.ФорматДоговорныйДокумент101
//  Ошибки        - Неопределено
//                - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект           - ОбъектXDTO
//  КонтактныеДанные - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеКонтактныеДанные
//  Ошибки           - Неопределено
//                   - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект              - ОбъектXDTO
//  БанковскиеРеквизиты - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеБанковскиеРеквизиты
//  Ошибки              - Неопределено
//                      - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект        - ОбъектXDTO
//  Подписант     - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеСведенияОПодписанте
//  КонструкторЭД - ОбработкаОбъект.ФорматДоговорныйДокумент101
//  Ошибки        - Неопределено
//                - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект   - ОбъектXDTO
//  Сведения - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеСведенияОбЭлектроннойДоверенности
//  Ошибки   - Неопределено
//           - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект        - ОбъектXDTO
//  Сведения      - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеСведенияОБумажнойДоверенности
//  КонструкторЭД - ОбработкаОбъект.ФорматДоговорныйДокумент101
//  Ошибки        - Неопределено
//                - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект        - ОбъектXDTO
//  Адрес         - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыйАдресКЛАДР
//                - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыйАдресФИАС
//                - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыйАдресЗаПределамиРФ
//  КонструкторЭД - ОбработкаОбъект.ФорматДоговорныйДокумент101
//  Ошибки        - Неопределено
//                - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект        - ОбъектXDTO
//  Адрес         - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыйАдресФИАС
//  КонструкторЭД - ОбработкаОбъект.ФорматДоговорныйДокумент101
//  Ошибки        - Неопределено
//                - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект   - ОбъектXDTO
//  Сведения - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыйРайонГородФИАС
//  Ошибки   - Неопределено
//           - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект   - ОбъектXDTO
//  Сведения - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеСведенияОВидеИНаименованииАдрЭлементаФИАС
//  Ошибки   - Неопределено
//           - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект   - ОбъектXDTO
//  Сведения - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеСведенияОТипеИНаименованииАдресногоЭлементаФИАС
//  Ошибки   - Неопределено
//           - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект   - ОбъектXDTO
//  Сведения - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеСведенияОНомереАдрЭлементаФИАС
//  Ошибки   - Неопределено
//           - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект   - ОбъектXDTO
//  Сведения - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыйАдресЗаПределамиРФ
//  Ошибки   - Неопределено
//           - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект                - ОбъектXDTO
//  УдостоверениеЛичности - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовоеУдостоверениеЛичности
//  Ошибки                - Неопределено
//                        - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект                - ОбъектXDTO
//  УдостоверениеЛичности - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовоеУдостоверениеЛичностиИностранногоЛица
//  Ошибки                - Неопределено
//                        - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
//  Объект                   - ОбъектXDTO:
//   * ТекстИнф - СписокXDTO
//  ДополнительнаяИнформация - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НоваяДополнительнаяИнформация
//  КонструкторЭД            - ОбработкаОбъект.ФорматДоговорныйДокумент101
//  Ошибки                   - Неопределено
//                           - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект - ОбъектXDTO
//  Поле   - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовоеДополнительноеПоле
//  Ошибки - Неопределено
//         - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// Параметры:
//  Объект - ОбъектXDTO
//  ФИО    - см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеФИО
//  Ошибки - Неопределено
//         - Массив Из см. ОбщегоНазначенияБЭДКлиентСервер.НовыеПараметрыОшибки
//
...
// 
// Возвращаемое значение:
//  см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеИдентификационныеСведенияИП
//  см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеИдентификационныеСведенияОрганизации
//  см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеИдентификационныеСведенияИностранногоЛица
//  см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыеИдентификационныеСведенияФизЛица
//
...
// 
// Возвращаемое значение:
//  см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыйАдресКЛАДР
//  см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыйАдресФИАС
//  см. ОбработкаОбъект.ФорматДоговорныйДокумент101.НовыйАдресЗаПределамиРФ
//
...
Функция ЗаписатьКоллекциюВложенийВПДФ(ДвоичныеДанныеФайлаПДФ, КоллекцияВложенийПДФ)
	...
	#Если Не ВнешнееСоединение Тогда
		...
		ПотокДанныхФайлаПДФ_А3 = Неопределено;
		
		// Конвертируем файл в формат PDF/A3
		КодДляВыполнения = "ДокументПДФ = Новый ДокументPDF;
		|ДокументПДФ.Прочитать(ПотокДанныхФайлаПДФ);
		|ПотокДанныхФайлаПДФ_А3 = Новый ПотокВПамяти;
		|ДокументПДФ.Записать(ПотокДанныхФайлаПДФ_А3, , ТипФайлаДокументаPDF.PDF_A_3);";
		...
		Исключение
			...
			ОбщийТекстОшибки = НСтр("ru = 'В процессе преобразования файла в формат PDF/A3 возникла ошибка.
			|Возможно, на файл установлен пароль.
			|Выберите другой файл или обновите платформу на более новую версию.'");
			
			ТекстСообщения = СтрШаблон(НСтр("ru = '%1
			|Текст ошибки: %2'"), ОбщийТекстОшибки, ПодробныйТекстОшибки);
			...
			ВызватьИсключение СтрШаблон(НСтр("ru = '%1
			|(Подробнее см. журнал регистрации).'"), ОбщийТекстОшибки);
			
		КонецПопытки;
		
		ЗаписьПДФ = Новый ЗаписьPDF;
		ЗаписьПДФ.Открыть(ПотокДанныхФайлаПДФ_А3);
		...
		Исключение
			...
			ОбщийТекстОшибки = НСтр("ru = 'В процессе записи вложения файла возникла ошибка.
			|Выберите другой файл или обновите платформу на более новую версию.'");
		...
		ДвоичныеДанные = ПотокДанныхФайлаПДФ_А3.ЗакрытьИПолучитьДвоичныеДанные();
		
		// Проверяем записалось ли вложение. Обходим ошибку платформы некоторых версий.
		ЗаписьВложенийУспешна = КоллекцияВложенийЗаписанаКорректно(ДвоичныеДанные);
		
		Если Не ЗаписьВложенийУспешна Тогда
			
			ИнформацияОбОшибке = ИнформацияОбОшибке();
			ПодробныйТекстОшибки = ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке);
			
			ОбщийТекстОшибки = НСтр("ru = 'В процессе добавления вложения файла возникла ошибка.
			|Выберите другой файл или обновите платформу на более новую версию.'");
...
// Параметры:
//  ДвоичныеДанные - ДвоичныеДанные - Двоичные данные файла PDF/A3 с вложениями
// 
// Возвращаемое значение:
//  Булево - Истина, если запись корректна, Ложь - если не корректна.
//
Функция КоллекцияВложенийЗаписанаКорректно(ДвоичныеДанные)
...
// Возвращаемое значение:
//  Строка - текст справки
//
Функция ТекстСправки() Экспорт
	
	ТекстСправки = НСтр("ru='Договорный документ составляется из двух частей:
	|1. Файла договора в формате PDF.
	|2. Автоматически генерируемого XML-вложения, сформированного по данным документа учета.
	|Данные файла PDF должны совпадать с данными документа учета.
	|Файл вложения в PDF документ можно просмотреть стандартной программой чтения Adobe Acrobat Reader, выполнив команду: ""Вложения: Просмотр вложенных файлов"".'");
