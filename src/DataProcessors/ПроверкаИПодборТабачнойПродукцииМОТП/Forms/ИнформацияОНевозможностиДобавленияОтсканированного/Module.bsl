...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ПараметрыОшибки <> Неопределено Тогда
...
&НаКлиенте
Процедура Подключаемый_ОткрытьФормуПроверкиИПодбора(Команда)
...
Процедура ПоказатьИнформациюОПроблемахСТабачнойПродукцией(ИнформацияВДереве)
	...
	Если ИнформацияВДереве Тогда
		...
		Иначе
			...
			ПредставлениеНоменклатуры = ДанныеТабачнойПродукции.Номенклатура;
	...
	Если ОбратноеСканирование Тогда
		Префикс = НСтр("ru = 'Невозможно удалить табачную продукцию с кодом маркировки'");
	...
	ИначеЕсли ЗначениеЗаполнено(ПредставлениеНоменклатуры)
		...
		Префикс = СтрШаблон(ПрефиксТабачнаяПродукцияИдентифицирована, ПредставлениеНоменклатуры);
	...
	Если ЗначениеЗаполнено(Штрихкод) Тогда
		...
		СоставСтрокиПричины.Добавить(СтрокаШтриховойКод);
		СоставСтрокиПричины.Добавить(" ");
	...
	Элементы.ДекорацияОшибкаДобавленияТабачнойПродукции.Заголовок = Новый ФорматированнаяСтрока(СоставСтрокиПричины);
...
&НаСервере
Функция ПредставлениеШтрихкода(Штрихкод)
