...
Процедура ЗаполнитьТаблицуТоваровНаСервере(ПроверятьЗаполнение = Истина)
	...
	ИнтеграцияСМаркетплейсамиСерверЛокализация.ДополнитьСтруктуруНастроекДляМаркетплейсов(ЭтаФорма, СтруктураНастроек);
...
Процедура ЗагрузитьНастройкиОтбораПоУмолчанию()
	...
	ИнтеграцияСМаркетплейсамиСерверЛокализация.ДополнитьСКДДляМаркетплейсов(ЭтаФорма, СхемаКомпоновкиДанных);
	...
	ИнтеграцияСМаркетплейсамиСерверЛокализация.УстановитьУчетнуюЗапись(ЭтаФорма, КомпоновщикНастроек.Настройки);
