...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьДоговорыСКлиентами" 
		...
		Элементы.ПредупреждениеИспользоватьДоговорыСКлиентамиПередачаНаХранение.Видимость = ЗначениеКонстантыОтветственногоХранения;
		Элементы.ПредупреждениеИспользоватьДоговорыСКлиентамиОказаниеАгентскихУслуг.Видимость = ЗначениеКонстантыИспользованиеАгентскойЗакупки;
