...
Процедура ЗаполнитьСтрокуДереваПоДаннымШтрихкода(Форма, СтрокаДерева, ДанныеШтрихкода, ТаблицаИзмененийПодобраннойПродукции, КэшированныеЗначения)
	...
	ДополнитьИменаСвойствСтрокиПоВидуПродукции(ИменаСвойствСтроки, Форма.ВидМаркируемойПродукции);
...
Процедура ЗаполнитьСтрокуДереваПоДаннымВыбора(СтрокаДерева, ДанныеВыбора, ЗаполнитьИзмененияПодобраннойПродукции = Ложь)
	...
	ДополнитьИменаСвойствСтрокиПоВидуПродукции(ИменаСвойствСтроки, ВидМаркируемойПродукции);
...
Процедура ДобавитьОбъемноСортовойКод(ДанныеШтрихкода, СтрокаОбъемноСортовогоКода = Неопределено, УстанавливатьСтатусПроверки = Истина)
	...
	Если РежимПодбораСуществующихУпаковок
		...
		Если ПараметрыСканирования.ТребуетсяЧастичноеВыбытие
			И ОбщегоНазначенияИСКлиентСерверПовтИсп.ПоддерживаетсяЧастичноеВыбытие(
			ВидМаркируемойПродукции, ПараметрыСканирования.ВидОперацииИСМП) Тогда
			ИменаСвойствСтроки.Добавить("ЧастичноеВыбытие");
		КонецЕсли;
...
&НаКлиентеНаСервереБезКонтекста
Процедура ДополнитьИменаСвойствСтрокиПоВидуПродукции(ИменаСвойствСтроки, ВидПродукции)
