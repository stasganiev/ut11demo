...
Процедура ЗаполнитьРеквизитыПолномочий()
	...
	Если ЗначениеЗаполнено(РезультатПроверки.ПротоколПроверки.ПроверкаМЧД.РодительскиеДанныеПолучены) Тогда
		...
		Если ЗначениеЗаполнено(НомераДоверенностей) Тогда
			...
			МассивДоверенностей = СтрРазделить(НомераДоверенностей, ",");
			НомерДоверенности = МассивДоверенностей[МассивДоверенностей.ВГраница()];
			
			СвойстваРодительскойДоверенности = МашиночитаемыеДоверенности.СвойстваДоверенностиПоНомеру(
				НомерДоверенности);
			РодительскаяДоверенность = СвойстваРодительскойДоверенности.Ссылка;
			ПолномочияРодительскойДоверенностиОграничены = СвойстваРодительскойДоверенности.ПолномочияОграничены;
