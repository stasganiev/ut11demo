...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтоДокументДО3 = ИнтеграцияС1СДокументооборот3.ЭтоДокументДО3(ТипОбъектаВыбора);
	
	Если ЭтоДокументДО3 Тогда
	...
	Элементы.Папка.Видимость = ЭтоДокументДО3;
...
Процедура ВыборСсылочногоРеквизитаНачало(ИмяРеквизита, Тип)
	...
	ЭтоДокументДО3 = ИнтеграцияС1СДокументооборот3КлиентПовтИсп.ЭтоДокументДО3(Тип);
	...
	Если ЭтоДокументДО3 Или Тип = "DMCorrespondent" Или Тип = "DMMeeting" Тогда
		// объектов ДО потенциально много, нужен выбор поиском
		Отбор = Новый Структура;
		Если ЭтоДокументДО3 И ЗначениеЗаполнено(Элементы.НаименованиеДокумента.ТекстРедактирования) Тогда
