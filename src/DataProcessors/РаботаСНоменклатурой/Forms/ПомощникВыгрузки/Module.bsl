...
Функция ПрогрессВыгрузки(Знач ПараметрыПрогресса)
	...
	Если СтроковыеФункцииКлиентСервер.ЭтоУникальныйИдентификатор(ИдентификаторЗадания) Тогда

		УникальныйИдентификатор = Новый УникальныйИдентификатор(ИдентификаторЗадания);

		ОтборЗаданий = Новый Структура("УникальныйИдентификатор, Состояние", УникальныйИдентификатор,
	...
	Иначе 
		...
		Если ЗначениеЗаполнено(НастройкаВыгрузки.ИдентификаторЗадания) Тогда
			ПрогрессВыгрузки.ВыгруженоПредставление = "";
			ПрогрессВыгрузки.ИдентификаторЗадания   = "";
			ПрогрессВыгрузки.ДатаПредставление      = "";
