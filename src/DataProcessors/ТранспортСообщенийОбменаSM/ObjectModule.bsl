...
Функция ОтправитьДанные(СообщениеДляСопоставленияДанных = Ложь) Экспорт
	...
	Попытка
		...
		Иначе
			Результат = МенеджерСерсива_ОтправитьСообщение(СообщениеДляСопоставленияДанных);
		КонецЕсли;
...
Функция ПолучитьДанные() Экспорт
	...
	Попытка
		Результат = МенеджерСерсива_ПолучитьСообщение();	
	Исключение
...
Функция ПараметрыКорреспондента(НастройкиПодключения) Экспорт
	...
	Иначе
		Результат = МенеджерСерсива_ПараметрыКорреспондента();
	КонецЕсли;
...
Функция МенеджерСерсива_ПараметрыКорреспондента()
...
Функция МенеджерСерсива_ОтправитьСообщение(СообщениеДляСопоставленияДанных)
...
Функция МенеджерСерсива_ПолучитьСообщение()
