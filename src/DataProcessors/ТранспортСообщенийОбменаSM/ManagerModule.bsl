...
Функция НастройкиПодключенияИзXML(ТекстXML) Экспорт
	...
	Если Фабрика.Свойства().Получить("ОсновныеПараметрыОбмена") <> Неопределено Тогда
		...
		Настройки.Вставить("WSКонечнаяТочкаКорреспондента", ОсновныеПараметры["WSКонечнаяТочкаКорреспондента"]); // @Non-NLS-2
		Настройки.Вставить("WSОбластьДанныхКорреспондента", ОсновныеПараметры["WSОбластьДанныхКорреспондента"]); // @Non-NLS-2
		...
		КонечнаяТочкаКорреспондента = ПланыОбмена.ОбменСообщениями.НайтиПоКоду(ОсновныеПараметры["WSКонечнаяТочкаКорреспондента"]); // @Non-NLS-2
		НастройкиТранспорта.Вставить("КонечнаяТочкаКорреспондента", КонечнаяТочкаКорреспондента);	
		НастройкиТранспорта.Вставить("ОбластьДанныхКорреспондента", ОсновныеПараметры["WSОбластьДанныхКорреспондента"]); // @Non-NLS-2
