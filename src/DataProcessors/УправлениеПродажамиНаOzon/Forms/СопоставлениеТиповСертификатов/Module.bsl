...
Процедура ТаблицаТиповСертификатовВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ТаблицаТиповСертификатовИдентификаторТипаСертификатаМаркетплейса" Тогда
...
Процедура УстановитьУсловноеОформление()
	...
	ОформляемоеПоле.Поле = Новый ПолеКомпоновкиДанных(Элементы.ТаблицаТиповСертификатовИдентификаторТипаСертификатаМаркетплейса.Имя);

	ЭлементУсловия  = ЭлементУсловногоОформления.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ЭлементУсловия.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("ТаблицаТиповСертификатов.ИдентификаторТипаСертификатаМаркетплейса");
	ЭлементУсловия.ВидСравнения = ВидСравненияКомпоновкиДанных.Заполнено;

	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", Новый ПолеКомпоновкиДанных("ТаблицаТиповСертификатов.НаименованиеТипаСертификатаМаркетплейса"));
