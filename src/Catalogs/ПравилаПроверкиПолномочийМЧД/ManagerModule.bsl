...
Процедура ЗаписатьПравило(Доверенность, Форма) Экспорт
	...
	РеквизитыМЧД = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Доверенность, "ПолномочияОграничены, ВариантЗаполненияПолномочий");

	Если Не РеквизитыМЧД.ПолномочияОграничены ИЛИ РеквизитыМЧД.ВариантЗаполненияПолномочий =
		Перечисления.ВариантыЗаполненияПолномочийМЧД.КлассификаторФНС Тогда
		Возврат;
	КонецЕсли;
