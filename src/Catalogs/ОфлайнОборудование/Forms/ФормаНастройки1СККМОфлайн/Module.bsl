...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РеквизитыПодключаемоеОборудование = ОбщегоНазначенияБПО.ЗначенияРеквизитовОбъекта(ПодключаемоеОборудование, 
		"ВидТранспортаОфлайнОбмена, ТипОфлайнОборудования, ИдентификаторWebСервисОборудования");
	
	Если ЗначениеЗаполнено(РеквизитыПодключаемоеОборудование.ВидТранспортаОфлайнОбмена) Тогда
		ВидОбмена = РеквизитыПодключаемоеОборудование.ВидТранспортаОфлайнОбмена;
	Иначе
		ВидОбмена = Перечисления.ВидыТранспортаОфлайнОбмена.FILE;
	КонецЕсли;
	
	Если РеквизитыПодключаемоеОборудование.ТипОфлайнОборудования = Перечисления.ТипыОфлайнОборудования.ПрайсЧекер Тогда
		ВидОбмена = Перечисления.ВидыТранспортаОфлайнОбмена.WS;
		Элементы.ВидОбмена.ТолькоПросмотр = Истина;
	КонецЕсли;
	
	ИдентификаторWebСервисОборудования = РеквизитыПодключаемоеОборудование.ИдентификаторWebСервисОборудования;
	
	ВерсииФорматовОбмена = МенеджерОфлайнОборудованияКлиентСервер.ДоступныеВерсииФорматовОбмена();
	ПоследняяВерсия = 0;
...
Процедура КаталогВыгрузкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	МенеджерОфлайнОборудованияКлиент.НачатьВыборФайла(Оповещение, КаталогВыгрузки, "ВыборКаталога");
...
Процедура КаталогЗагрузкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	МенеджерОфлайнОборудованияКлиент.НачатьВыборФайла(Оповещение, КаталогЗагрузки, "ВыборКаталога");
	СтандартнаяОбработка = Ложь;
...
Процедура НастроитьЭлементыПоВерсииФормата()
	...
	ПодключаемоеОборудованиеТипОфлайнОборудования = 
		ОбщегоНазначенияБПО.ЗначениеРеквизитаОбъекта(ПодключаемоеОборудование, "ТипОфлайнОборудования");
	Если ПодключаемоеОборудованиеТипОфлайнОборудования = Перечисления.ТипыОфлайнОборудования.ККМ Тогда
