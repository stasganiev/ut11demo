...
Функция СоздатьДрайверыОборудованияНаСервере(РезультатЗагрузки, МассивТиповОборудования)
	...
	Для Каждого ТипОборудования Из МассивТиповОборудования Цикл 
		...
		ПараметрыСоздания.ИдентификаторОбъекта = РезультатЗагрузки.Идентификатор;
		ПараметрыСоздания.Наименование         = РезультатЗагрузки.Наименование;
		ПараметрыСоздания.ВерсияДрайвера       = РезультатЗагрузки.Версия;
		ПараметрыСоздания.СпособПодключения    = Перечисления.СпособПодключенияДрайвера.ИзИнформационнойБазы;
		НовыйЭлемент = МенеджерОборудования.НовыйДрайверОборудования(ПараметрыСоздания);
