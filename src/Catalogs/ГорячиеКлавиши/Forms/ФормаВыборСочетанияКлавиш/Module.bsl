...
Процедура ПредставлениеСочетанияКлавиш(НоваяСтрока, Данные, Имя, Сочетание)
	...
	Если ЗначениеЗаполнено(Данные) Тогда
		НайденныеСтроки = Данные.КомандыФормы.НайтиСтроки(СтруктураСочетаний); // Массив из СтрокаТаблицыЗначений - см. Справочники.ГорячиеКлавиши.ФормаЭлемента.КомандыФормы
		Если НайденныеСтроки.Количество() > 0 Тогда
			НоваяСтрока[Имя+"_"] = НайденныеСтроки[0].Заголовок;
		КонецЕсли;
		
		НайденныеСтроки = Данные.БыстрыеТовары.НайтиСтроки(СтруктураСочетаний); // Массив из СтрокаТаблицыЗначений - см. Справочники.ГорячиеКлавиши.ФормаЭлемента.БыстрыеТовары
		Если НайденныеСтроки.Количество() > 0 Тогда
			НоваяСтрока[Имя+"_"] = НайденныеСтроки[0].Заголовок;
		КонецЕсли;
	КонецЕсли;
