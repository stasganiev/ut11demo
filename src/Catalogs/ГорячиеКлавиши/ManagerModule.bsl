...
Процедура ЗаполнитьТабличныйДокументПоДаннымОбъекта(ТабличныйДокумент, ДанныеОбъекта)
	...
	БыстрыеТовары = ДанныеОбъектаБыстрыеТовары.Получить(); // ТаблицаЗначений - см. Справочники.ГорячиеКлавиши.ФормаЭлемента.БыстрыеТовары
	...
	КомандыФормы = ДанныеОбъектаКомандыФормы.Получить(); // ТаблицаЗначений - см. Справочники.ГорячиеКлавиши.ФормаЭлемента.КомандыФормы
