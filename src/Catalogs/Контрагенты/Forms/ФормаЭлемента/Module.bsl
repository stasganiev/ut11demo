...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ Локализация
	Элементы.НаименованиеВТранскрипции.Видимость = Объект.СтранаРегистрации <> Справочники.СтраныМира.Россия;
	//-- Локализация
...
Процедура СтранаРегистрацииПриИзменении(Элемент)  
	//++ Локализация
	Элементы.НаименованиеВТранскрипции.Видимость = Объект.СтранаРегистрации <> ПредопределенноеЗначение("Справочник.СтраныМира.Россия");
	//-- Локализация
КонецПроцедуры
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьМногострановойУчет") Тогда
		Если Объект.ЮрФизЛицо <> Перечисления.ЮрФизЛицо.ЮрЛицоНеРезидент Тогда
			Элементы.ВидКонтрагента.СписокВыбора.Удалить(3);
		КонецЕсли;
	КонецЕсли;
