...
Процедура ПослеЗагрузкиСоставляющихПАТ(Результат, ДополнительныеПараметры) Экспорт
	...
	ПА = ЗагрузитьПАТИзСоставаТукосмеси(ДополнительныеПараметры.ИдентификаторСтроки);
...
&НаСервере
Функция ЗагрузитьПАТИзСоставаТукосмеси(ИдентификаторСтроки)
	
	ДанныеСтроки = СоставТукосмеси.Получить(ИдентификаторСтроки);
