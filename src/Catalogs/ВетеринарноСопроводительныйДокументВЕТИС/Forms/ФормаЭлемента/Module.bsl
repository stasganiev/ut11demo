...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Электронный Или Инвентаризационный Тогда
...
Процедура Аннулировать(Команда)
	...
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("ВСД", Объект.Ссылка);
...
Процедура ОткрытьЧерезБраузер(Команда)
	...
	Иначе 
		ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Идентификатор документа не заполнен!'"),,,"Объект.Идентификатор");
	КонецЕсли;
...
Процедура ЗаполнитьСлужебныеРеквизиты()
	...
	Инвентаризационный = Объект.Тип = Перечисления.ТипыВетеринарныхДокументовВЕТИС.Инвентаризационный;
	...
	ИначеЕсли Инвентаризационный Тогда
		Представление = НСтр("ru='Данные о ВСД, серия:'");
		Заголовок = НСтр("ru='Информация о ВСД'");
	Иначе
...
Процедура НастроитьЭлементыФормы()
	...
	Если Объект.Тип = Перечисления.ТипыВетеринарныхДокументовВЕТИС.Инвентаризационный Тогда
		
		Элементы.НадписьСвязанныеДокументы.Видимость = Ложь;
		Элементы.ФормаДокумента.Видимость = Ложь;
		Элементы.ГруппаГрузоотправитель.Видимость = Ложь;
		Элементы.ГруппаМаршрут.Видимость = Ложь;
		Элементы.ГруппаТТН.Видимость = Ложь;
		Элементы.СтраницаПродукция.Видимость = Ложь;
		Элементы.СтраницаДополнительно.Видимость = Ложь;
		Элементы.СерияБланка.АвтоОтметкаНезаполненного = Ложь;
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	Если СтруктураРеквизитов.Свойство("Продукция")
		...
		Элементы.ТоварыПанельГруппаСведенияОКарантинировании.Видимость = Форма.ТипЖивыеЖивотные И ЗначениеЗаполнено(Объект.Идентификатор);
		
		Элементы.СкоропортящаясяПродукция.Видимость   = Не Форма.ТипЖивыеЖивотные;
		Элементы.НизкокачественнаяПродукция.Видимость = Не Форма.ТипЖивыеЖивотные;
		Элементы.ГруппаЭкспертизаРезультат.Видимость  = Не Форма.ТипЖивыеЖивотные;
