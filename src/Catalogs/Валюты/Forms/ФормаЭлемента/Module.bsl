...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользоватьЗагрузкуКурсовВалютЕЦБ = ПолучитьФункциональнуюОпцию("ИспользоватьЗагрузкуКурсовВалютЕЦБ");
	Если Метаданные.Обработки.Найти("ЗагрузкаКурсовВалют") = Неопределено Тогда
		Элементы.КурсВалютыЗагружаетсяИзИнтернета.Видимость = ИспользоватьЗагрузкуКурсовВалютЕЦБ;
	КонецЕсли;
	...
	Элементы.КурсВалютыЗагружаетсяИзИнтернета.Доступность = ДоступнаЗагрузкаИзИнтернета Или ИспользоватьЗагрузкуКурсовВалютЕЦБ;
