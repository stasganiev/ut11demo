...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Попытка
		...
		ДанныеКэша = СервисНастроекЭДО.ОбработкаРезультатаКлассификаторПолномочийФНС_МЧД003(ДвоичныеДанныеКлассификатора);
		Если ДанныеКэша <> Неопределено Тогда
			МашиночитаемыеДоверенности.ОбновитьКлассификаторПолномочийФНС_МЧД003(ДанныеКэша);
		КонецЕсли;
