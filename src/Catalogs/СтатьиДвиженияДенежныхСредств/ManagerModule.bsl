...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Инвестиционная деятельность'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Операционная деятельность'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Финансовая деятельность'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Возврат денежных средств от другой организации'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Возврат оплаты поставщиком (товары, работы, услуги)'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Возврат оплаты клиенту (продажа товаров, работ, услуг)'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Выдача денежных средств в другую кассу'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Выдача денежных средств в кассу ККМ'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Выплата заработной платы по ведомостям'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Прибыль от курсовых разниц'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Убыток от курсовых разниц'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Оплата денежных средств в другую организацию'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Оплата поставщику (товары, работы, услуги)'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Перечисление денежных средств на другой счет'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Поступление денежных средств из банка'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Поступление денежных средств из банка (в иностранной валюте)'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Поступление денежных средств из кассы ККМ'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Поступление денежных средств от другой организации'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Поступление оплаты от клиента (продажа товаров, работ, услуг)'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Сдача денежных средств в банк'", КодыЯзыков); // @НСтр
	#КонецОбласти
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "
		|ru = 'Сдача денежных средств в банк (в иностранной валюте)'", КодыЯзыков); // @НСтр
	#КонецОбласти
