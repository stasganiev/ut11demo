...
Процедура НастроитьЭлементыФормыНаСервере()
	...
	Если ВидПродукции = Перечисления.ВидыПродукцииИС.Духи Тогда
		...
		Тексты.ПолеКоличествоЧастичноеВыбытиеПодсказка = ИнтеграцияИСКлиентСервер.ПредставлениеЕдиницыЧастичногоВыбытия(ВидПродукции);
		...
		Тексты.ПолеКоличествоУпаковкаПодсказка         = ИнтеграцияИСКлиентСервер.ПредставлениеЕдиницыЧастичногоВыбытия(ВидПродукции);
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.Табак Тогда
		...
		Тексты.ПолеКоличествоКоробЗаголовок            = НСтр("ru = 'Пачек'");
		Тексты.ПолеКоличествоКоробПодсказка            = ИнтеграцияИСКлиентСервер.ПредставлениеЕдиницыЧастичногоВыбытия(ВидПродукции);;
