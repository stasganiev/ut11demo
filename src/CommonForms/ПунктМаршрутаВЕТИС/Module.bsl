...
&НаКлиенте
Процедура ПредставлениеАдресаОткрытие(Элемент, СтандартнаяОбработка)
...
Процедура НастроитьВидимостьДоступностьЭлементов()
	...
	ТолькоПросмотрАдреса = Элементы.ГруппаПунктМаршрута.ТолькоПросмотр;
	Элементы.ПредставлениеАдреса.КнопкаОткрытия = ТолькоПросмотрАдреса;
	Элементы.ПредставлениеАдреса.КнопкаВыбора = НЕ ТолькоПросмотрАдреса;
