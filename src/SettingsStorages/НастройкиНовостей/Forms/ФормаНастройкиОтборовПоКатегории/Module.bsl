...
Процедура ЗаполнитьФормуДаннымиСервер(Знач СписокЗначенийОтборов, Знач СписокЗначенийГлобальныхОтборов)
	...
	ДоступныеКатегорииНовостейЛентыНовостей = ОбработкаНовостейПовтИсп.ДоступныеКатегорииНовостейЛентыНовостей(ЭтотОбъект.ЛентаНовостей);

	НайденнаяСтрока = ДоступныеКатегорииНовостейЛентыНовостей.Найти(ЭтотОбъект.КатегорияНовостей, "КатегорияНовостей");
	Если НайденнаяСтрока = Неопределено Тогда
	...
	ЭтотОбъект.ЛентаНовостей_ДоступныеКатегории.ЗагрузитьЗначения(ДоступныеКатегорииНовостейЛентыНовостей);
