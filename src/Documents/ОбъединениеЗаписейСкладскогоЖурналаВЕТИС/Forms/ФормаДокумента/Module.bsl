...
Процедура ЗаписатьДокумент(Команда)
	...
	ОценкаПроизводительностиКлиент.ЗамерВремени("Документ.ОбъединениеЗаписейСкладскогоЖурналаВЕТИС.Форма.ФормаДокумента.Записать");
...
Процедура НастроитьЗависимыеЭлементыФормыНаСервере(ИзмененныеРеквизитыИлиЭлемент = "")
	...
	Если СтруктураРеквизитов.Свойство("СпособОбъединения")
		...
		Если Объект.СпособОбъединения = Перечисления.СпособыОбъединенияЗаписейСкладскогоЖурналаВЕТИС.Объединить Тогда
			...
			|	ВЫБОР КОГДА ЗаписиСкладскогоЖурналаВЕТИС.Продукция.ПолноеНаименование = """" ТОГДА
			|		ЗаписиСкладскогоЖурналаВЕТИС.Продукция.Наименование
			|	ИНАЧЕ
			|		ЗаписиСкладскогоЖурналаВЕТИС.Продукция.ПолноеНаименование
			|	КОНЕЦ КАК ПродукцияНаименование
			|ИЗ
			|	Справочник.ЗаписиСкладскогоЖурналаВЕТИС КАК ЗаписиСкладскогоЖурналаВЕТИС
			|ГДЕ
...
Процедура УправлениеДоступностьюЭлементовФормы(Форма)
	...
	ИнтеграцияИСКлиентСервер.УстановитьДоступностьЭлементовФормы(Форма, ЗависимыеОтСтатуса, Не ОграничениеПоСтатусу);
