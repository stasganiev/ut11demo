...
Процедура ИнициализироватьПоляКонтактнойИнформации()
	...
	КомментарийМестоХранения = ИнтеграцияИС.КомментарийКонтактнойИнформации(Объект.МестоХранения);
	
	Для Каждого СтрокаТовары Из Объект.Товары Цикл
		СтрокаТовары.КомментарийМестоВыращивания = ИнтеграцияИС.КомментарийКонтактнойИнформации(СтрокаТовары.МестоВыращивания);
	КонецЦикла;
