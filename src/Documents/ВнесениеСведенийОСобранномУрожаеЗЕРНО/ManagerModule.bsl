...
Функция СообщенияСозданиеМестФормированияПартий(ДокументСсылка, ДополнительныеПараметры)
	...
	Для Каждого СтрокаТовары Из Товары Цикл
		...
		Наименование = СтрШаблон(НСтр("ru = '%1, %2 га, %3, 1С-%4'"),
			...
			Шапка.Номер);
		ИнтеграцияЗЕРНОСлужебный.ЗаполнитьСвойствоXDTO(СтрокаТоварыXDTO, "name", Наименование, СообщениеXML);
		
		ИнтеграцияЗЕРНОСлужебный.ЗаполнитьСвойствоXDTO(СтрокаТоварыXDTO, "Crop", СтрокаТовары.ОКПД2, СообщениеXML);
...
Функция СообщенияВнесениеСведенийОСобранномУрожае(ДокументСсылка, ДополнительныеПараметры)
	...
	МестоХраненияXDTO = ИнтеграцияЗЕРНОСлужебный.АдресРФXDTO(Шапка.МестоХранения, Шапка.МестоХраненияСтрокой, СообщениеXML);
	...
	Для Каждого СтрокаТовары Из Товары Цикл
		...
		МестоВыращиванияXDTO = ИнтеграцияЗЕРНОСлужебный.АдресРФXDTO(СтрокаТовары.МестоВыращивания, СтрокаТовары.МестоВыращиванияСтрокой, СообщениеXML);
		
		ИнтеграцияЗЕРНОСлужебный.ЗаполнитьСвойствоXDTO(СтрокаТоварыXDTO,
			"primaryStoragePlaceID", Число(СтрокаТовары.МестоФормированияПартииИдентификатор), СообщениеXML);
		ИнтеграцияЗЕРНОСлужебный.ЗаполнитьСвойствоXDTO(СтрокаТоварыXDTO,
			"amount", СтрокаТовары.КоличествоЗЕРНО, СообщениеXML);
		ИнтеграцияЗЕРНОСлужебный.ЗаполнитьСвойствоXDTO(СтрокаТоварыXDTO,
			"area", СтрокаТовары.ПлощадьСбораУрожая, СообщениеXML);
		ИнтеграцияЗЕРНОСлужебный.ЗаполнитьСвойствоXDTO(СтрокаТоварыXDTO,
			"EfisNumber", СтрокаТовары.НомерПоляЕФИС, СообщениеXML);
		ИнтеграцияЗЕРНОСлужебный.ЗаполнитьСвойствоXDTO(СтрокаТоварыXDTO,
			"CultivationPlace", МестоВыращиванияXDTO, СообщениеXML);
		ИнтеграцияЗЕРНОСлужебный.ЗаполнитьСвойствоXDTO(СтрокаТоварыXDTO,
			"StoragePlace", МестоХраненияXDTO, СообщениеXML);
		ИнтеграцияЗЕРНОСлужебный.ЗаполнитьСвойствоXDTO(СтрокаТоварыXDTO,
			"Crop", СтрокаТовары.ОКПД2, СообщениеXML);
		ИнтеграцияЗЕРНОСлужебный.ЗаполнитьСвойствоXDTO(СтрокаТоварыXDTO,
			"PropertyRight", СтрокаТовары.ВидПраваСобственностиИдентификатор, СообщениеXML);
