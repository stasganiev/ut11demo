...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ЭлектронныйДокумент", ЭлектронныйДокумент)
		...
		Если ДокументРаспознан Тогда
			СписокТиповДокументов = ИнтеграцияЭДО.СписокОперацийИсходящихВидовДокумента(ВидДокумента);
		Иначе
		...
		ИначеЕсли СписокТиповДокументов.Количество() = 1 Тогда
			...
			Элементы.ФормаПодобратьДокумент.Видимость = Истина;
...
Функция СоздатьДокументУчетаНаСервере(СпособОбработки, КонтекстОперации)
	...
	ИнтеграцияЭДО.ПерезаполнитьОбъектУчетаПоЭлектронномуДокументу(
		СсылкаНаНовыйДокумент, ЭлектронныйДокумент, СпособОбработки, КонтекстОперации);
