...
Процедура СформироватьДокументыУведомлений(РеквизитыПервичногоДокумента, ДополнительныеПараметры)
	...
	Для Каждого СтрокаДанных Из ТаблицаДанные Цикл
		...
		Если НЕ ТекущийДокумент.КорректировочноеУведомление Тогда
			...
			СтрокаТовары = ТекущийДокумент.Товары.Добавить();
			...
			ТекущийДокумент.Количество = ТекущийДокумент.Количество + СтрокаТовары.Количество;
			ТекущийДокумент.КоличествоПрослеживаемости = ТекущийДокумент.КоличествоПрослеживаемости + СтрокаТовары.КоличествоПоРНПТ;
