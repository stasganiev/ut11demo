		...
		Если СтрокаТЧ.ОбъектРасчетовОтправитель = Справочники.ОбъектыРасчетов.ПустаяСсылка()
			...
			Если ЗначениеЗаполнено(ИсточникОбъектаРасчетов) Тогда
				...
				Если ТипЗнч(ИсточникОбъектаРасчетов) = Тип("ДокументСсылка.ОтчетПоКомиссииМеждуОрганизациями") 
					...
					Или Объект.УдалитьТипОперации = Перечисления.УдалитьТипыОперацийВводаОстатков.ОстаткиРасчетовМеждуОрганизациямиПоРеализациям) 
				...
				ИначеЕсли ТипЗнч(ИсточникОбъектаРасчетов) = Тип("ПеречислениеСсылка.ТипыДоговоровМеждуОрганизациями") Тогда
					Если Объект.УдалитьТипОперации = Перечисления.УдалитьТипыОперацийВводаОстатков.ОстаткиРасчетовМеждуОрганизациямиПоАвансам
						Или Объект.УдалитьТипОперации = Перечисления.УдалитьТипыОперацийВводаОстатков.ОстаткиРасчетовМеждуОрганизациямиПоРеализациям 
						Или Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковРасчетовМеждуОрганизациямиПоАвансам
						...
						Если НеобходимоСоздатьЭлемент Тогда
							...
							ДоговорМеждуОрганизациями.Наименование          = НСтр("ru = 'Договор создан автоматически при вводе остатков'");
