...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбменСГИСЭПД.СоздатьЭлементыВводаЗначенийСписка(ЭтотОбъект, "ТитулПеревозчикаВодителиНомераТелефонов", "Телефон");
...
&НаКлиенте
Процедура ТитулПеревозчикаВодителиНомераТелефоновПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулПеревозчикаВодителиНомераТелефоновПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
