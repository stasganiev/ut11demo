...
Процедура ЗаменяющиеТоварыОткрытьПодбор(Команда)
	...
	ПараметрыФормы.Вставить("ПодборВариантовОбеспечения", Не Объект.ЭтоЗаказКакСчет);
...
Процедура РассчитатьСостояниеЗаказа(Ссылка, Договор, СостояниеЗаказа, Гиперссылка)
	...
	Документы.ЗаявкаНаВозвратТоваровОтКлиента.РассчитатьСостояние(Ссылка, Договор, СостояниеЗаказа);
