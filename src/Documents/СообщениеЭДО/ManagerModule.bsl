...
Функция ПроштампованныйФайл(СообщениеЭДО, ПроверятьДоступностьВыводаПДФ_А3 = Ложь, ЭтоМассовоеШтампирование = Ложь) Экспорт
	...
	// Ограничиваем массовое штампирование и обрабатываем PDF платформенным способом для снижения нагрузки на сервис
	//  в рамках пилотного проекта.
	Если Не ЭтоPDF И Не ЭтоМассовоеШтампирование И НастройкиЭДО.ИспользуетсяСервис1СШтамп() Тогда
		...
		ПараметрыШтампа.ПравилаРазмещения = Интеграция1СШтампКлиентСервер.ПравилоРасположенияНаПоследнейСтранице();
