...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступноИзменение = ПравоДоступа("Изменение", Метаданные.Документы.ПервичныйДокумент);
	Элементы.ФормаСоздатьПервичныйДокумент.Видимость = ДоступноИзменение;
...
&НаКлиенте
Процедура СоздатьПервичныйДокумент(Команда)
	...
	ОткрытьФорму("Документ.ПервичныйДокумент.ФормаОбъекта", ПараметрыФормы, ЭтаФорма);
