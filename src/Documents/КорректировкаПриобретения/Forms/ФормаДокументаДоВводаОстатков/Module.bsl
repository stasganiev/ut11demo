...
&НаКлиенте
Процедура ТаблицаКорректировкиКодТНВЭДПриИзменении(Элемент)
...
Процедура КонтрольНеСогласованныхИзмененийОбработатьСобытиеПриИзменении(Элемент)
	...
	ИначеЕсли Элемент.Имя = Элементы.ТаблицаКорректировкиКодТНВЭД.Имя Тогда
		ТаблицаКорректировкиКодТНВЭДПриИзменении(Элемент);
...
Процедура ПолучитьСтрокиИзБуфераОбмена()
	...
	Для каждого СтрокаТовара Из ТаблицаТоваров Цикл
		...
		Если Не ЕстьКоличествоПосле Тогда
			ТекущаяСтрока.КоличествоУпаковокПосле = СтрокаТовара.КоличествоУпаковок;
			ТекущаяСтрока.КоличествоПосле = СтрокаТовара.Количество;
		КонецЕсли;
		ОбновитьНомерСтрокиТаблицыКорректировки(ТекущаяСтрока);
