...
Процедура УстановитьВариантыОтражения(Команда)
	...
	Для Каждого СтрокаРасхождений Из Объект.Расхождения Цикл
		...
		Если (СтрокаРасхождений.ТипНоменклатуры = ПредопределенноеЗначение("Перечисление.ТипыНоменклатуры.Услуга")
			...
			ИначеЕсли СтрокаРасхождений.Сумма > 0 Тогда
	...
	Если Не (
	 НастройкиВариантовОтражения.ЕстьУвеличениеКоличестваПоОрдерномуСкладу
	 Или НастройкиВариантовОтражения.ЕстьУвеличениеКоличестваБезИнвентаризации
	 Или НастройкиВариантовОтражения.ЕстьУменьшениеКоличестваПоОрдерномуСкладу
	 Или НастройкиВариантовОтражения.ЕстьУменьшениеКоличестваБезИнвентаризации
	 Или НастройкиВариантовОтражения.ЕстьУменьшениеСуммы
	 Или НастройкиВариантовОтражения.ЕстьУвеличениеСуммы
	 ) Тогда
	...
	ДополнительныеПараметры = Новый Структура;
	ДополнительныеПараметры.Вставить("ИмяТЧ", "Расхождения");
	...
	ДополнительныеПараметры.Вставить("ВариантОтраженияУменьшениеСуммы", Неопределено);
	ДополнительныеПараметры.Вставить("ВариантОтраженияУвеличениеСуммы", Неопределено);
	...
	Если НастройкиВариантовОтражения.ЕстьУменьшениеСуммы Тогда
		...
		ДополнительныеПараметры.СписокВариантовДляВыбора.Добавить(Новый Структура("ИмяСвойстваДляРезультатаВыбора, СписокВариантовОтражения", "ВариантОтраженияУменьшениеСуммы", СписокВариантовОтражения));
	...
	Если НастройкиВариантовОтражения.ЕстьУвеличениеСуммы Тогда
		...
		ДополнительныеПараметры.СписокВариантовДляВыбора.Добавить(Новый Структура("ИмяСвойстваДляРезультатаВыбора, СписокВариантовОтражения", "ВариантОтраженияУвеличениеСуммы", СписокВариантовОтражения));
...
Процедура УстановитьУсловноеОформление()
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеНомераГТД(ЭтаФорма,,, "КорректировкаПриобретенияУслугПрочихАктивов");
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеНомераГТД(ЭтаФорма,
															"РасхожденияНомерГТД",
															"Объект.Расхождения.ВедетсяУчетПоГТД",
															"КорректировкаПриобретенияУслугПрочихАктивов");
	НоменклатураСервер.УстановитьУсловноеОформлениеНомераГТД(ЭтаФорма,
															"РасхожденияНомерГТДСтранаПроисхождения",
															"Объект.Расхождения.ВедетсяУчетПоГТД",
															"КорректировкаПриобретенияУслугПрочихАктивов");
	...
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеКоличестваПоРНПТ(ЭтаФорма, ПараметрыУсловногоОформления);
...
Функция УправлениеВариантамиОтражения()
	...
	Ответ.Вставить("ЕстьУвеличениеКоличестваПоОрдерномуСкладу", Ложь);
	Ответ.Вставить("ЕстьУвеличениеКоличестваБезИнвентаризации", Ложь);
	Ответ.Вставить("ЕстьУменьшениеКоличестваПоОрдерномуСкладу", Ложь);
	Ответ.Вставить("ЕстьУменьшениеКоличестваБезИнвентаризации", Ложь);
	Ответ.Вставить("ЕстьУвеличениеСуммы", Ложь);
	Ответ.Вставить("ЕстьУменьшениеСуммы", Ложь);
	
	// Дополнительный набор условий.
	Ответ.Вставить("ЕстьУвеличениеСуммыТовараТары", Ложь);
	Ответ.Вставить("ЕстьУменьшениеСуммыТовараТары", Ложь);
	
	// Значения, которые устанавливает пользователь.
	Ответ.Вставить("ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу", Неопределено);
	Ответ.Вставить("ВариантОтраженияУвеличениеКоличестваБезИнвентаризации", Неопределено);
	Ответ.Вставить("ВариантОтраженияУменьшениеКоличестваПоОрдерномуСкладу", Неопределено);
	Ответ.Вставить("ВариантОтраженияУменьшениеКоличестваБезИнвентаризации", Неопределено);
	Ответ.Вставить("ВариантОтраженияУменьшениеСуммы", Неопределено);
	Ответ.Вставить("ВариантОтраженияУвеличениеСуммы", Неопределено);
...
Процедура УстановитьВариантыОтраженияЗавершение(НастройкиВариантовОтражения)
	...
	Если ЗначениеЗаполнено(НастройкиВариантовОтражения.ВариантОтраженияУвеличениеКоличестваПоОрдерномуСкладу)
		Или ЗначениеЗаполнено(НастройкиВариантовОтражения.ВариантОтраженияУвеличениеКоличестваБезИнвентаризации)
		Или ЗначениеЗаполнено(НастройкиВариантовОтражения.ВариантОтраженияУменьшениеКоличестваПоОрдерномуСкладу)
		Или ЗначениеЗаполнено(НастройкиВариантовОтражения.ВариантОтраженияУменьшениеКоличестваБезИнвентаризации)
		Или ЗначениеЗаполнено(НастройкиВариантовОтражения.ВариантОтраженияУменьшениеСуммы)
		Или ЗначениеЗаполнено(НастройкиВариантовОтражения.ВариантОтраженияУвеличениеСуммы) Тогда
		...
		Для Каждого СтрокаРасхождений Из Объект.Расхождения Цикл
			...
			Если (СтрокаРасхождений.ТипНоменклатуры = ПредопределенноеЗначение("Перечисление.ТипыНоменклатуры.Услуга")
				...
				Если СтрокаРасхождений.Сумма < 0
					И ЗначениеЗаполнено(НастройкиВариантовОтражения.ВариантОтраженияУменьшениеСуммы) Тогда
					СтрокаРасхождений.ВариантОтражения = НастройкиВариантовОтражения.ВариантОтраженияУменьшениеСуммы;
					
				ИначеЕсли СтрокаРасхождений.Сумма > 0
					И ЗначениеЗаполнено(НастройкиВариантовОтражения.ВариантОтраженияУвеличениеСуммы) Тогда
					СтрокаРасхождений.ВариантОтражения = НастройкиВариантовОтражения.ВариантОтраженияУвеличениеСуммы;
...
Процедура КонтрольНеСогласованныхИзмененийОбработатьСобытиеПриИзменении(Элемент)
	...
	ИначеЕсли Элемент.Имя = Элементы.ТоварыКодТНВЭД.Имя Тогда
		ТоварыКодТНВЭДПриИзменении(Элемент);
	Иначе
