...
//   * НовыйСтатус - ПеречислениеСсылка.СтатусыОбработкиТТНВходящейЕГАИС - Новый статус.
...
// 
// Возвращаемое значение:
//  Структура - (см. ИнтеграцияИСПереопределяемый.ЗаполнитьПараметрыУказанияСерий) параметры указания серий
//
