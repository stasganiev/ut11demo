...
&НаКлиенте
Процедура ТитулУказаниеПереадресМаркировкаПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулУказаниеПереадресМаркировкаПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
