...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИспользоватьШаблон Тогда
		...
		// устаревшие операции открываем как произвольный взаимозачет
		ТипыРасчетов.Вставить(ВидыОпераций.УдалитьКлиента,                               5);
		ТипыРасчетов.Вставить(ВидыОпераций.УдалитьПоставщика,                            5);
		ТипыРасчетов.Вставить(ВидыОпераций.УдалитьКлиентаМеждуОрганизациями,             5);
		ТипыРасчетов.Вставить(ВидыОпераций.УдалитьПоставщикаМеждуОрганизациями,          5);
		ТипыРасчетов.Вставить(ВидыОпераций.УдалитьМеждуКлиентами,                        5);
		ТипыРасчетов.Вставить(ВидыОпераций.УдалитьМеждуПоставщиками,                     5);
