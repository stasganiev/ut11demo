...
Процедура ОформленоОрганизацииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ВходящиеПараметры = Новый Структура("РежимБезМестХранения", Истина);
	
	ИнтеграцияСАТУРНКлиент.ОткрытьФормуВыбораОрганизаций(ЭтотОбъект, "Оформлено",,,, ВходящиеПараметры);
...
Процедура КОформлениюОрганизацииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ИнтеграцияСАТУРНКлиент.ОткрытьФормуВыбораОрганизаций(ЭтотОбъект, "КОформлению",,,, ВходящиеПараметры);
...
Процедура Архивировать(Команда)
	...
	ИнтеграцияИСКлиент.АрхивироватьРаспоряжения(ЭтотОбъект, Элементы.СписокКОформлению, ИнтеграцияСАТУРНКлиент,
		ПредопределенноеЗначение("Документ.ПланПримененияСАТУРН.ПустаяСсылка"), "Ссылка");
...
Процедура УстановитьУсловноеОформление()
	...
	СписокСтатусов.ЗагрузитьЗначения(Документы.ПланПримененияСАТУРН.СтатусыОшибок());
	...
	СписокДействий.ЗагрузитьЗначения(Документы.ПланПримененияСАТУРН.ВсеТребующиеОжидания()); 
...
Функция ВсеТребующиеДействия()
	...
	Возврат Документы.ПланПримененияСАТУРН.ВсеТребующиеДействия();
...
Функция ВсеТребующиеОжидания()
	...
	Возврат Документы.ПланПримененияСАТУРН.ВсеТребующиеОжидания();
