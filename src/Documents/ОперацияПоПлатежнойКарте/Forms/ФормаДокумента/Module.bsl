...
Процедура УправлениеЭлементамиФормыЗависимыхОтДокументаОснования()
	...
	Элементы.ПредставлениеДокументаОснования.Доступность = Ложь;
	Если Не ИспользоватьЗаявкиНаРасходованиеДенежныхСредств 
		...
		Элементы.ПредставлениеДокументаОснования.Доступность = Истина;
	КонецЕсли;
...
Процедура ОбработкаВыбораДокументаОснованияСервер(ВыбранноеЗначение)
	...
	ДанныеЗаполнения.Вставить("Основание", ВыбранноеЗначение);
