...
&НаКлиенте
Процедура РасходыКодТНВЭДПриИзменении(Элемент)
...
Функция ТоварПрослеживается(НомерГТД, КодТНВЭД)
	
	Возврат ПриобретениеУслугПрочихАктивовЛокализация.ТоварПрослеживается(НомерГТД, КодТНВЭД);
...
Процедура КонтрольНеСогласованныхИзмененийОбработатьСобытиеПриИзменении(Элемент)
	...
	ИначеЕсли Элемент.Имя = "РасходыНомерГТД" ИЛИ Элемент.Имя = "РасходыКодТНВЭД" Тогда 
		ЗаполнитьСлужебныеРеквизитыПрослеживаемостиВСтрокеРасходов();
	Иначе
...
Процедура ЗаполнитьСлужебныеРеквизитыПрослеживаемостиВСтрокеРасходов()
	...
	ТекущиеДанные.ВедетсяУчетПоРНПТ = ТоварПрослеживается(ТекущиеДанные.НомерГТД, ТекущиеДанные.КодТНВЭД);
