...
Процедура УстановитьУсловноеОформление()
	...
	СписокСтатусов.ЗагрузитьЗначения(Документы.ЗапросСкладскогоЖурналаВЕТИС.СтатусыОшибок());
	...
	СписокДействий.ЗагрузитьЗначения(Документы.ЗапросСкладскогоЖурналаВЕТИС.ВсеТребующиеОжидания());
...
Процедура УстановитьВидимостьДальнейшихДействий()
	...
	ОперацииДопустимыхДействий = Документы.ЗапросСкладскогоЖурналаВЕТИС.ОперацииДопустимыхДействий();
...
Функция ВсеТребующиеДействия()
	...
	Возврат Документы.ЗапросСкладскогоЖурналаВЕТИС.ВсеТребующиеДействия();
...
Функция ВсеТребующиеОжидания()
	...
	Возврат Документы.ЗапросСкладскогоЖурналаВЕТИС.ВсеТребующиеОжидания();
