...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияЕГАИС.УстановитьВидимостьКомандыОформленияДокумента(ЭтотОбъект, Метаданные.Документы.ОтчетОбИмпортеЕГАИС, "СписокКОформлениюОформитьОтчетОбИмпорте");
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_ОтчетОбИмпортеЕГАИС" Тогда
		Элементы.Список.Обновить();
	КонецЕсли;
	
	Если ИмяСобытия = "ИзменениеСостоянияЕГАИС"
		И ТипЗнч(Параметр.Ссылка) = Тип("ДокументСсылка.ОтчетОбИмпортеЕГАИС") Тогда
...
&НаКлиенте
Процедура ОформитьОтчетОбИмпорте(Команда)
...
Процедура Архивировать(Команда)
	...
	ИнтеграцияИСКлиент.АрхивироватьРаспоряжения(ЭтотОбъект, Элементы.СписокКОформлению, ИнтеграцияЕГАИСКлиент,
		ПредопределенноеЗначение("Документ.ОтчетОбИмпортеЕГАИС.ПустаяСсылка"));
...
Процедура УстановитьУсловноеОформление()
	...
	СписокСтатусов.ЗагрузитьЗначения(Документы.ОтчетОбИмпортеЕГАИС.СтатусыОшибок());
	...
	СписокДействий.ЗагрузитьЗначения(Документы.ОтчетОбИмпортеЕГАИС.ВсеТребующиеОжидания());
...
Функция ВсеТребующиеДействия()
	...
	Возврат Документы.ОтчетОбИмпортеЕГАИС.ВсеТребующиеДействия();
...
Функция ВсеТребующиеОжидания()
	...
	Возврат Документы.ОтчетОбИмпортеЕГАИС.ВсеТребующиеОжидания();
