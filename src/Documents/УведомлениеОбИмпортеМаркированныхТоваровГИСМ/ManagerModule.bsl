...
Функция УведомлениеОбИмпортеМаркированныхТоваровСXML(ДокументСсылка)
	...
	Попытка
		УведомлениеОбИмпорте.sender_gln = РеквизитыОрганизации.GLN;
	Исключение
	...
	Для Каждого СтрокаТЧ Из Товары Цикл
		...
		ПредставлениеНоменклатуры = ИнтеграцияИС.ПредставлениеНоменклатуры(СтрокаТЧ.Номенклатура, СтрокаТЧ.Характеристика);
