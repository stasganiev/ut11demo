...
Процедура НастроитьДоступныеВидыПродукции(ДоступныеВидыПродукцииИС)
	...
	ИсключаемыеВидыПродукции.Добавить(Перечисления.ВидыПродукцииИС.БАДы);
	ИсключаемыеВидыПродукции.Добавить(Перечисления.ВидыПродукцииИС.ТитановаяМеталлопродукция);
	ИсключаемыеВидыПродукции.Добавить(Перечисления.ВидыПродукцииИС.РастительныеМасла);
	
	Для Каждого ИсключаемыйВидПродукции Из ИсключаемыеВидыПродукции Цикл
		ИсключаемыйЭлемент = ДоступныеВидыПродукцииИС.Найти(ИсключаемыйВидПродукции);
