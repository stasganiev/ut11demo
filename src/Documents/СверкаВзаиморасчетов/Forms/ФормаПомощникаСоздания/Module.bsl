...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Документы.СверкаВзаиморасчетов.ИнициализироватьКомпоновщикНастроек(КомпоновщикОтбор, ЭтаФорма.УникальныйИдентификатор);
...
Процедура ПередЗагрузкойДанныхИзНастроекНаСервере(Настройки)
	...
	Если НастройкиОтбора <> Неопределено Тогда
		...
		Если ПолучитьФункциональнуюОпцию("ИспользоватьПартнеровКакКонтрагентов") Тогда
			Документы.СверкаВзаиморасчетов.ЗаполнитьОтборПартнераПоКонтрагенту(КомпоновщикОтбор.Настройки.Отбор);
		КонецЕсли;
...
Процедура УстановитьНастройкиОтборов(Команда)
	...
	ОткрытьФорму("Документ.СверкаВзаиморасчетов.Форма.НастройкаОтборов",
	            ПараметрыОткрытия,
	            ЭтаФорма,
	            ,
	            ,
...
Процедура ЗаполнитьТаблицуРасчетовСервер()
	...
	ТаблицаРезультатаСКД = Документы.СверкаВзаиморасчетов.ПолучитьВзаиморасчеты(КомпоновщикОтбор);
...
Функция ЕстьЗаданияКРаспределению()
	...
	АналитикаКРасчету = Документы.СверкаВзаиморасчетов.АналитикаКРасчету(
	...
	Если ЕстьЗадания Тогда
		...
		ИмяПроцедуры        = "Документы.СверкаВзаиморасчетов.РаспределениеРасчетовПоДокументам";
...
// 
// Параметры:
// 	СтрокаПротокола - см. Документы.СверкаВзаиморасчетов.СтрокаПротокола
...
Процедура УстановитьПометкуНаУдалениеНаСервере()
	...
	ИмяПроцедуры        = "Документы.СверкаВзаиморасчетов.УстановитьПометкуНаУдаление";
