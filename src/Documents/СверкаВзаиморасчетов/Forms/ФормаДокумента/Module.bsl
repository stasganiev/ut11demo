...
Функция РасчетныйДокументОбработкаВыбораНаСеврере(ВыбранноеЗначение)
	...
	ДанныеДокумента = Документы.СверкаВзаиморасчетов.ДанныеРасчетногоДокумента(ВыбранноеЗначение);
	ДанныеДокумента.Вставить("ВалютаДокумента", ДанныеДокумента.Валюта);
	ОписаниеДокумента = Документы.СверкаВзаиморасчетов.ОписаниеРасчетногоДокумента(ДанныеДокумента.Ссылка, ДанныеДокумента.Номер, ДанныеДокумента.Дата, ДанныеДокумента.НаименованиеПервичногоДокумента);
