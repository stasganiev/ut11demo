...
Процедура УстановитьДоступностьКомандУстановкиСтатуса()
	...
	ПравоДоступаУтверждениеПлановПродаж = Пользователи.РолиДоступны("УтверждениеПлановПродаж");
	
	Элементы.ГруппаУстановитьСтатус.Видимость = ПравоДоступаИзменениеПланПродаж;
	Элементы.СписокУстановитьСтатусУтвержден.Видимость = ПравоДоступаУтверждениеПлановПродаж;
