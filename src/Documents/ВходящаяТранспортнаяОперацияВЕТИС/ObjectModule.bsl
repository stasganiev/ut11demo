...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ТоварыУточнение.Количество() > 0 Тогда
		...
		Для Каждого СтрокаТовар Из Товары Цикл
			...
			КонецЦикла;
		КонецЦикла;
		ИнтеграцияВЕТИС.ЗаписатьСоответствиеНоменклатуры(ЭтотОбъект, РежимЗаписи, ТаблицаУточнений);
	КонецЕсли;
	...
	Если Не ДополнитьДокумент Тогда
		...
		Если ДанныеШапки.Следующий() Тогда
			...
			Если ДанныеПоследнегоТранспорта <> Неопределено Тогда
				...
				ТипТранспорта                 = ДанныеПоследнегоТранспорта.ТипТранспорта;
				НомерТранспортногоСредства    = ДанныеПоследнегоТранспорта.НомерТранспортногоСредства;
				НомерАвтомобильногоПрицепа    = ДанныеПоследнегоТранспорта.НомерАвтомобильногоПрицепа;
				НомерАвтомобильногоКонтейнера = ДанныеПоследнегоТранспорта.НомерАвтомобильногоКонтейнера;
