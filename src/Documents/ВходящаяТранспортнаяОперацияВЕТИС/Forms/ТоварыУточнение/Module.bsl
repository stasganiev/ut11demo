...
Процедура РазбитьСтроку(Команда)
	...
	ПараметрыРазбиенияСтроки.ИмяПоляКоличество = "КоличествоВЕТИС";
	
	СобытияФормИСКлиент.РазбитьСтрокуТабличнойЧасти(ТоварыУточнение, Элементы.ТоварыУточнение, ПараметрыРазбиенияСтроки, Оповещение);
