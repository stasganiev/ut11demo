...
Процедура АрхивироватьОснования(Команда)
	...
	ИнтеграцияИСКлиент.АрхивироватьРаспоряжения(ЭтотОбъект, Элементы.СписокКОформлению, ИнтеграцияЗЕРНОКлиент,
		ПредопределенноеЗначение("Документ.ФормированиеПартийИзДругихПартийЗЕРНО.ПустаяСсылка"));
...
Процедура УстановитьУсловноеОформление()
	...
	СписокСтатусов.ЗагрузитьЗначения(Документы.ФормированиеПартийИзДругихПартийЗЕРНО.СтатусыОшибок());
	...
	СписокДействий.ЗагрузитьЗначения(Документы.ФормированиеПартийИзДругихПартийЗЕРНО.ВсеТребующиеОжидания());
...
Функция ВсеТребующиеДействия()
	...
	Возврат Документы.ФормированиеПартийИзДругихПартийЗЕРНО.ВсеТребующиеДействия();
...
Функция ВсеТребующиеОжидания()
	...
	Возврат Документы.ФормированиеПартийИзДругихПартийЗЕРНО.ВсеТребующиеОжидания();
...
Процедура НастроитьВидимостьДоступностьЭлементовСервер()
	...
	Если НЕ ПравоДоступа("Добавление", Метаданные.Документы.ФормированиеПартийИзДругихПартийЗЕРНО) Тогда
		Элементы.СтраницаКОформлению.Видимость = Ложь;
