	...
	Если ТекущиеДанные <> Неопределено Тогда
		Если ЗначениеЗаполнено(ТекущиеДанные.СпособОпределенияСебестоимости) Тогда
			Если (ТекущиеДанные.СтавкаНДС = ТекущиеДанные.СтавкаНДСПосле
				...
				ТекущиеДанные.СпособОпределенияСебестоимости = ПредопределенноеЗначение("Перечисление.СпособыОпределенияСебестоимости.ПустаяСсылка");
	...
	Если ТекущаяСтрока <> Неопределено Тогда
		Если ЗначениеЗаполнено(ТекущаяСтрока.СпособОпределенияСебестоимости)
			...
			И ТекущаяСтрока.ВариантОтраженияСписания = ПредопределенноеЗначение("Перечисление.ВариантыОтраженияКорректировокРеализаций.СписатьНаРасходы") Тогда
				ТекущаяСтрока.СпособОпределенияСебестоимости = ПредопределенноеЗначение("Перечисление.СпособыОпределенияСебестоимости.ПустаяСсылка");
...
Процедура УстановитьУсловноеОформление()
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеЕдиницИзмерения(ЭтотОбъект,
																	"ТаблицаКорректировкиНоменклатураЕдиницаИзмерения", 
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеНомераГТД(ЭтотОбъект,
															"ТаблицаКорректировкиНомерГТД",
															"ТаблицаКорректировки.ВедетсяУчетПоГТД");
	НоменклатураСервер.УстановитьУсловноеОформлениеНомераГТД(ЭтотОбъект,
															"ТаблицаКорректировкиНомерГТДСтранаПроисхождения",
															"ТаблицаКорректировки.ВедетсяУчетПоГТД");
	
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеНомераГТД(
		ЭтотОбъект,
		"ТаблицаКорректировкиНомерГТД",
		"ТаблицаКорректировки.ВедетсяУчетПоРНПТ",
		"Объект.Дата",
		"ТаблицаКорректировки.НомерГТД");
...
Процедура ЗаполнитьУсловияПродаж(Знач УсловияПродаж)
	...
	Объект.НаправлениеДеятельности = УсловияПродаж.НаправлениеДеятельности;
...
Процедура ВыгрузитьТаблицуКорректировкиВДанныеДокумента()
	...
	Для каждого СтрокаТаблицыКорректировки Из ТаблицаКорректировки Цикл
		...
		Если Не ИспользоватьУчетСебестоимости 
			...
			СтрокаТаблицыКорректировки.СпособОпределенияСебестоимости = ПредопределенноеЗначение("Перечисление.СпособыОпределенияСебестоимости.ИзТекущегоДокумента");
		КонецЕсли;
