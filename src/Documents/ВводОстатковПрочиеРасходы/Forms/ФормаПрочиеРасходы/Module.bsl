...
Процедура УстановитьВидимость()
	...
	Если Не ВидимостьГруппУчета Тогда
		...
		Элементы.ОтражатьВОперативномУчете.Видимость = Истина;
	...
	Элементы.ПрочиеРасходыЗаполнитьПоОстаткам.Видимость = НЕ Объект.ОтражатьВОперативномУчете 
		И (Объект.ОтражатьВБУиНУ ИЛИ Объект.ОтражатьВУУ) И НЕ Объект.Исправление;
	...
	ПоказыватьРеквизитыНДД = Объект.ОтражатьНДД;
	Элементы.ПрочиеРасходыСуммаНДД.Видимость = ПоказыватьРеквизитыНДД И ВедетсяУчетПоНДД;
...
Процедура СтатьяПрочихРасходовПриИзмененииСервер(КэшированныеЗначения)
	...
	ЗаполнитьСуммуНДД(СтрокаТаблицы);
...
&НаСервере
Процедура ЗаполнитьСуммуНДД(СтрокаТаблицы)
	
	ВедетсяУчетПоНДД = РасчетСебестоимостиЛокализация.ВедетсяУчетПоНДД(Объект.Дата, Объект.Организация);
	СтатьяРасходовПризнаетсяВРасходахНДД = СтатьяРасходовПризнаетсяВРасходахНДД(СтрокаТаблицы.СтатьяРасходов);
	Если ВедетсяУчетПоНДД И СтатьяРасходовПризнаетсяВРасходахНДД Тогда
