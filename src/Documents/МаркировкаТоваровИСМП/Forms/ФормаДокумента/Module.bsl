...
Процедура НастроитьЭлементыФормы(Форма)
	...
	ЭтоПродукцияСоСрокамиГодности   = ИнтеграцияИСМПКлиентСервер.ЭтоВидПродукцииСоСрокамиГодности(ВидПродукции);
	...
	Элементы.ОперацияНанесенияТолькоДляНаборов.Видимость   = ВидПродукцииИспользуетНаборы И Не ЭтоИмпортСФТС;
	Элементы.ОперацияТолькоДляНаборов.Видимость            = ЭтоОперацияНанесения И ВидПродукцииИспользуетНаборы;
	...
	ИначеЕсли ВозможнаОперацияНанесения Тогда
		...
		Элементы.ОперацияНанесенияТолькоДляНаборов.Видимость = ДоступнаОперацияНанесенияПоВидуОперацииИСМП И Не ЭтоМех
			И ВидПродукцииИспользуетНаборы;
...
Процедура ОбновитьИденификаторПримененияВЕТИССрокГодности()
	...
	Если ИнтеграцияИСМПКлиентСервер.ЭтоВидПродукцииСоСрокамиГодности(Объект.ВидПродукции) Тогда
...
Функция КлючСвязиСтатусаСтрок(Форма, Номенклатура = Неопределено)
	...
	Если ИнтеграцияИСМПКлиентСервер.ОперацииНанесенияКодовМаркировки().Найти(Форма.Объект.Операция) <> Неопределено
		...
		ИначеЕсли ИнтеграцияИСМПКлиентСервер.ЭтоВидПродукцииСоСрокамиГодности(Форма.Объект.ВидПродукции) Тогда
			МассивКлючейСвязи.Добавить("СрокГодности");
		КонецЕсли;
