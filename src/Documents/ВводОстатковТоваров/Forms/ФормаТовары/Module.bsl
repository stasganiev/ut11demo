...
Процедура УстановитьУсловноеОформление()
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеНомераГТД(ЭтотОбъект, "ПолученныеНаХранениеНомерГТД");
	НоменклатураСервер.УстановитьУсловноеОформлениеНомераГТД(ЭтаФорма, "ПереданныеНаКомиссиюНомерГТД");
	НоменклатураСервер.УстановитьУсловноеОформлениеНомераГТД(ЭтотОбъект, "ПереданныеНаКомиссию25НомерГТД");
	НоменклатураСервер.УстановитьУсловноеОформлениеНомераГТД(ЭтотОбъект, "ПереданныеНаХранениеНомерГТД");
	...
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеНомераГТД(ЭтаФорма, "СобственныеТоварыНомерГТД");
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеНомераГТД(ЭтаФорма, "ПолученныеНаКомиссиюНомерГТД");
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеНомераГТД(ЭтотОбъект, "ПолученныеНаХранениеНомерГТД");
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеНомераГТД(ЭтаФорма, "ПереданныеНаКомиссиюНомерГТД");
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеНомераГТД(ЭтотОбъект, "ПереданныеНаКомиссию25НомерГТД");
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеНомераГТД(ЭтотОбъект, "ПереданныеНаХранениеНомерГТД");
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеНомераГТД(ЭтаФорма, "ПринятаяТараНомерГТД");
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеНомераГТД(ЭтаФорма, "ПереданныеПереработчикамТоварыНомерГТД");
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеНомераГТД(ЭтаФорма, "ПереданнаяТараНомерГТД");
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеЕдиницИзмерения(ЭтотОбъект,
		"ПолученныеНаХранениеНоменклатураЕдиницаИзмерения",,
		"ИспользоватьАдресноеХранение");
	НоменклатураСервер.УстановитьУсловноеОформлениеЕдиницИзмерения(ЭтотОбъект,
		"ПереданныеНаКомиссию25НоменклатураЕдиницаИзмерения",,
		"ИспользоватьАдресноеХранение");
	НоменклатураСервер.УстановитьУсловноеОформлениеЕдиницИзмерения(ЭтотОбъект,
		"ПереданныеНаХранениеНоменклатураЕдиницаИзмерения",,
		"ИспользоватьАдресноеХранение");
	НоменклатураСервер.УстановитьУсловноеОформлениеЕдиницИзмерения(ЭтотОбъект,
...
Процедура ДобавитьВСтруктуруДействияПриИзмененииКоличестваУпаковок(СтруктураДействий, Форма)
	...
	Если Форма.ЭтоОстаткиСобственныхТоваров
		...
		Или Форма.ЭтоОстаткиПереданныхНаХранениеТоваров Тогда
