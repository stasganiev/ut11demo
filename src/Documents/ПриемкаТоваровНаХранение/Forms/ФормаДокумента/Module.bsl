...
Процедура ПодборТоваровИзЗаказа()
	...
	АдресТоваров     = "";
	ИмяФомрыПодбора  = "Обработка.ЖурналДокументовЗакупки.Форма.ФормаПодбораТоваровИзЗаказа";
	...
	ОткрытьФорму(ИмяФомрыПодбора, ПараметрыПодбора, ЭтаФорма, , , , , РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
