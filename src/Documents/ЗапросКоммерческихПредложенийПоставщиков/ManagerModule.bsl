...
Процедура ЗаполнитьДанныеПоЗапросуКоммерческихПредложений(Знач СсылкаНаОбъект, ДанныеДокумента, Отказ) Экспорт
	...
	Запрос.Текст = 
		...
		|	ЗапросКоммерческихПредложенийПоставщиков.Склад КАК АдресДоставкиПредставление,
		|	ЗапросКоммерческихПредложенийПоставщиков.СкладЗначенияПолей КАК АдресДоставкиЗначениеПолей,
