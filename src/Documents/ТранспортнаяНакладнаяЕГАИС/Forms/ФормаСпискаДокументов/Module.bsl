...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияЕГАИС.УстановитьВидимостьКомандыОформленияДокумента(ЭтотОбъект, Метаданные.Документы.ТранспортнаяНакладнаяЕГАИС, "СписокКОформлениюОформитьТранспортнаяНакладнаяЕГАИС");
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_ТранспортнаяНакладнаяЕГАИС" Тогда
		Элементы.Список.Обновить();
	КонецЕсли;
	
	Если ИмяСобытия = "ИзменениеСостоянияЕГАИС"
		И ТипЗнч(Параметр.Ссылка) = Тип("ДокументСсылка.ТранспортнаяНакладнаяЕГАИС") Тогда
...
&НаКлиенте
Процедура ОформитьТранспортнаяНакладнаяЕГАИС(Команда)
	...
	ОбменДаннымиЕГАИСКлиент.ВыполнитьКомандуГиперссылки(
		...
		"СоздатьТранспортнаяНакладнаяЕГАИС",
		ЭтотОбъект);
...
Процедура Архивировать(Команда)
	...
	ИнтеграцияИСКлиент.АрхивироватьРаспоряжения(ЭтотОбъект, Элементы.СписокКОформлению, ИнтеграцияЕГАИСКлиент,
		ПредопределенноеЗначение("Документ.ТранспортнаяНакладнаяЕГАИС.ПустаяСсылка"));
...
Процедура УстановитьУсловноеОформление()
	...
	СписокСтатусов.ЗагрузитьЗначения(Документы.ТранспортнаяНакладнаяЕГАИС.СтатусыОшибок());
	...
	СписокДействий.ЗагрузитьЗначения(Документы.ТранспортнаяНакладнаяЕГАИС.ВсеТребующиеОжидания());
...
Функция ВсеТребующиеДействия()
	...
	Возврат Документы.ТранспортнаяНакладнаяЕГАИС.ВсеТребующиеДействия();
...
Функция ВсеТребующиеОжидания()
	...
	Возврат Документы.ТранспортнаяНакладнаяЕГАИС.ВсеТребующиеОжидания();
